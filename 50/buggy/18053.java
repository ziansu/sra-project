...
public com.thalesgroup.dtkit.metrics.model.InputMetric getInputMetric() {
    try {
        ...
        throw new java.lang.RuntimeException(("Can't create the inputMetric object for the class " + (com.thalesgroup.hudson.plugins.xunit.types.CustomInputMetric.class)));
    }
}