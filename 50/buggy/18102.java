...
final java.lang.String path, @org.springframework.beans.factory.annotation.Value(value = "${firmware.fileExtension}")
final java.lang.String fileExtension) {
    return new com.alliander.osgp.adapter.protocol.iec61850.device.FirmwareLocation(protocol, domain, port, path, fileExtension);
}