...
public void shouldFailCacheDeleteIfPersistenceDeleteThrowException() throws java.lang.Exception {
    org.mockito.Mockito.when(persistence.delete(com.mobilejazz.cacheio.CacheManagerTest.FAKE_KEY)).thenThrow(com.mobilejazz.cacheio.exceptions.CacheErrorException.class);
