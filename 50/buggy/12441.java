...
public org.elasticsearch.action.ingest.SimulateDocumentSimpleResult readFrom(org.elasticsearch.common.io.stream.StreamInput in) throws java.io.IOException {
    ...
    return new org.elasticsearch.action.ingest.SimulateDocumentSimpleResult(org.elasticsearch.action.ingest.WriteableIngestDocument.readWriteableIngestDocumentFrom(in));
}