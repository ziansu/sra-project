...
int id) {
    return new org.springframework.http.ResponseEntity<org.springframework.hateoas.Resource>(new org.springframework.hateoas.Resource(buildUserResource(0, "Mika Penniman")), org.springframework.http.HttpStatus.OK);
}