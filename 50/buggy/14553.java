...
protected java.net.HttpURLConnection performAction(java.net.HttpURLConnection connection, long timestamp) throws java.io.IOException {
    org.elasticsearch.metrics.JsonMetric jsonMetric = new org.elasticsearch.metrics.JsonStartTime(com.codahale.metrics.MetricRegistry.name(prefix, "metricStart"));
