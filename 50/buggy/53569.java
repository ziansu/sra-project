...
java.lang.String id) {
    profileProducer.send(new org.apache.kafka.clients.producer.ProducerRecord<java.lang.String, com.github.patrickbcullen.profile.ProfileEvent>(topic, id, new com.github.patrickbcullen.profile.ProfileEvent("delete")));
