...
public org.springframework.data.jpa.support.MergingPersistenceUnitManager persistenceUnitManager(@org.springframework.beans.factory.annotation.Qualifier(value = com.jpaex.sampledb.config.SampleDbConfiguration.QUALIFIER)
javax.sql.DataSource dataSource) {
    ...
    persistenceUnitManagerBean.setDefaultDataSource(dataSource);
