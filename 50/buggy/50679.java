...
int id) {
    return new org.springframework.http.ResponseEntity<org.springframework.hateoas.Resource<app.entities.Book>>(new org.springframework.hateoas.Resource(buildBookResource(0, "Harry Potter")), org.springframework.http.HttpStatus.OK);
}