private java.security.cert.X509Certificate createCertificate(java.lang.String name, final java.util.Date notBefore, final java.util.Date notAfter) {
    ...
    return org.apache.ace.authentication.processor.clientcert.ClientCertAuthenticationProcessorTest.m_keystore.createCertificate("alias", ("cn=" + name), notBefore, notAfter, keypair.getPublic());
}