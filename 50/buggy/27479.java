public java.util.Map<java.lang.String, hudson.remoting.RemoteClassLoader.ClassFile2> fetch3(java.lang.String className) throws java.lang.ClassNotFoundException {
    ...
    return java.util.Collections.singletonMap(className, new hudson.remoting.RemoteClassLoader.ClassFile2(cf.classLoader, new hudson.remoting.ResourceImageDirect(cf.classImage), null));
}