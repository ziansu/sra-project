...
public static java.lang.String entityName(org.lightadmin.core.config.domain.DomainTypeAdministrationConfiguration domainTypeAdministrationConfiguration, java.lang.Object entity) {
    ...
    return org.lightadmin.core.config.domain.configuration.support.ExceptionAwareTransformer.exceptionAwareNameExtractor(nameExtractor, domainTypeAdministrationConfiguration).apply(entity);
}