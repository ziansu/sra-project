...
org.apache.camel.spring.boot.RoutesCollector routesCollector(org.springframework.context.ApplicationContext applicationContext) {
    ...
    return new org.apache.camel.spring.boot.RoutesCollector(applicationContext, new java.util.ArrayList<org.apache.camel.spring.boot.CamelContextConfiguration>(configurations));
}