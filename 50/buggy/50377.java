...
public void initialize(io.dropwizard.setup.Bootstrap<uk.gov.register.presentation.config.PresentationConfiguration> bootstrap) {
    bootstrap.addBundle(new io.dropwizard.views.ViewBundle(com.google.common.collect.ImmutableList.of(new io.dropwizard.views.mustache.MustacheViewRenderer(), new thymeleaf.ThymeleafViewRenderer())));
