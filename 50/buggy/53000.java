...
retrofit2.Call<java.lang.Void> addToWishlistAsync(@retrofit2.http.Header(value = "X-Auth-Token")
java.lang.String token, @retrofit2.http.Field(value = "wishlistCode")
