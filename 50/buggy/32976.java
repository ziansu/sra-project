...
java.lang.String tenant, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) {
    com.witvan.wechat.controller.BaseController.logger.info("getting redirect in base controller");
    com.witvan.wechat.domain.RedirectResponse redirectUrl = userService.checkRedirect(request, tenant, url, false);
    return redirectUrl;
}