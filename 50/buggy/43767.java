...
fr.denoria.client.space.models.User user) throws fr.denoria.client.space.exceptions.UserException, java.security.NoSuchAlgorithmException {
    return new org.springframework.http.ResponseEntity(new fr.denoria.client.space.models.dto.UserDto(userService.createOrUpdate(user)), org.springframework.http.HttpStatus.OK);
}