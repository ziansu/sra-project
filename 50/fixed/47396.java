...
public org.springframework.social.twitter.api.Twitter twitter(org.springframework.core.env.Environment environment) {
    return new org.springframework.social.twitter.api.impl.TwitterTemplate(environment.getProperty("twitter.consumerKey"), environment.getProperty("twitter.consumerSecret"));
}