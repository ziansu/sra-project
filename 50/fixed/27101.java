private org.zaproxy.zap.utils.ZapNumberSpinner getMaxPayloadsNumberSpinner() {
    if ((maxPayloadsNumberSpinner) == null) {
        maxPayloadsNumberSpinner = new org.zaproxy.zap.utils.ZapNumberSpinner(0, org.zaproxy.zap.extension.fuzz.payloads.ui.impl.RegexPayloadGeneratorUIHandler.RegexPayloadGeneratorUIPanel.DEFAULT_MAX_PAYLOADS, java.lang.Integer.MAX_VALUE);
