...
it.smartcommunitylab.carpooling.model.Booking booking) throws it.smartcommunitylab.carpooling.exceptions.CarPoolingCustomException {
    return new it.smartcommunitylab.carpooling.model.Response<it.smartcommunitylab.carpooling.model.Travel>(carPoolingManager.bookTrip(tripId, booking, getUserId()));
}