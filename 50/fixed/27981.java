...
org.apache.hadoop.conf.Configuration conf) throws java.io.IOException {
    com.netflix.aegisthus.io.sstable.compression.CompressionMetadata compressionMetadata = com.netflix.aegisthus.input.splits.AegCompressedSplit.getCompressionMetadata(conf, compressionMetadataPath, compressedLength, true);
