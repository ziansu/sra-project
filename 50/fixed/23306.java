...
protected buzztaiki.lucene.lastuni.TokenStreamComponents createComponents(java.lang.String fieldName, java.io.Reader reader) {
    ...
    return new buzztaiki.lucene.lastuni.TokenStreamComponents(source, new org.apache.lucene.analysis.StopFilter(matchVersion, new buzztaiki.lucene.lastuni.CJKLastUniGramFilter(source), stopwords));
}