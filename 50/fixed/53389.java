...
io.reactivex.Observable<com.ryandzhunter.contact.data.model.Contact> addContactWithImage(@retrofit2.http.Part(value = "contact[first_name]")
...
okhttp3.RequestBody phoneNumber, @retrofit2.http.Part
