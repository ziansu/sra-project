public static void sell(org.bukkit.entity.Player player) {
    ...
    player.sendMessage(com.codisimus.plugins.chunkown.Econ.sellMsg.replace("<price>", com.codisimus.plugins.chunkown.Econ.economy.format(com.codisimus.plugins.chunkown.Econ.sellPrice)));
}