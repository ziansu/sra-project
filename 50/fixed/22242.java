...
public void testChunkedResponseWithInitialFlush() throws java.io.IOException {
    ...
    runTest(io.undertow.servlet.test.streams.ServletOutputStreamTestCase.message, io.undertow.servlet.test.streams.ServletOutputStreamTestCase.BLOCKING_SERVLET, false, true, 1, true, false);
}