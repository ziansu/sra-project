...
public void testExecuteQueryWithNonSelectType() throws java.lang.Exception {
    ...
    com.j256.ormlite.jdbc.JdbcCompiledStatement stmt = new com.j256.ormlite.jdbc.JdbcCompiledStatement(preparedStatement, com.j256.ormlite.stmt.StatementBuilder.StatementType.EXECUTE, false);
    stmt.runQuery(null);
    stmt.close();
}