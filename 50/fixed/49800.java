...
java.lang.Integer year, javax.servlet.http.HttpServletRequest request) {
    return org.openlmis.core.web.OpenLmisResponse.response("estimates", service.getEstimateFor(loggedInUserId(request), year));
}