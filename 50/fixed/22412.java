...
java.lang.String date, @org.springframework.web.bind.annotation.RequestParam(value = "time")
java.lang.String time, @org.springframework.web.bind.annotation.RequestParam(value = "eventClass")
java.lang.String postClass, @org.springframework.web.bind.annotation.RequestParam(value = "type")
java.lang.String type) {
    return postService.submitEvent(title, desc, date, time, java.lang.Integer.parseInt(postClass), type);
}