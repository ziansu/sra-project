public org.springframework.data.domain.Page<es.test.vessel.entities.Vessel> findByNameContainingAndPointNearAndWidthBetweenAndLengthBetween(@org.springframework.data.repository.query.Param(value = "name")
