...
final org.apereo.cas.CipherExecutor cipherExecutor) {
    ...
    return new org.apereo.cas.web.support.TGCCookieRetrievingCookieGenerator(defaultCookieValueManager(cipherExecutor), tgc.getName(), tgc.getPath(), tgc.getDomain(), rememberMeMaxAge, tgc.isSecure(), tgc.getMaxAge());
}