public com.builtbroken.mc.core.network.packet.PacketTile getDescPacket() {
    com.builtbroken.mc.imp.transform.vector.Pos pos = ((getHost()) != null) ? new com.builtbroken.mc.imp.transform.vector.Pos(getHost()) : new com.builtbroken.mc.imp.transform.vector.Pos();
