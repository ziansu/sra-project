...
hu.unideb.inf.nvkshop.web.user.UserForm form, @org.springframework.web.bind.annotation.ModelAttribute(value = "categoryForm")
hu.unideb.inf.nvkshop.web.admin.CategoryForm categoryForm, @org.springframework.web.bind.annotation.PathVariable(value = "id")
