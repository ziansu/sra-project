...
public static com.playposse.egoeater.storage.PairingParcelable getNextPairing(android.content.ContentResolver contentResolver) {
    android.database.Cursor cursor = contentResolver.query(PipelineTable.CONTENT_URI, PipelineTable.COLUMN_NAMES, null, null, ((com.playposse.egoeater.contentprovider.EgoEaterContract.PipelineTable.ID_COLUMN) + " asc"));
