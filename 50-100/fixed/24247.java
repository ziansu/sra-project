...
int[] grantResults) {
    ...
    switch (requestCode) {
        case ph.intrepidstream.callmanager.ui.MainActivity.PERMISSION_REQUEST_CALL_PHONE :
            {
                if ((((grantResults.length) > 0) && ((grantResults[0]) != (android.content.pm.PackageManager.PERMISSION_GRANTED))) && (android.support.v4.app.ActivityCompat.shouldShowRequestPermissionRationale(this, permissions[0]))) {
