private com.qubit.topnet.Handler getErrorHandler(com.qubit.topnet.Handler handler) {
    com.qubit.topnet.Handler errorHandler = com.qubit.topnet.errors.ErrorHandlingConfig.getErrorHandlingConfig().getDefaultErrorHandler(getErrorCode(), this.errorOccured);
