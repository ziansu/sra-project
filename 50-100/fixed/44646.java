...
public com.pacoapp.paco.shared.model2.ExperimentQueryResult getUsersAdministeredExperiments(java.lang.String email, org.joda.time.DateTimeZone timezone, java.lang.Integer limit, java.lang.String cursor) {
    com.pacoapp.paco.shared.model2.ExperimentIdQueryResult experimentIdsQueryResult = com.google.sampling.experiential.server.ExperimentAccessManager.getExistingExperimentIdsForAdmin(email, (limit == null ? 0 : limit), cursor);
