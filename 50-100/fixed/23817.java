public void setDefaultSecureEndpoint(org.eclipse.californium.core.network.Endpoint endpoint) {
    ...
    if (!(this.default_secure_endpoint.isStarted())) {
        try {
            ...
            org.eclipse.californium.core.network.EndpointManager.LOGGER.log(java.util.logging.Level.INFO, ("Started new default secure endpoint " + (default_secure_endpoint.getAddress())));
