private void checkPreferences() {
    int sittingPeriod = (((prefs.getInt(SettingsActivity.KEY_PREF_SITTING_PERIOD, SettingsActivity.SITTING_DEFAULT_VALUE)) * 1) + 1) * (com.bitsorific.standup.activity.MainActivity.MINUTE);
