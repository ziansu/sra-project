private void fillKitsStr(java.lang.String kitName, java.lang.String kitsStr) {
    ...
    for (java.lang.String productIdToQuantityPairStr : productIdToQuantityPairs) {
        ...
        kits.put(kitName, org.springframework.data.util.Pair.of(java.lang.Long.valueOf(productIdToQuantityPair[0]), java.lang.Integer.valueOf(productIdToQuantityPair[1])));
    }
}