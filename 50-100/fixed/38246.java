...
public cz.metacentrum.perun.taskslib.model.Task removeTask(cz.metacentrum.perun.taskslib.model.Task task) throws cz.metacentrum.perun.taskslib.exceptions.TaskStoreException {
    cz.metacentrum.perun.taskslib.model.Task idRemoved;
    cz.metacentrum.perun.taskslib.model.Task otherRemoved;
    synchronized(this) {
        idRemoved = tasksById.remove(task.getId());
        otherRemoved = tasksByFacilityAndExecService.remove(new cz.metacentrum.perun.core.api.Pair(task.getFacility(), task.getExecService()));
    }
