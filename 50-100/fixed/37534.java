...
public void onClick(android.view.View v) {
    ...
    if (parentActivity instanceof it.polito.mad.countonme.interfaces.IActionReportBack) {
        ...
        ((it.polito.mad.countonme.interfaces.IActionReportBack) (parentActivity)).onAction(new it.polito.mad.countonme.ReportBackAction(ReportBackAction.ActionEnum.ACTION_ADD_NEW_EXPENSE, getData()));
    }
}