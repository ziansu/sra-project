private void startFindNearestNodesService() {
    ...
    if (permissionCheck == (android.content.pm.PackageManager.PERMISSION_GRANTED)) {
        ...
        requestPermissions(new java.lang.String[]{ Manifest.permission.ACCESS_FINE_LOCATION }, com.example.tobiastrumm.freifunkautoconnect.NearestNodesFragment.PERMISSION_REQUEST_FINE_LOCATION);
    }
}