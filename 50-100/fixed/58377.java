public int GetAllProductAndMaterialRepertory(java.lang.String barcode) {
    ...
    return (hMSHandle.GetRepertoryByKeyList(java.util.Arrays.asList("Bar_Code"), java.util.Arrays.asList(hMSHandle.GetUsedBarcode(barcode, "material_storage")))) + (hPSHandle.GetRepertoryByKeyList(java.util.Arrays.asList("Bar_Code"), java.util.Arrays.asList(hPSHandle.GetUsedBarcode(barcode, "product_storage"))));
}