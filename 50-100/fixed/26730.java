...
public void testInvalidArrayRecursiveType() throws java.lang.Exception {
    ...
    byte[] bytes = mapper.writeValueAsBytes(com.google.common.collect.ImmutableMap.of("collection", "test", "api", api, "properties", com.google.common.collect.ImmutableMap.of("test0", "test", "test1", com.google.common.collect.ImmutableList.of("test", com.google.common.collect.ImmutableMap.of("test", 2)), "test2", false)));
