public void postSelectedItems(com.melodies.bandup.setup.DoubleListAdapter dla, com.melodies.bandup.setup.SetupListeners sl, android.content.Context c, java.lang.String url) {
    ...
    com.android.volley.toolbox.JsonArrayRequest postItems = new com.android.volley.toolbox.JsonArrayRequest(Request.Method.POST, url, selectedItems, sl.getPickListener(), sl.getErrorListener());
