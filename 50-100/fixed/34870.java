...
protected void onCreate(android.os.Bundle savedInstanceState) {
    ...
    com.liangmayong.netbox.Netbox.server(com.liangmayong.android_netbox.DemoService.class).path().method(Method.POST).exec(this, new com.liangmayong.netbox.callbacks.OnNetboxCallback<com.liangmayong.android_netbox.DemoBean>() {
        @java.lang.Override
