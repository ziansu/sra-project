...
java.lang.String assId, org.springframework.ui.Model model) {
    stumasys.Course course = db.getCourse(code, java.lang.Integer.parseInt(year));
    if (course == null) {
        return "404";
    }
    stumasys.Assessment assessment = course.getAssessment(java.lang.Integer.parseInt(assId));
    if (assessment == null) {
        return "404";
    }
    return "assessment";
