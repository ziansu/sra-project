...
public void testDeviceRegistration() throws java.io.IOException {
    ...
    de.sevenfactory.helium.TokenRepository tokenRepository = new de.sevenfactory.helium.TokenRepository(new de.sevenfactory.helium.mock.MockConfig(server.getUrl()), store);
