...
public void createDocumentReferenceWhenWikiParameterEmpty() throws java.lang.Exception {
    ...
    when(this.resolver.resolve(new org.xwiki.model.reference.EntityReference("page", org.xwiki.model.EntityType.DOCUMENT, new org.xwiki.model.reference.EntityReference("space", org.xwiki.model.EntityType.SPACE)))).thenReturn(reference);
