...
protected void onPostExecute(java.lang.String s) {
    ...
    adapter.addFragment(new in.mayanknagwanshi.radiodrive.fragment.SearchResultFragment(), music, true);
    adapter.addFragment(new in.mayanknagwanshi.radiodrive.fragment.SearchResultFragment(), station, false);
