protected com.arangodb.velocystream.Request getEdgeRequest(final java.lang.String key, final com.arangodb.model.DocumentReadOptions options) {
    final com.arangodb.velocystream.Request request = new com.arangodb.velocystream.Request(db, com.arangodb.velocystream.RequestType.GET, executor.createPath(ArangoDBConstants.PATH_API_GHARIAL, graph, ArangoDBConstants.EDGE, executor.createDocumentHandle(name, key)));
