...
public void testSendPrivateMessage() throws java.io.IOException, java.net.URISyntaxException {
    org.apache.http.HttpResponse response = com.teamdev.RequestMethods.sendPrivateMessage(validToken, "testMessage", registeredUserId.id, registeredChatId, registeredUserId.id);
