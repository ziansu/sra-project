...
public java.util.Map<java.lang.String, com.dell.cpsd.paqx.dne.service.model.Step> preProcessWorkflowSteps() {
    ...
    addWorkflowSteps(workflowSteps, "findAvailableNodes", "listScaleIoComponents", "listVCenterComponents", "discoverScaleIo", "discoverVCenter", "discoverNodeInventory", "configIdrac", "pingIdrac", "configureObmSettings", "configureBootDeviceIdrac", "findVCluster", "findProtectionDomain");
