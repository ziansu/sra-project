private java.util.PriorityQueue<de.fau.cs.mad.kwikshop.server.sorting.Edge> getSortedEdges() {
    java.util.PriorityQueue<de.fau.cs.mad.kwikshop.server.sorting.Edge> edges = new java.util.PriorityQueue(((this.edges.size()) + 1), new java.util.Comparator<de.fau.cs.mad.kwikshop.server.sorting.Edge>() {
        @java.lang.Override
