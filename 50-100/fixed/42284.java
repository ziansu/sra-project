private void initialiseFragments() {
    ...
    getSupportFragmentManager().beginTransaction().add(R.id.top_monitor_resizer_vertical_fragment, veritcalResizerFragment).replace(R.id.explorer_fragment, folderStructureFragment).add(R.id.android_monitor, androidMonitorFragment).commit();
}