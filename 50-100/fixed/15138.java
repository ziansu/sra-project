...
protected java.util.List<com.weibo.api.motan.rpc.URL> discoverService(com.weibo.api.motan.rpc.URL url) {
    try {
        ...
        throw new com.weibo.api.motan.exception.MotanFrameworkException(java.lang.String.format("Failed to discover service %s from zookeeper(%s), cause: %s", url, getUrl(), e.getMessage()), e);
    }
}