...
protected void onCreate(android.os.Bundle savedInstanceState) {
    ...
    if ((assignmentListFragment) == null) {
        ...
        fragmentManager.beginTransaction().replace(R.id.fragmentContainer, assignmentListFragment, com.example.android.grader.activities.MainActivity.ASSIGNMENT_LIST_FRAGMENT).addToBackStack(null).commit();
    }
}