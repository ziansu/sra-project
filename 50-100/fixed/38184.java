...
public void testTransactionSynchronizationInManagedTransaction() throws java.lang.Exception {
    ...
    org.mockito.Mockito.verify(transaction, org.mockito.Mockito.times(1)).registerSynchronization(org.mockito.Mockito.any(javax.transaction.Synchronization.class));
}