public void populateDbView() {
    ...
    if (ruleArray.isEmpty()) {
        ...
        android.widget.ArrayAdapter<com.mhmt.autotextmate.dataobjects.Rule> arrayAdapter = new android.widget.ArrayAdapter<com.mhmt.autotextmate.dataobjects.Rule>(this, android.R.layout.simple_list_item_1, ruleArray);
