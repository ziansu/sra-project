    ...
    switch (accuracy) {
        ...
        default :
            if (accuracy == (amai.org.conventions.AlarmScheduler.Accuracy.UP_TO_1_MINUTE_EARLIER)) {
                time = time - (amai.org.conventions.utils.Dates.MILLISECONDS_IN_MINUTE);
                length = amai.org.conventions.utils.Dates.MILLISECONDS_IN_MINUTE;
            }else {
                length = 5 * (amai.org.conventions.utils.Dates.MILLISECONDS_IN_MINUTE);
            }
