    ...
    return new java.util.HashMap<java.lang.String, java.lang.Object>() {
        {
            ...
            put(SharedPreferencesHelper.EXERCISES, new java.util.ArrayList<java.lang.Object>() {
                {
                    add(com.aff.allformfitness.defaults.ProgramsDefaults.getStrengthExercise(exerciseName1));
                    add(com.aff.allformfitness.defaults.ProgramsDefaults.getStrengthExercise(exerciseName2));
                }
            });
        }
    };
