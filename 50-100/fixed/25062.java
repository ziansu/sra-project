...
public void passVideos(java.util.ArrayList<com.example.android.movie_review_app.data.Video> videos) {
    ...
    video_recyclerView.setLayoutManager(new android.support.v7.widget.LinearLayoutManager(getContext(), android.support.v7.widget.LinearLayoutManager.HORIZONTAL, false));
}