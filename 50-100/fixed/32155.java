...
public void onClick(android.view.View view) {
    ...
    new ai.elimu.appstore.synchronization.AppListArrayAdapter.DownloadApplicationAsyncTask(viewHolder.progressBarDownloadProgress, viewHolder.textViewDownloadProgress, viewHolder.buttonInstall, viewHolder.buttonDownload).execute(applicationVersion);
}