...
public net.minecraft.item.ItemStack getCraftingResult(net.minecraft.inventory.InventoryCrafting inv) {
    ...
    upgradeStack.getCapability(YabbaCommon.UPGRADE_CAPABILITY, null).applyOn(((com.latmod.yabba.api.IBarrelModifiable) (output.getCapability(YabbaCommon.BARREL_CAPABILITY, null))), worldObj, upgradeStack, false);
    return output;
}