...
public void onIncomingMessage(com.sinch.android.rtc.messaging.MessageClient client, com.sinch.android.rtc.messaging.Message message) {
    ...
    com.sinch.android.rtc.messaging.WritableMessage writableMessage = new com.sinch.android.rtc.messaging.WritableMessage(message.getRecipientIds(), message.getTextBody());
