...
public void onClick(android.view.View view) {
    ...
    application.getRealTimeGameData().sendMessageToPartner(new de.appphil.categories.messages.InputMessage(getInput(), application.getRealTimeGameData().getOwnParticipantId()));
