public static corp.skaj.foretagskvitton.view.CompanyListFragment createCompanyList(android.content.Context context, java.util.List<corp.skaj.foretagskvitton.model.Company> companyList) {
    ...
    new corp.skaj.foretagskvitton.controllers.CompanyToolbarController(context, ca);
    return fragment;
}