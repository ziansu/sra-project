private static void loadConfiguration() {
    ...
    com.corwinjv.achunkloader.config.ConfigurationHandler.playerInactivityTimeout = com.corwinjv.achunkloader.config.ConfigurationHandler.configuration.getInt("PlayerInactivityTimeout", Configuration.CATEGORY_GENERAL, 0, 0, 100, "Number of hours after a player has been inactive before disabling the loader.\nUse 0 to disable.");
