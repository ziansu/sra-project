...
public int onStartCommand(android.content.Intent intent, int flags, int startId) {
    ...
    notificationManager.showTestNotification(bundle.getString(GCMReceiver.GCM_EXTRA_TITLE), bundle.getString(GCMReceiver.GCM_EXTRA_SERVER_TIME), bundle.getString(GCMReceiver.GCM_EXTRA_PRIORITIZATION));
