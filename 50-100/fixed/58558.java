...
final java.lang.String toSplit) {
    for (int i = 0; i < (toSplit.length()); i++) {
        ...
        org.hamcrest.MatcherAssert.assertThat(nl.quintor.kennissessie.pbt.strings.StringUtils.splitAt(delimiter, withoutDelimiter), is(java.util.Arrays.asList(withoutDelimiter)));
    }
}