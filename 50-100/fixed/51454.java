@java.lang.Override
@org.exoplatform.commons.api.persistence.ExoTransactional
public void resetNumberOnBadge(java.lang.String userId) {
    ...
    try {
        for (org.exoplatform.commons.notification.impl.jpa.web.entity.WebNotifEntity webNotifEntity : getNewMessage(userId, 0)) {
