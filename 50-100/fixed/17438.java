...
java.lang.String targetBucket) throws org.dasein.cloud.azure.storage.CloudException, org.dasein.cloud.azure.storage.InternalException {
    if (sourceBucket == null) {
        throw new org.dasein.cloud.azure.storage.InternalException("No source bucket was specified");
    }
    if (targetBucket == null) {
        throw new org.dasein.cloud.azure.storage.InternalException("No target bucket was specified");
    }
    if (object == null) {
        throw new org.dasein.cloud.azure.storage.InternalException("No source object was specified");
    }
