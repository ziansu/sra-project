@library.controllers.admin.RequestMapping(value = "/manage/material/save", method = RequestMethod.POST)
public java.lang.String save(@javax.validation.Valid
@library.controllers.admin.ModelAttribute(value = "savMaterial")
library.domain.Material material, org.springframework.validation.BindingResult bindingResult, @library.controllers.admin.RequestParam(value = "materialType", required = true)
int materialType) {
