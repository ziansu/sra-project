public void taskAborted(diskCacheV111.util.PnfsId pnfsId, java.util.Set<java.lang.String> triedSources, int retried, int maxRetries, java.lang.Exception e) {
    ...
    org.dcache.resilience.handlers.FileTaskCompletionHandler.LOGGER.error(org.dcache.alarms.AlarmMarkerFactory.getMarker(PredefinedAlarm.FAILED_REPLICATION, pnfsId.toString()), org.dcache.resilience.handlers.FileTaskCompletionHandler.ABORT_REPLICATION_LOG_MESSAGE, pnfsId, triedSources, new org.dcache.resilience.util.ExceptionMessage(e));
}