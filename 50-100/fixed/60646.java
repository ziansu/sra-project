...
public void testInlineCountAllpages() throws java.lang.Exception {
    ...
    org.apache.olingo.odata2.api.ep.EntityProviderWriteProperties properties = org.apache.olingo.odata2.api.ep.EntityProviderWriteProperties.serviceRoot(org.apache.olingo.odata2.android.xml.BASE_URI).inlineCount(java.lang.Integer.valueOf(103)).inlineCountType(InlineCount.ALLPAGES).build();
