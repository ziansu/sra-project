...
public com.luxoft.wheretogo.controller.UserInfo getUserInfo(java.security.Principal principal) {
    ...
    return new com.luxoft.wheretogo.controller.UserInfo(user.getRole(), user.getEmail(), user.getFirstName(), user.getLastName(), user.isActive(), user.getPicture(), user.getId());
}