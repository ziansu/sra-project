...
public void run() {
    ...
    assertBlobReadSuccess(options, readIntoFuture, asyncWritableChannel, result.getBlobDataChannel(), readCompleteLatch, readCompleteResult, readCompleteException);
}