public void initControllerEmails() throws org.json.JSONException {
    ...
    if (emailDAO.isDatabaseEmpty()) {
        gppmds.wikilegis.controller.RegisterUserController.emailList = gppmds.wikilegis.dao.JSONHelper.emailListFromJSON(gppmds.wikilegis.controller.RegisterUserController.emailList);
