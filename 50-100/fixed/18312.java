public void testSaveAndLoadTaskList() {
    ...
    taskList.add(new com.hazzard.nathan.to_do.Task("Sample1", new java.util.GregorianCalendar(), 1, "Sample1", 1));
    taskList.add(new com.hazzard.nathan.to_do.Task("Sample2", new java.util.GregorianCalendar(), 2, "Sample2", 2));
