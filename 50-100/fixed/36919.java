ru.yakovburtsev.socialnetwork.core.model.User get(java.lang.Long id) {
    ...
    ru.yakovburtsev.socialnetwork.core.model.User user = userMessageReceiver.receive(((ru.yakovburtsev.socialnetwork.webclient.controller.AbstractUserController.GET_USER_SELECTOR) + id));
