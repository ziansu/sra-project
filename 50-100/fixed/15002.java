private void markIncompleteZipFileFinished(java.lang.String fileName, boolean success) throws java.lang.Exception {
    try {
        ...
        com.emc.storageos.systemservices.impl.jobs.backupscheduler.UploadExecutor.log.error("Failed to rename the uploading backup zip file({})", fileName, e);
        throw e;
    }
}