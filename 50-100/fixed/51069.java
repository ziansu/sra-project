public org.uma.jmetal.algorithm.multiobjective.rnsgaii.util.PreferenceNSGAII<S> createUtilityFunction() {
    ...
    org.uma.jmetal.algorithm.multiobjective.rnsgaii.util.PreferenceNSGAII<S> aux = new org.uma.jmetal.algorithm.multiobjective.rnsgaii.util.PreferenceNSGAII<S>(weights);
    return aux;
}