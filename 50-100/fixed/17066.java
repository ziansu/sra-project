public void getFilter(android.content.Context c, org.json.JSONArray filteredInstruments) {
    com.melodies.bandup.DatabaseSingleton.getInstance(c).getBandUpDatabase().postInstruments(filteredInstruments, new com.melodies.bandup.listeners.BandUpResponseListener() {
        @java.lang.Override
