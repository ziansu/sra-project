private void getState() {
    com.shanejansen.thelodge.data.DataManager.refreshDevices(new com.shanejansen.thelodge.data.DataManager.NetworkInf<java.util.List<com.shanejansen.thelodge.data.Device>>() {
        @java.lang.Override
