public java.lang.String getUserImgUrl(java.lang.Integer userId) {
    try {
        java.util.List<com.vk.api.sdk.objects.users.UserXtrCounters> list = vkApiClient.users().get(getUserActor()).unsafeParam("user_id", userId).unsafeParam("fields", "photo_400_orig").execute();
