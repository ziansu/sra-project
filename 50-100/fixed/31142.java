@org.terasology.logic.console.commandSystem.annotations.Command(shortDescription = "Building generation test", runOnServer = true)
public void build() {
    ...
    if ((worldProvider) != null) {
        worldProvider.getWorldEntity().send(new org.terasology.world.block.entity.placement.PlaceBlocks(collection.getBlocks(targetPos)));
    }
