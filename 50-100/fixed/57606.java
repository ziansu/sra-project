...
public void testToggleEditMode() throws java.lang.Exception {
    ...
    org.mockito.Mockito.verify(spy).replaceFragment(org.mockito.Mockito.any(android.os.Bundle.class), org.mockito.Mockito.any(com.dariuszdeoniziak.charades.views.fragments.CategoriesFormFragment.class), org.mockito.Matchers.eq(R.id.fragment_container), org.mockito.Matchers.eq(fragment.TAG), org.mockito.Matchers.eq(true));
    spy.toggleViewMode(null);
