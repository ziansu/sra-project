...
public void testCollectionAsBasic() {
    ...
    try {
        org.hibernate.boot.Metadata metadata = new org.hibernate.boot.MetadataSources(ssr).addAnnotatedClass(org.hibernate.test.annotations.basic.CollectionAsBasicTest.Post.class).getMetadataBuilder().applyBasicType(new org.hibernate.test.annotations.basic.CollectionAsBasicTest.DelimitedStringsType()).build();
