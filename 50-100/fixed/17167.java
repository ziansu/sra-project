public long dailyWorkingTimeOf(long start, long end) {
    ...
    if (worked >= (com.runafter.wtt.WorkingTimeCalculator.MILLISECONDS_OF_8_HOURS))
        return java.lang.Math.min((worked - (com.runafter.wtt.WorkingTimeCalculator.MILLISECONDS_OF_1_HOUR)), com.runafter.wtt.WorkingTimeCalculator.MILLISECONDS_OF_12_HOURS);
