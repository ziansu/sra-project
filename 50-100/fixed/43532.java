public void embeddedCodeContainsStoredOrientation() {
    ...
    org.junit.Assert.assertTrue(java.lang.String.format("The embedded code orientation value is: %s but the orientation value which was stored before is: %s ", embeddedOrientationValue.toLowerCase(), orientationValue), embeddedOrientationValue.equalsIgnoreCase(orientationValue));
}