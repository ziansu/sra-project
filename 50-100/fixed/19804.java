...
public seedu.address.logic.commands.CommandResult execute() {
    ...
    return new seedu.address.logic.commands.CommandResult(java.lang.String.format(seedu.address.logic.commands.DeleteCommand.MESSAGE_DELETE_ITEM_SUCCESS, itemToDelete), itemToDelete);
}