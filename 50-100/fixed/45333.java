public static java.lang.String getPersianDate(long timeMillies, boolean isFull) {
    ...
    ir.anamsoftware.persiandateultimate.ManamPDUltimate m = new ir.anamsoftware.persiandateultimate.ManamPDUltimate(((date.getYear()) + 1900), ((date.getMonth()) + 1), date.getDate());
    if (!isFull)
