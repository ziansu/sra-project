private static void registerItemModel(net.minecraft.item.Item item, int meta, java.lang.String resourcePath) {
    net.minecraft.client.resources.model.ModelResourceLocation modelResourceLocation = new net.minecraft.client.resources.model.ModelResourceLocation(resourcePath, "inventory");
