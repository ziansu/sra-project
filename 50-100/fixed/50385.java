public eu.europa.ec.fisheries.uvms.rules.service.business.fact.CodeType mapToCodeType(eu.europa.ec.fisheries.uvms.rules.service.business.fact.CodeType codeType) {
    if (codeType == null) {
        return null;
    }
