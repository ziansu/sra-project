...
public void setup(org.apache.drill.exec.physical.impl.OutputMutator output) throws org.apache.drill.common.exceptions.ExecutionSetupException {
    ...
    this.jsonReader = new org.apache.drill.exec.vector.complex.fn.JsonReader(fragmentContext.getManagedBuffer(), com.google.common.collect.Lists.newArrayList(getColumns()), enableAllTextMode, false, readNumbersAsDouble);
