private java.lang.String checkForProblem(final com.sap.cloud.sdk.s4hana.serialization.SapClient sapClient) {
    try {
        final com.sap.cloud.sdk.s4hana.connectivity.ErpConfigContext config = new com.sap.cloud.sdk.s4hana.connectivity.ErpConfigContext(com.sap.cloud.sdk.s4hana.connectivity.ErpDestination.getDefaultName(), sapClient, java.util.Locale.ENGLISH);
