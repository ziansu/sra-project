...
public void minimalDriverConfiguration() throws java.rmi.RemoteException {
    ...
    verify(mockedClient).configure(org.mockito.Matchers.any(com.elastisys.scale.cloudpool.vsphere.driver.config.VsphereApiSettings.class), org.mockito.Matchers.any(com.elastisys.scale.cloudpool.vsphere.driver.config.VsphereProvisioningTemplate.class));
}