...
public void acceptNothingAfterProvidedDependency() throws java.lang.Exception {
    ...
    org.commonjava.maven.cartographer.testutil.PresetAssertions.assertConcreteAcceptance(child, from, src, tgt, new java.util.HashSet<org.commonjava.maven.atlas.ident.DependencyScope>(), org.commonjava.maven.atlas.graph.rel.RelationshipType.PARENT);
