@java.lang.Override
public java.util.List<com.twobig.sivale.hd.to.Invoice> getInvoicesNoTransactionBetweenDates(java.util.Date startDate, java.util.Date endDate, java.lang.String cardNumber) {
    ...
    invoice.setTransactionId(CommonsConstants.NO_CONCILIATION_FLAG);
    return invoiceDAO.getInvoiceByDateRange(startDateStr, endDateStr, invoice);
}