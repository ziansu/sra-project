...
public void running() throws java.io.UnsupportedEncodingException {
    org.mockserver.model.HttpRequest[] requests = new org.mockserver.model.HttpRequest[]{ prepareUpdateCommitStatusWithSuccessResponse("test/project", "123abc", ((jenkins.getInstance().getRootUrl()) + "/build/123"), BuildState.running) };
