...
public void run() {
    try {
        pixyel_backend.userinterface.Userinterface.vaadinJettyServer = new pixyel_backend.userinterface.VaadinJettyServer(pixyel_backend.userinterface.Userinterface.PORT, pixyel_backend.userinterface.Userinterface.class);
