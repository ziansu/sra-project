private backtype.storm.sharedcontext.ShareContext.Node findNode(java.lang.String path, boolean force) throws java.lang.Exception {
    ...
    for (java.lang.String token : tokens) {
        ...
        if (!(e.children.containsKey(token))) {
            if (force) {
                ...
                throw new java.lang.Exception("path not exist!");
            }
        }
