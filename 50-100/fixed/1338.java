...
java.lang.Integer mainScreenImage) {
    userService.modifyUser(new myddl.entity.UserPassword(userId, null, password), new myddl.entity.UserInfo(userId, userName, userImage, userPhone, userEmail, mainScreenImage));
