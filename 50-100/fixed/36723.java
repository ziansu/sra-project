...
public org.springframework.web.servlet.ModelAndView MySubmissionsSearch(javax.servlet.http.HttpServletRequest request) {
    ...
    org.springframework.web.servlet.ModelAndView mav = internalSearch(uk.ac.ebi.metabolights.controller.WSSearchController.MY_SUBMISSIONS, query, uk.ac.ebi.metabolights.controller.WSSearchController.MY_SUBMISSIONS);
    return mav;
}