...
public void ShouldNotCreateAFacilityIfAlreadyExists() throws org.motechproject.ghana.national.exception.FacilityAlreadyFoundException {
    ...
    when(mockAllFacilities.facilities()).thenReturn(java.util.Arrays.asList(new org.motechproject.ghana.national.domain.Facility(new org.motechproject.mrs.model.MRSFacility(facilityName, country, region, district, province))));
