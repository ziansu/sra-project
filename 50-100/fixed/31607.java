public static org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.inet.types.rev100924.Ipv4Prefix prefixForBytes(final byte[] bytes, final int length) {
    ...
    final byte[] tmp;
    if ((bytes.length) != (org.opendaylight.protocol.util.Ipv4Util.IP4_LENGTH)) {
        tmp = java.util.Arrays.copyOfRange(bytes, 0, org.opendaylight.protocol.util.Ipv4Util.IP4_LENGTH);
    }else {
        tmp = bytes;
    }
