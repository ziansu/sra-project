public boolean register(java.lang.String username, java.lang.String password, java.lang.String email) throws java.lang.Exception {
    ...
    java.lang.String sql = java.lang.String.format("INSERT INTO user(username,password,email,avatar,status) VALUES (\"%s\",\"%s\",\"%s\",concat((floor(rand()*8)+1),\'.jpg\'),\"%d\")", username, code, email, 0);
