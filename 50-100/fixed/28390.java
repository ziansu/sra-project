...
org.tdl.vireo.model.Configuration configuration) {
    ...
    simpMessagingTemplate.convertAndSend("/channel/settings/configurable", new edu.tamu.framework.model.ApiResponse(edu.tamu.framework.enums.ApiResponseType.SUCCESS, configuration));
