private org.wso2.carbon.appfactory.core.dto.ApplicationSummary getAppInfoSummaryFromRXT(org.wso2.carbon.governance.api.generic.dataobjects.GenericArtifact artifact) throws org.wso2.carbon.appfactory.common.AppFactoryException {
    ...
    try {
        appInfo = new org.wso2.carbon.appfactory.core.dto.ApplicationSummary(artifact.getAttribute(AppFactoryConstants.RXT_KEY_APPINFO_NAME), artifact.getAttribute(AppFactoryConstants.RXT_KEY_APPINFO_KEY), artifact.getAttribute(AppFactoryConstants.RXT_KEY_APPINFO_TYPE));
