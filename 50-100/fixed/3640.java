...
public org.springframework.http.ResponseEntity<java.lang.Void> updateProduct(@org.springframework.web.bind.annotation.PathVariable(value = "id")
int id, @org.springframework.web.bind.annotation.RequestBody
com.IJM.dto.ProductImageDto productImageDto) {
    java.lang.System.out.println(("Updating ProductImageDto " + id));
