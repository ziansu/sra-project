public org.opendaylight.yangtools.yang.data.api.schema.NormalizedNode<?, ?> normalizedNodeFromJsonString(final java.lang.String inputJson) {
    ...
    final org.opendaylight.yangtools.yang.data.codec.gson.JsonParserStream jsonParser = org.opendaylight.yangtools.yang.data.codec.gson.JsonParserStream.create(streamWriter, this.context);
