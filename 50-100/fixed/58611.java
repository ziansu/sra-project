...
public void removeAllSubTasksTest() {
    ...
    child0 = new net.sf.memoranda.TaskImpl(new java.util.ArrayList<net.sf.memoranda.Task>());
    container.add(child0);
    net.sf.memoranda.Task child1;
    child1 = new net.sf.memoranda.TaskImpl(new java.util.ArrayList<net.sf.memoranda.Task>());
