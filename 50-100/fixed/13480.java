private void updateByPriorityLevel(seedu.address.model.Task.Priority priority) {
    if (this.priority.toString().equals(seedu.address.logic.commands.FindCommand.HIGH_PRIORITY)) {
        model.updateFilteredTaskListByHighPriority();
    }else
        if (this.priority.toString().equals(seedu.address.logic.commands.FindCommand.MEDIUM_PRIORITY)) {
            model.updateFilteredTaskListByMediumPriority();
        }else
            if (this.priority.toString().equals(seedu.address.logic.commands.FindCommand.LOW_PRIORITY)) {
