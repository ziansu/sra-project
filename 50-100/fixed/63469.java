public void addRecord(com.experiment.chickenjohn.materialdemo.EcgData ecgData) {
    ...
    if (((dataId % 500) != 0) || (dataId == 0)) {
        ...
        com.experiment.chickenjohn.materialdemo.EcgDatabaseManager.dataInsertingThread dataInsertingThread = new com.experiment.chickenjohn.materialdemo.EcgDatabaseManager.dataInsertingThread(ecgData);
