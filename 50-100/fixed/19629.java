...
com.intellij.openapi.project.Project project, com.intellij.openapi.actionSystem.AnActionEvent event) throws com.intellij.execution.ExecutionException {
    ...
    if (pair != null) {
        ...
        io.flutter.FlutterErrors.showError(io.flutter.FlutterBundle.message("flutter.command.missing.pubspec"), io.flutter.FlutterBundle.message("flutter.command.missing.pubspec.message", io.flutter.actions.FlutterPackagesGetAction.COMMAND.title));
    }
}