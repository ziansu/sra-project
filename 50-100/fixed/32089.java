...
final android.content.Context context) {
    ...
    for (final android.content.pm.ResolveInfo x : context.getPackageManager().queryBroadcastReceivers(new <android.content.com.twofortyfouram.locale.api.Intent>android.content.Intent(), 0)) {
