...
@org.springframework.web.bind.annotation.RequestMapping(value = "{settingId}", method = org.springframework.web.bind.annotation.RequestMethod.GET)
...
long settingId) throws org.openbox.sf5.json.exceptions.NotAuthenticatedException {
    ...
    return new org.springframework.http.ResponseEntity(setting, org.springframework.http.HttpStatus.OK);
}