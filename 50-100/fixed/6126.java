...
public void testExpandSkipLimit() {
    ...
    java.util.List<com.orientechnologies.orient.core.db.record.OIdentifiable> results = db.query(sql);
    org.testng.Assert.assertEquals(results.size(), 1);
    com.orientechnologies.orient.core.record.impl.ODocument doc = results.get(0).getRecord();
