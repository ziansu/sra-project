public void saveImage(android.view.View view) {
    ...
    imageHelper.saveImageData(getApplicationContext(), de.uni_koeln.phil_fak.spinfo.javamobile.picman.activity.util.TimeStamper.getInstance().generateTimestamp(false), uri, thumbnail, getText(), de.uni_koeln.phil_fak.spinfo.javamobile.picman.activity.util.TimeStamper.getInstance().generateTimestamp(true));
