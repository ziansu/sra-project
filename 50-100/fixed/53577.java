...
public void locationIsSentToRestaurantsActivity() {
    ...
    android.support.test.espresso.Espresso.onView(android.support.test.espresso.matcher.ViewMatchers.withId(R.id.findRestaurantsButton)).perform(android.support.test.espresso.action.ViewActions.click());
