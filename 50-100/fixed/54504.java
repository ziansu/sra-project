private void searchAndRemoveGraphicalSynapseCongif(org.eclipse.core.resources.IProject project) {
    try {
        ...
        org.wso2.developerstudio.eclipse.distribution.project.ui.wizard.ProjectImportWizard.log.error((("Error while deleting graphical-synapse-config directory in " + project) + e));
    }
}