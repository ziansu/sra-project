public void setupFirebase() {
    if (mbIsGrocery) {
        mListRef = new com.firebase.client.Firebase(edu.pacificu.cs493f15_1.utils.Constants.FIREBASE_URL_GROCERY_LISTS).child(mListID);
        ...
        mListRef = new com.firebase.client.Firebase(edu.pacificu.cs493f15_1.utils.Constants.FIREBASE_URL_KITCHEN_INVENTORY).child(mListID);
