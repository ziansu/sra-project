private void getCardByPages() throws java.io.IOException {
    for (int page = minCardPage; page <= (maxCardPage); page++) {
        if (com.thoughtworks.lhli.lovelive_rock.LoveLiveApp.getInstance().isNetworkAvailable()) {
            retrofit.Call<com.thoughtworks.lhli.lovelive_rock.model.MultipleCards> call = com.thoughtworks.lhli.lovelive_rock.Retrofit.getInstance().getCardService().getCardList(page, true);
            ...
            java.lang.System.out.print((("Get cards from " + page) + " pages failed."));
        }
    }
}