private java.util.List<java.lang.String> parseConfigurationFile(java.lang.String path) {
    java.util.List<java.lang.String> configuration = readFileToLines("annotation.conf", path);
