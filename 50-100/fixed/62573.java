private void sendRequest(net.exclaimindustries.geohashdroid.util.Graticule g) {
    ...
    request.setAction(StockService.ACTION_STOCK_REQUEST).putExtra(StockService.EXTRA_GRATICULE, g).putExtra(StockService.EXTRA_DATE, cal).putExtra(StockService.EXTRA_REQUEST_ID, ((cal.getTimeInMillis()) / 1000)).putExtra(StockService.EXTRA_REQUEST_FLAGS, StockService.FLAG_ALARM);
