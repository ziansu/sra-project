public static final <K> void incrementValues(final it.unimi.dsi.fastutil.objects.Object2IntMap<K> map, final java.util.Collection<? extends K> keysToIncrement, final int increment, final int fromValue, final int toValue) {
