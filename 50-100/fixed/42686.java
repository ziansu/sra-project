public void onFullTransaction(java.lang.Integer transId, java.lang.String tradesInMessage) {
    ...
    final com.fourcasters.forec.reconciler.server.persist.TradeTaskFactory.FullTask task = taskFactory.newFullReconciliationTask(tradesInMessage, this, transId, (t == null));
    if (t == null) {
