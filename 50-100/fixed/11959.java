...
public co.cask.cdap.store.NamespaceMDS get() {
    ...
    try {
        ...
        try {
            co.cask.cdap.data2.datafabric.dataset.DatasetsUtil.getOrCreateDataset(dsFramework, co.cask.cdap.store.DefaultNamespaceStore.APP_META_INSTANCE_ID, "table", DatasetProperties.EMPTY, DatasetDefinition.NO_ARGUMENTS, null);
            table = dsCache.getDataset(co.cask.cdap.store.DefaultNamespaceStore.APP_META_INSTANCE_ID.getId());
