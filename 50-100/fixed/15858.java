public void storeOneFile(com.baidu.disconf.client.common.model.DisconfCenterBaseModel disconfCenterBaseModel) {
    ...
    if (confFileMap.containsKey(fileName)) {
        com.baidu.disconf.client.store.inner.DisconfCenterStore.LOGGER.error((((("There are two same fileName!!!! " + "first: ") + (confFileMap.get(fileName).toString())) + ", Second: ") + (disconfCenterFile.toString())));
    }else {
