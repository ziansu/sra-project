private java.sql.ResultSet queryForColumnsInFactTable(java.sql.DatabaseMetaData dmd) throws java.sql.SQLException {
    ...
    return dmd.getColumns(null, (isSchemaDefined(tableNameParts) ? tableNameParts[0].toUpperCase() : ""), (isSchemaDefined(tableNameParts) ? tableNameParts[1].toUpperCase() : tableNameParts[0].toUpperCase()), null);
}