public static java.util.UUID getUUIDOf(java.lang.String name) {
    if (!(name.richardson.james.bukkit.banhammer.model.UUIDFetcher.CACHE.containsKey(name.toLowerCase()))) {
    ...
    return name.richardson.james.bukkit.banhammer.model.UUIDFetcher.CACHE.get(name.toLowerCase());
}