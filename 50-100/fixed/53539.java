protected <K, V> com.hazelcast.core.IMap<K, V> getNearCachedMapFromClient(com.hazelcast.config.Config config, com.hazelcast.config.NearCacheConfig nearCacheConfig) {
