private void validateLabel(java.lang.String label) {
    ...
    if ((label != null) && ((label.length()) < minLength)) {
        ...
        throw DatabaseException.fatals.fieldLengthTooShort(clazzName, this.getId(), com.emc.storageos.db.client.model.DataObject.READ_LABEL_METHOD_NAME, label.length(), minLength);
    }
}