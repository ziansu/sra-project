public io.getcoffee.motionprofiles.Tuple<io.getcoffee.motionprofiles.MotionTrajectoryPoint, io.getcoffee.motionprofiles.MotionTrajectoryPoint> calcPoint(int tick) {
    ...
    return new io.getcoffee.motionprofiles.Tuple<io.getcoffee.motionprofiles.MotionTrajectoryPoint, io.getcoffee.motionprofiles.MotionTrajectoryPoint>(leftWheelTick.getY().findSetPoint(leftWheelTick.getX(), tick), rightWheelTick.getY().findSetPoint(rightWheelTick.getX(), tick));
}