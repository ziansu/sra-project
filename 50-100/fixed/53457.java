private void Initialize() {
    ...
    ListenButton = ((android.widget.Button) (findViewById(R.id.startListeningButton)));
    StatusTextView = ((android.widget.TextView) (findViewById(R.id.virtualAssistantStatus)));
}