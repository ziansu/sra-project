public void applyTranslation(org.nschmidt.ldparteditor.composites.Composite3D c3d) {
    if (modified) {
        ...
        org.nschmidt.ldparteditor.shells.editor3d.Editor3DWindow.getWindow().updateInitialScale(org.nschmidt.ldparteditor.helpers.Manipulator.initialScaleNew, org.nschmidt.ldparteditor.helpers.Manipulator.factor_Scale, false);
    }
    resetTranslation();
}