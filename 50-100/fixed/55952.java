...
protected void onPostExecute(java.lang.Integer integer) {
    ...
    edu.gcc.whiletrue.pingit.SecurePreferences preferences = new edu.gcc.whiletrue.pingit.SecurePreferences(fragmentContext, getString(R.string.pref_login), edu.gcc.whiletrue.pingit.SecurePreferences.generateDeviceUUID(fragmentContext), true);
    preferences.clear();
