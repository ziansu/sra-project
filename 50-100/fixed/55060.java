private java.io.InputStream extractClassTemplateIncurrentPlugin() {
    try {
        java.io.InputStream _xblockexpression = null;
        {
            ...
            _xblockexpression = org.eclipse.core.runtime.FileLocator.openStream(codegenBundle, path, false);
        }
