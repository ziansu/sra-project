...
public void execute() throws java.lang.Exception {
    for (org.dkpro.lab.task.TaskContextMetadata subcontext : getSubtasks()) {
        if (((org.dkpro.tc.examples.single.sequence.ContextMemoryReport.adapter) != null) && (subcontext.getType().contains(org.dkpro.tc.examples.single.sequence.ContextMemoryReport.adapter))) {
