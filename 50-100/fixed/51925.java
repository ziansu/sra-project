...
public void termiateTask_findThenTerminate_success() throws java.lang.Exception {
    ...
    seedu.taskboss.testutil.TestTask terminatedTask = new seedu.taskboss.testutil.TaskBuilder(taskToTerminate).withCategories("Done").build();
    seedu.taskboss.testutil.TestTask[] resultList = new seedu.taskboss.testutil.TestTask[]{ terminatedTask };
