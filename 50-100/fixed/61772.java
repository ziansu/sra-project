private void refreshUIButtons() {
    btnShowFavourites.setBackgroundResource((com.doruchidean.clujbikemap.helpers.PersistenceManager.getShowFavouritesOnly(this) ? R.drawable.ic_favourites_pressed : R.drawable.ic_favourite));
