void addWatchCallbacks(java.lang.String path, java.lang.String sessionId) {
    if ((backtype.storm.sharedcontext.ShareContext.watchedPaths.containsKey(path)) && ((backtype.storm.sharedcontext.ShareContext.watchedPaths.get(path)) != null)) {
