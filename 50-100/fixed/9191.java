...
protected void onDataSourceServiceReady(org.wso2.carbon.datasource.core.api.DataSourceService service) {
    try {
        ...
        org.wso2.carbon.datasource.sample.DataSourceServiceListenerComponent.logger.error("error occurred while fetching the data source.", e);
    } catch (java.sql.SQLException e) {
        org.wso2.carbon.datasource.sample.DataSourceServiceListenerComponent.logger.error("error occurred while fetching the connection.", e);
    }
}