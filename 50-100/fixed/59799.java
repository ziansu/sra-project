...
public void onInput(com.afollestad.materialdialogs.MaterialDialog materialDialog, java.lang.CharSequence input) {
    db.addSolve(new com.aricneto.twistytimer.items.Solve(1, currentPuzzle, input.toString(), 0L, "", com.aricneto.twistytimer.utils.PuzzleUtils.PENALTY_HIDETIME, "", true));
