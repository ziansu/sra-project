public static void cancelScheduledNotifications(android.content.Context context) {
    ...
    android.app.PendingIntent rebuyPendingIntent = net.chokethe.killerdealer.notifications.NotificationUtils.getPendingIntent(context, NotificationPublisher.REBUY_NOTIFICATION_ACTION);
