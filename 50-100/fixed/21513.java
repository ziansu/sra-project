...
public java.lang.String getZplCode(fr.w3blog.zpl.model.PrinterOptions printerOptions) {
    ...
    zpl.append(fr.w3blog.zpl.utils.ZplUtils.zplCommandSautLigne("BC", zebraRotation.getLetter(), barCodeHeigth, showTextInterpretation, showTextInterpretationAbove, checkDigit43));
    zpl.append("^FD");
    zpl.append(text);
