static java.util.List<java.lang.String> configListProperty(java.lang.String fileName, java.lang.String propertyName, java.lang.String defaultValue) {
    ...
    java.util.List<java.lang.String> list = (property.isEmpty()) ? new java.util.ArrayList<java.lang.String>() : java.util.Arrays.asList(property.split(vn.com.solution.ntq.glastool.config.ConfigMethod.ROW_SEPARATOR));
    return list;
}