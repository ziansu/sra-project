...
public void init() {
    ...
    addAttribute(org.molgenis.data.mapper.meta.AttributeMappingMetaData.SOURCEATTRIBUTEMETADATAS).setDataType(org.molgenis.MolgenisFieldTypes.AttributeType.TEXT);
