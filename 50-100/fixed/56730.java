public void buildNotification(android.content.Context ctx) {
    ...
    notifBuilder = ((android.support.v7.app.NotificationCompat.Builder) (new android.support.v7.app.NotificationCompat.Builder(ctx).setContentTitle(musicTitle).setContentText(musicDesc).setContentIntent(pendingIntent)));
