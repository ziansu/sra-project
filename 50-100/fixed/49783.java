...
public javax.ws.rs.core.Response authenticate(final org.picketlink.credential.DefaultLoginCredentials credential) {
    ...
    return token.isPresent() ? javax.ws.rs.core.Response.ok(javax.ws.rs.client.Entity.text(token.get())).build() : javax.ws.rs.core.Response.status(Status.FORBIDDEN).build();
}