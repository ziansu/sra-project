public void updateMovies() {
    if (isConnected()) {
        edu.boisestate.azamattulepbergenovu.popularmovies.fetch.FetchMovieDataTask task = new edu.boisestate.azamattulepbergenovu.popularmovies.fetch.FetchMovieDataTask(getActivity());
