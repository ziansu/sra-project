public android.app.Dialog showAgreePermissonDialog(android.content.Context context, final com.xinyi.czbasedevtool.base.interfaces.listener.OnTaskDoneListener doNextListener) {
    closeAllDialog();
    com.afollestad.materialdialogs.MaterialDialog materialDialog = com.xinyi.czbasedevtool.base.manager.ui_about.dialog.MaterialDialogFactory.getInstance(context).createMaterialDialog("权限申请", "接下来的权限提示请点击同意，否则无法往后执行！", "同意", new com.afollestad.materialdialogs.MaterialDialog.SingleButtonCallback() {
        @java.lang.Override
