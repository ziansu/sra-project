...
public void findActionsByActionTypeNotFound() throws java.lang.Exception {
    ...
    org.springframework.test.web.servlet.ResultActions resultActions = mockMvc.perform(getJson(java.lang.String.format("/actions?actiontype=%s", uk.gov.ons.ctp.response.action.endpoint.ActionEndpointUnitTest.ACTION_TYPE_NOTFOUND)));
