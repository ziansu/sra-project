...
final java.lang.String script) {
    try {
        ...
        return org.jenkinsci.plugins.pollmailboxtrigger.PollMailboxTrigger.checkForEmails(properties, new org.jenkinsci.lib.xtrigger.XTriggerLog(new hudson.util.StreamTaskListener(Logger.DEFAULT.getOutputStream())), true, null);
