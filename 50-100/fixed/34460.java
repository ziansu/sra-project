...
public java.lang.String getLoginPage(org.springframework.ui.Model model, @org.springframework.web.bind.annotation.RequestParam(required = false)
...
java.lang.String logout) {
    ...
    model.addAttribute("loginForm", new by.epam.jmp.app.tradesystem.web.dto.LoginFormDTO());
    return "login";
}