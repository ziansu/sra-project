...
public void onActivityResult(int requestCode, int resultCode, android.content.Intent data) {
    if (resultCode == (RESULT_OK)) {
        if (requestCode == (org.softeg.slartus.forpdaplus.prefs.PreferencesActivity.PrefsFragment.MY_INTENT_CLICK)) {
            ...
            java.lang.String selectedImagePath = org.softeg.slartus.forpdaplus.classes.ImageFilePath.getPath(org.softeg.slartus.forpdaplus.App.getContext(), selectedImageUri);
