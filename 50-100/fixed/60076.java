...
public com.bqreaders.lib.token.TokenGrant createToken(com.bqreaders.lib.token.TokenInfo info, long expiresIn, java.lang.String... tags) {
    ...
    if (info.isOneUseToken()) {
        oneTimeAccessTokenRepository.save(new com.bqreaders.lib.token.model.OneTimeAccessToken(token, java.util.Date.from(expireTime), java.util.Arrays.asList(tags)));
    }
