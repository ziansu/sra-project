...
org.jetbrains.kotlin.resolve.calls.model.ResolvedCall<org.jetbrains.kotlin.codegen.FunctionDescriptor> resolvedCall, final int indexInPropertyMetadataArray, int propertyMetadataArgumentIndex) {
    ...
    return org.jetbrains.kotlin.codegen.PropertyCodegen.invokeDelegatedPropertyConventionMethodWithReceiver(codegen, typeMapper, resolvedCall, indexInPropertyMetadataArray, propertyMetadataArgumentIndex, receiver, propertyDescriptor);
}