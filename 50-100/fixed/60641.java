...
public org.springframework.http.ResponseEntity<java.util.List<com.roommanagement.beans.Room>> roomRange(@org.springframework.web.bind.annotation.RequestHeader
java.lang.String authToken, @org.springframework.web.bind.annotation.PathVariable(value = "start")
int start, @org.springframework.web.bind.annotation.PathVariable(value = "end")
int end) {
