private void loadPreferences(android.content.SharedPreferences sharedPreferences) {
    ...
    mIrWakeUpEnabled = sharedPreferences.getBoolean(com.cyanogenmod.settings.device.CMActionsSettings.GESTURE_IR_WAKEUP_KEY, true);
    mPickUpGestureEnabled = sharedPreferences.getBoolean(com.cyanogenmod.settings.device.CMActionsSettings.GESTURE_PICK_UP_KEY, true);
    mIrSilencerEnabled = sharedPreferences.getBoolean(com.cyanogenmod.settings.device.CMActionsSettings.GESTURE_IR_SILENCER_KEY, true);
}