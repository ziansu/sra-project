...
public org.springframework.beans.factory.FactoryBean<java.util.Properties> dynamicProperties() {
    ...
    factoryBean.setLocations(new org.springframework.core.io.ClassPathResource("/yamj3-core-dynamic.properties"), new org.springframework.core.io.ClassPathResource((("/yamj3-core-dynamic." + defLang) + ".properties")));
    return factoryBean;
}