...
public static void setupTest() throws java.lang.Exception {
    ...
    co.cask.hydrator.plugin.batch.source.BatchXMLFileFilterTest.sourceFolderUri = co.cask.hydrator.plugin.batch.source.BatchXMLFileFilterTest.sourceFolder.toString();
