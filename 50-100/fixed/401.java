...
public org.springframework.cache.CacheManager cacheManager() {
    ...
    org.springframework.cache.guava.GuavaCache eventsCache = new org.springframework.cache.guava.GuavaCache(lv.tsi.calendar.config.CacheConfiguration.EVENTS_CACHE, com.google.common.cache.CacheBuilder.newBuilder().maximumSize(663).expireAfterWrite(24, java.util.concurrent.TimeUnit.HOURS).build());
