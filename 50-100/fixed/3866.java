public static void init() {
    net.minecraftforge.fml.common.registry.EntityRegistry.registerModEntity(net.thedragonteam.armorplus.entity.entityzombie.EntityEnderDragonZombie.class, "ender_dragon_zombie", net.thedragonteam.armorplus.entity.ARPEntities.ENDER_DRAGON_ZOMBIE, ArmorPlus.instance, 64, 1, true, 8704, 65280);
