private com.google.maps.android.geojson.GeoJsonGeometry createGeoJsonPolygon(com.google.android.gms.maps.Projection projection) {
    ...
    com.vividsolutions.jts.geom.Polygon polygon = ((com.vividsolutions.jts.geom.Polygon) (at.jku.cis.radar.convert.GeometryTransformator.transformToGeometry(geoJsonPolygon)));
    if (polygon.isSimple()) {
