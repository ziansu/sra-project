...
public android.support.v4.content.Loader<android.database.Cursor> onCreateLoader(int i, android.os.Bundle bundle) {
    java.lang.String locationSetting = com.example.mshukla.cloudy.Utility.getPreferredLocation(getContext());
    ...
    return new android.support.v4.content.CursorLoader(getContext(), weatherForLocationUri, com.example.mshukla.cloudy.ForecastFragment.FORECAST_COLUMNS, null, null, sortOrder);
}