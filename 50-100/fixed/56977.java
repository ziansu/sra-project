private boolean getItem(org.bukkit.entity.LivingEntity target, java.lang.String item) {
    ...
    if ((maybeItem = this.mythicmobs.getItemManager().getItem(itemString)).isPresent()) {
        ...
        target.getEquipment().setHelmet(io.lumine.xikage.mythicmobs.adapters.bukkit.BukkitAdapter.adapt(mi.generateItemStack(1)));
        return true;
    }
    return false;
}