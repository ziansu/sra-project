...
public int onStartCommand(android.content.Intent intent, int flags, int startId) {
    ...
    java.lang.String type = intent.getStringExtra("type");
    new com.example.por.project_test.DownloadFileService.DownloadTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, url, filename, type);
