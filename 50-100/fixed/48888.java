...
java.lang.String patientWithFingerprint) throws java.lang.Exception {
    ...
    if (muzimaFingerprint == null) {
        org.openmrs.module.muzimabiometrics.model.PatientFingerPrintModel patient = service.addFingerprintToPatient(patientWithFingerprint, firstImageBytes, secondImageBytes, thirdImageBytes);
