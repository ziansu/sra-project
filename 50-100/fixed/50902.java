...
rx.Observable<java.lang.String> getAddItemInputObservable(android.content.Context context) {
    return com.jakewharton.rxbinding.widget.RxTextView.afterTextChangeEvents(input).observeOn(rx.android.schedulers.AndroidSchedulers.mainThread()).map(new rx.functions.Func1<com.jakewharton.rxbinding.widget.TextViewAfterTextChangeEvent, java.lang.String>() {
        @java.lang.Override
