protected void createGroup(java.lang.String title) {
    android.widget.LinearLayout layout = ((android.widget.LinearLayout) (android.view.LayoutInflater.from(parent.getContext()).inflate(R.layout.empty_component_group, parent, false)));
