...
public void init() {
    ...
    final com.b2international.snowowl.snomed.datastore.id.gen.ItemIdGenerationStrategy idGenerationStrategy = new com.b2international.snowowl.snomed.datastore.id.gen.SequentialItemIdGenerationStrategy(store, reservationService);
    service = new com.b2international.snowowl.snomed.datastore.id.memory.DefaultSnomedIdentifierService(store, idGenerationStrategy, reservationService, new com.b2international.snowowl.snomed.datastore.config.SnomedIdentifierConfiguration());
}