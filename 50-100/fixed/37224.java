...
public void testCalculateScore3() {
    ...
    h.allocate(new org.cloudish.borg.model.Task(0, 10, 0.3, 0.1, 11, true, new java.util.ArrayList<>()));
    org.junit.Assert.assertEquals(6, score.calculateScore(null, h), org.cloudish.score.TestBalancedResourceAllocationRankingScore.ACCEPTABLE_DIFF);
}