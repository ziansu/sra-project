private int getPrefixIndexMinLength() {
    ...
    try {
        java.lang.reflect.Method method = com.emc.storageos.db.client.model.DataObject.class.getDeclaredMethod(com.emc.storageos.db.client.model.DataObject.READ_LABEL_METHOD_NAME, null);
