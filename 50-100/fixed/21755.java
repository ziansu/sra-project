...
public java.util.List<com.microsoft.azure.management.storage.StorageAccountKey> regenerateKey(java.lang.String keyName) throws com.microsoft.azure.CloudException, java.io.IOException {
    com.microsoft.rest.ServiceResponse<com.microsoft.azure.management.storage.implementation.StorageAccountListKeysResultInner> response = this.client.regenerateKey(this.resourceGroupName(), this.name(), keyName);
