@com.itechart.warehouse.controller.RequestMapping(value = "/save/{email:.+}", method = RequestMethod.POST, consumes = org.springframework.http.MediaType.APPLICATION_JSON_UTF8_VALUE)
public org.springframework.http.ResponseEntity<java.lang.Void> saveCompany(@javax.validation.Valid
