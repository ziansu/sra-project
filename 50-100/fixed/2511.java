protected com.arangodb.velocystream.Request documentExistsRequest(final java.lang.String key, final com.arangodb.model.DocumentExistsOptions options) {
    ...
    request = new com.arangodb.velocystream.Request(db, com.arangodb.velocystream.RequestType.HEAD, executor.createPath(ArangoDBConstants.PATH_API_DOCUMENT, executor.createDocumentHandle(name, key)));
