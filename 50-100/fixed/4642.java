...
public void handle(org.sonar.api.server.ws.Request request, org.sonar.api.server.ws.Response response) throws java.lang.Exception {
    ...
    org.sonar.core.issue.DefaultIssue issue = issueService.createManualIssue(componentKey, ruleKey, request.paramAsInt("line"), request.param("message"), request.param("severity"));
