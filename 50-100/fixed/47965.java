...
public void testAlternativeFlow() throws java.lang.Exception {
    ...
    whenNew(java.io.DataInputStream.class).withArguments(null).thenThrow(new java.lang.RuntimeException("error"));
    java.io.InputStream stream = tested.alternativePath();
    verifyNew(java.io.DataInputStream.class).withArguments(null);
