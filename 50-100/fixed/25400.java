...
private java.util.Set<org.openmrs.Obs> getHeadCircumferenceConceptObsForAPatient(org.openmrs.Patient patient) {
    ...
    return ((java.util.Set<org.openmrs.Obs>) (headCircumferenceConcept != null ? new java.util.HashSet<org.openmrs.Obs>(org.openmrs.api.context.Context.getObsService().getObservationsByPersonAndConcept(patient, headCircumferenceConcept)) : null));
}