...
public void onClick(android.view.View v) {
    if (mIsTwoPane) {
        getActivity().getSupportFragmentManager().beginTransaction().add(R.id.detail_movie_container, com.example.android.popmovies.detailsActivity.MovieDetailsFragment.newInstance(mMovieItem), DETAIL_FRAGMENT).commit();
    }else {
