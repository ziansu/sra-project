...
public void checkDateIsRequired() throws java.lang.Exception {
    ...
    points.setDate(null);
    restPointsMockMvc.perform(post("/api/points").contentType(TestUtil.APPLICATION_JSON_UTF8).content(org.daniels.jhipster.myhealth.web.rest.TestUtil.convertObjectToJsonBytes(points))).andExpect(status().isBadRequest());
