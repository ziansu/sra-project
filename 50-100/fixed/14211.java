protected void refreshHolder(de.dreier.mytargets.utils.multiselector.SelectableHolder holder) {
    if (holder != null) {
        if ((holder instanceof de.dreier.mytargets.utils.multiselector.ItemBindingHolder) && ((((de.dreier.mytargets.utils.multiselector.ItemBindingHolder) (holder)).getItem()) != null)) {
