...
public java.util.List<by.robotun.webapp.domain.Lot> selectMyResponsesLimitOffset(int offset, int idUser) throws by.robotun.webapp.exeption.DaoException {
    ...
    java.util.List<by.robotun.webapp.domain.Lot> lots = entityManager.createNamedQuery("Lot.findLotsRespondedUser").setParameter("id", idUser).setFirstResult(offset).setMaxResults(limit).getResultList();
    return lots;
}