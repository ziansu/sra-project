private void switchToolsToN(int n) {
    ...
    if (entityplayer.inventory.mainInventory.get(n).isEmpty()) {
        ...
        net.minecraft.util.ResourceLocation itemLocation = thebombzen.mods.autoswitch.AutoSwitch.findUniqueIdentifierFor(entityplayer.inventory.mainInventory.get(n).getItem());
