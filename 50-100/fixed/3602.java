...
public void testCTor() {
    ...
    jmri.jmrix.can.cbus.CbusDccProgrammerManager t = new jmri.jmrix.can.cbus.CbusDccProgrammerManager(new jmri.jmrix.can.cbus.CbusDccProgrammer(tc, memo), memo);
