...
java.lang.String groupedBy) {
    ...
    ssService.setDisplayMetadata(new io.mlh.objects.Metadata(new io.mlh.objects.charts.PieChartDisplayElementConfig(groupedBy), true, lAcc.size(), io.mlh.types.DataSetType.valueOf(requestType.toUpperCase())));
}