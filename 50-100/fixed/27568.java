private void createCountries() throws java.lang.Exception {
    ...
    for (java.lang.String code : COUNTRY_ISO_CODE) {
        ...
        if (locale != null) {
            com.salesmanager.core.business.reference.country.model.Country country = new com.salesmanager.core.business.reference.country.model.Country(null, 1L, true, code);
