public org.apache.cassandra.db.UnfilteredPartitionIterator makeIterator(org.apache.cassandra.config.CFMetaData metadata, org.apache.cassandra.db.ReadCommand command) {
    try {
        ...
        return org.apache.cassandra.db.UnfilteredPartitionIterators.serializerForIntraNode().deserialize(in, MessagingService.current_version, metadata, selection(command), flag);
