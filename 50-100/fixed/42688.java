...
public void handleMessage(android.os.Message message) {
    ...
    if (!(de.tbjv.rmxmc2.activity.ControllerActivity.trainList.isEmpty())) {
        ...
        de.tbjv.rmxmc2.activity.ControllerActivity.trainName = de.tbjv.rmxmc2.activity.ControllerActivity.trainList.get(de.tbjv.rmxmc2.activity.ControllerActivity.currentTrain);
    }
}