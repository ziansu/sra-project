public void run() {
    ...
    }, org.wso2.siddhi.debs2016.Processors.Q1EventManager.bufferSize, java.util.concurrent.Executors.newFixedThreadPool(1), com.lmax.disruptor.dsl.ProducerType.SINGLE, new com.lmax.disruptor.SleepingWaitStrategy());
