public org.alopex.hyperios.helix.Specimen tournamentSelect() {
    org.alopex.hyperios.helix.Population tournamentPop = new org.alopex.hyperios.helix.Population(((int) ((GASettings.populationSize) * (GASettings.tournamentRatio))), (-1), false);
