private void addChestIfValid(org.bukkit.util.Vector chestLocation) {
    try {
        ...
        if (isChest(candidate.getType())) {
            ...
            final fr.zcraft.zbanque.structure.containers.Container newContainer = new fr.zcraft.zbanque.structure.containers.Container(chestMainLocation, getOtherChestPart(chestMainLocation, candidate.getType()), true);
