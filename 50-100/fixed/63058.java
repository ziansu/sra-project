public void changePositionValue(es.mikel.tictactoe.Vector2 position, java.lang.String value) {
    ...
    java.util.Arrays.asList(positions).get(java.util.Arrays.asList(positions).indexOf(position)).setValue(value);
}