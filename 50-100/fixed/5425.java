...
org.springframework.http.ResponseEntity<?> handleControllerException(javax.servlet.http.HttpServletRequest request, java.lang.Throwable ex) {
    ...
    return new org.springframework.http.ResponseEntity<java.lang.Object>(new com.baifendian.swordfish.webserver.exception.CustomErrorType(status, ex.getMessage()), status);
}