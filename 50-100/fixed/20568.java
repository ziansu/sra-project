public static long getFileSize(edu.isi.pegasus.planner.classes.PegasusFile file) {
    if (((edu.isi.pegasus.planner.refiner.cleanup.constraint.Utilities.sizes) == null) || ((edu.isi.pegasus.planner.refiner.cleanup.constraint.Utilities.sizes.get(file.getLFN())) == null)) {
