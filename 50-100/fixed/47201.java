...
public void execute_add_successful() throws java.lang.Exception {
    ...
    assertCommandSuccess(helper.generateAddCommand(toBeAdded), java.lang.String.format(AddCommand.MESSAGE_SUCCESS, toBeAdded.getName()), expectedTM, expectedTM.getTaskList());
}