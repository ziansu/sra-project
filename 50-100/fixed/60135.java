...
java.lang.String outputFileName) {
    try {
        ...
        saveTextFile(outputFileName, com.gmail.volodymyrdotsenko.javabio.simple.SequencesUtil.overlapGraph(list.toArray(new java.lang.String[list.size()])).toString(false, true));
