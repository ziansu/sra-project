public org.atlasapi.media.entity.Priority getPriority(com.mongodb.DBObject dbObject) {
    java.lang.Double score = null;
    java.util.List<java.lang.String> priorityScoreReasons = null;
    if (dbObject.containsField(org.atlasapi.persistence.media.entity.PriorityTranslator.SCORE_KEY)) {
        score = com.metabroadcast.common.persistence.translator.TranslatorUtils.toDouble(dbObject, org.atlasapi.persistence.media.entity.PriorityTranslator.SCORE_KEY);
    }
    if (dbObject.containsField(org.atlasapi.persistence.media.entity.PriorityTranslator.REASONS_KEY)) {
        ...
        for (com.mongodb.DBObject object : dbos) {
            priorityScoreReasons.add(com.metabroadcast.common.persistence.translator.TranslatorUtils.toString(object));
        }
    }
