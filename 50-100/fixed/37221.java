...
public void shouldNotAddPushEventByDefaultForProjectWithoutTrigger() throws java.io.IOException {
    ...
    org.mockito.Mockito.verify(manager, org.mockito.Mockito.never()).createHookSubscribedTo(org.mockito.Matchers.anyListOf(org.kohsuke.github.GHEvent.class), null);
}