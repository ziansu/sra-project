...
public static void combine(com.facebook.presto.bloomfilter.BloomFilterState state, com.facebook.presto.bloomfilter.BloomFilterState otherState) {
    ...
    com.facebook.presto.bloomfilter.BloomFilter bfOther = com.facebook.presto.bloomfilter.BloomFilterAggregation.getOrCreateBloomFilter(otherState, BloomFilter.DEFAULT_BLOOM_FILTER_EXPECTED_INSERTIONS, BloomFilter.DEFAULT_BLOOM_FILTER_FALSE_POSITIVE_PERCENTAGE);
