...
public void onResume() {
    ...
    for (int i = 0; i < (ru.yandex.yamblz.ui.fragments.ContentFragment.PRODUCERS_COUNT); i++) {
        ru.yandex.yamblz.concurrency.LoadProducer loadProducer = new ru.yandex.yamblz.concurrency.LoadProducer(dataResults, this::postResult, consumerThread.getCyclicBarrier());
