static void statistics(int i) {
    ...
    com.company.Main.bothList.add(java.lang.Integer.toString((((com.company.Main.nInfected) - (com.company.Main.nImune)) + 1)));
    com.company.Main.neverInfectedList.add(java.lang.Integer.toString((((com.company.Main.nAgents) - (com.company.Main.nInfected)) + 1)));
