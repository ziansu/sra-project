private static boolean isInternetAvailable(android.content.Context context) {
    android.net.NetworkInfo info = ((android.net.ConnectivityManager) (context.getSystemService(Context.CONNECTIVITY_SERVICE))).getActiveNetworkInfo();
    if (info == null) {
