public static void replaceAll(java.util.List<woohoo.utils.gameobjects.Tile> tiles) {
    woohoo.utils.framework.UndoManager.add(new woohoo.utils.framework.UndoState(woohoo.utils.gameobjects.TileMap.tileList, woohoo.utils.gameobjects.TileMap.mapWidth, woohoo.utils.gameobjects.TileMap.mapHeight));
