private void initializeMiniSAT() {
    ...
    this.orderHeap = new org.logicng.solvers.datastructures.FixedList(idx2name);
    this.graphDrawer = new org.logicng.solvers.visualization.LEMTBDDGraphDrawer(idx2name, vars, this.f);
