public static void main(java.lang.String[] args) {
    ...
    chapter7.ProgrammingProjects.Adminstrator admin1 = new chapter7.ProgrammingProjects.Adminstrator("Tom", date1, 120000);
    chapter7.ProgrammingProjects.Adminstrator admin2 = new chapter7.ProgrammingProjects.Adminstrator(admin1);
    chapter7.ProgrammingProjects.Adminstrator admin3 = new chapter7.ProgrammingProjects.Adminstrator("Tom", date1, 120000);
