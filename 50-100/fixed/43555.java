private void jButtonLaunchBatchActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    org.healtex.gui.RunBatch runBatch = new org.healtex.gui.RunBatch(fileList, new java.io.File(jTextFieldOutputDir.getText()), jProgressBarBatchProgress, jButtonLaunchBatch, jButtonCancelBatch);
