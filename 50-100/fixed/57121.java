private boolean isEvictableHeapSize(final com.hazelcast.map.impl.MapContainer mapContainer) {
    ...
    final double maxSize = com.hazelcast.map.impl.eviction.MaxSizeChecker.getApproximateMaxSize(maxSizeConfig.getSize());
    return maxSize < ((1.0 * usedHeapSize) / (com.hazelcast.map.impl.eviction.MaxSizeChecker.ONE_MEGABYTE));
}