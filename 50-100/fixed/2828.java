public static void processDoors2(jaredbgreat.dldungeons.planner.Dungeon dungeon, jaredbgreat.dldungeons.rooms.Room room) {
    ...
    for (jaredbgreat.dldungeons.pieces.Doorway exit : room.topDoors) {
        exit.priority -= 16;
        dungeon.rooms.get(jaredbgreat.dldungeons.planner.astar.DoorChecker.getOtherRoom(exit, room, dungeon)).addToConnections(new jaredbgreat.dldungeons.pieces.Doorway(exit, room.id));
    }
}