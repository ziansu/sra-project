public boolean setDoiToNotAvailable(java.lang.String projectId, java.lang.String studyId) throws freemarker.template.TemplateException, java.io.IOException {
    ...
    java.lang.String filledTemplate = this.fillTemplate(registerXmlStr, this.getTemplateConfiguration(), this.getDataForTemplate(studyId, eu.dzhw.fdz.metadatamanagement.projectmanagement.service.DaraService.AVAILABILITY_CONTROLLED_NOT_AVAILABLE, (!(project.isHasBeenReleasedBefore()))));
