public static java.lang.String[] getDataFileNames(boolean includeLast) {
    int maxID = com.adsamcik.signalcollector.Setting.getPreferences(com.adsamcik.signalcollector.DataStore.context).getInt(com.adsamcik.signalcollector.DataStore.KEY_FILE_ID, (-1));
    if (!includeLast)
        maxID--;
