...
public void onSuccess(com.facebook.login.LoginResult loginResult) {
    ...
    com.devsh.androidlogin.library.data.SharedData.putAccountUserPhoto(com.devsh.androidlogin.library.FacebookLoginUtil.sContext, profile.getProfilePictureUri(200, 200).toString());
