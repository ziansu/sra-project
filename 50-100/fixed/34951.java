public java.util.List<org.sosy_lab.cpachecker.cpa.smg.SMGState> reconstructStates() {
    if (isFalse()) {
        ...
        java.util.List<org.sosy_lab.cpachecker.cpa.smg.SMGState> result = new java.util.ArrayList(this.smgStates.size());
        for (org.sosy_lab.cpachecker.cpa.smg.SMGState state : smgStates) {
            result.add(new org.sosy_lab.cpachecker.cpa.smg.SMGState(state));
        }
        return result;
    }
}