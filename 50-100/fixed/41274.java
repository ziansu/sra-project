...
public void alreadyExists() throws java.io.IOException {
    ...
    new com.upplication.s3fs.S3SeekableByteChannel(file1, java.util.EnumSet.of(java.nio.file.StandardOpenOption.WRITE, java.nio.file.StandardOpenOption.CREATE_NEW));
}