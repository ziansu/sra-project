public com.emc.vipr.model.sys.backup.BackupRestoreStatus queryBackupRestoreStatus(java.lang.String backupName, boolean isLocal) {
    com.emc.storageos.coordinator.common.Configuration cfg = coordinatorClient.queryConfiguration(coordinatorClient.getSiteId(), getBackupConfigKind(isLocal), backupName);
