public static void getTotalMoney() {
    ...
    com.xgf.winecome.ui.activity.HomeActivity.modifyCartPayView(java.lang.String.valueOf(totalPay), java.lang.String.valueOf(com.xgf.winecome.utils.CartManager.sCartList.size()));
}