void dumpStoredProperties() throws java.io.IOException {
    uk.ac.manchester.cs.owl.semspreadsheets.repository.bioportal.BioPortalCache.logger.info(("Storing cache in " + (uk.ac.manchester.cs.owl.semspreadsheets.repository.bioportal.BioPortalCache.getUserBioportalCache())));
    ...
    stream.close();
    uk.ac.manchester.cs.owl.semspreadsheets.repository.bioportal.BioPortalCache.logger.info("Stored");
}