public static void clearNotification() {
    ...
    android.app.PendingIntent sender = android.app.PendingIntent.getBroadcast(com.project.nghicv.readingbook.RBApp.getInstance(), 0, intent, PendingIntent.FLAG_CANCEL_CURRENT);
