...
public de.uni_freiburg.informatik.ultimate.smtinterpol.theory.epr.clauses.EprClause getFreshAlphaRenamedVersion() {
    ...
    return new de.uni_freiburg.informatik.ultimate.smtinterpol.theory.epr.clauses.EprBaseClause(newLits.toArray(new de.uni_freiburg.informatik.ultimate.smtinterpol.dpll.Literal[newLits.size()]), mTheory, mStateManager, true, sub, this);
}