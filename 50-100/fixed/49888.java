private void createAccountsInGroupColumn() {
    ...
    groupLabelProvider = new sernet.verinice.rcp.accountgroup.AccountLabelProvider();
    tableAccountsInGroup.setLabelProvider(groupLabelProvider);
    tableAccountsInGroup.setComparator(new sernet.verinice.rcp.accountgroup.AccountGroupView.AccountComparator());
    tableAccountsInGroup.refresh(true);
    org.eclipse.jface.layout.GridLayoutFactory.fillDefaults().margins(sernet.verinice.rcp.accountgroup.AccountGroupView.MARGINS).spacing(sernet.verinice.rcp.accountgroup.AccountGroupView.SPACING).generateLayout(accountsInGroupColumn);
}