private io.reactivex.Flowable<zlc.season.rxdownload.entity.DownloadStatus> rangeSave(final long start, final long end, final int i, final okhttp3.ResponseBody response) {
