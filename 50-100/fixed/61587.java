protected java.util.List<shinigami.no.sekai.filenavigator.NavigationItem> initializeFileListData(java.io.File dir) {
    java.util.List<shinigami.no.sekai.filenavigator.NavigationItem> adapterFiles = null;
    java.io.File[] filesInDir = dir.listFiles(mFileFilter);
    if (filesInDir != null) {
        adapterFiles = new java.util.ArrayList<shinigami.no.sekai.filenavigator.NavigationItem>(filesInDir.length);
