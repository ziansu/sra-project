...
public java.util.Map<java.lang.String, com.dell.cpsd.paqx.dne.service.model.Step> preProcessWorkflowSteps() {
    ...
    addWorkflowSteps(workflowSteps, "findAvailableNodes", "listVCenterComponents", "discoverVCenter", "discoverNodeInventory", "configIdrac", "pingIdrac", "configureObmSettings", "configureBootDeviceIdrac", "configurePxeBoot", "findVCluster", "findProtectionDomain", "findSystemData", "assignDefaultHostName", "assignDefaultCredentials");
