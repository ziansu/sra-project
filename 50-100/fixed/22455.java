private java.lang.String readContent(java.net.HttpURLConnection httpConn) throws java.io.IOException {
    ...
    return new java.lang.String(out.toByteArray(), charsetOf(httpConn));
}