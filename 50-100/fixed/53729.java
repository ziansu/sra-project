...
public void testProcessMul() throws net.torocraft.minecoprocessors.util.ParseException {
    ...
    net.torocraft.minecoprocessors.processor.ProcessorTest.assertRegisters(processor, 254, 2, 0, 0);
    ...
    processor.processMul();
    net.torocraft.minecoprocessors.processor.ProcessorTest.assertRegisters(processor, 10, 0, 0, 2);
    org.junit.Assert.assertFalse(processor.zero);
}