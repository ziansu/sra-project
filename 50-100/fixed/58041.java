...
public boolean validate(com.conveyal.gtfs.GTFSFeed feed, boolean repair) {
    ...
    for (com.conveyal.gtfs.model.Stop stop : feed.stops.values()) {
        ...
        try {
            com.conveyal.gtfs.validator.service.GeoUtils.convertLatLonToEuclidean(stopCoord);
        } catch (java.lang.IllegalArgumentException iae) {
            feed.errors.add(new com.conveyal.gtfs.error.StopMissingCoordinatesError(stop));
            isValid = false;
        }
    }
    return isValid;
