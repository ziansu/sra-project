public <T extends org.javers.core.metamodel.type.ManagedType> T getJaversManagedType(java.lang.Class javaClass, java.lang.Class<T> expectedType) {
    ...
    if (expectedType.isAssignableFrom(mType.getClass())) {
        ...
        throw new org.javers.common.exception.JaversException(org.javers.common.exception.JaversExceptionCode.MANAGED_CLASS_MAPPING_ERROR, javaClass, mType.getClass().getSimpleName(), expectedType.getSimpleName());
    }
}