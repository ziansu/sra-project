private org.hibernate.Criteria orderedSearchCriteria(org.hibernate.criterion.Order order, int page) {
    ...
    return criteria.setFirstResult(((ee.rs.repository.establishment.HbnEstablishmentRepository.RESULTS_PER_PAGE) * page)).setMaxResults(((ee.rs.repository.establishment.HbnEstablishmentRepository.RESULTS_PER_PAGE) + 1));
}