...
public void testGetEvaluator() throws java.io.IOException, org.apache.hadoop.hive.ql.parse.SemanticException {
    ...
    try (org.apache.hadoop.hive.ql.udf.generic.GenericUDAFEvaluator eval = udf.getEvaluator(params)) {
