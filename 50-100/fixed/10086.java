...
public boolean exists(java.lang.String id) throws org.n52.series.db.da.DataAccessException {
    ...
    try {
        if (org.n52.io.response.v1.ext.PlatformType.isStationaryId(id)) {
            ...
            return featureDao.hasInstance(parseId(org.n52.io.response.v1.ext.PlatformType.extractId(id)), org.n52.series.db.da.beans.FeatureEntity.class);
        }else {
            org.n52.series.db.da.dao.v1.ext.PlatformDao dao = new org.n52.series.db.da.dao.v1.ext.PlatformDao(session);
            return dao.hasInstance(parseId(org.n52.io.response.v1.ext.PlatformType.extractId(id)), org.n52.series.db.da.beans.ext.PlatformEntity.class);
        }
    } finally {
