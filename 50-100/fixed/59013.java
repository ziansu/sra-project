...
public org.clojars.kyleannen.javaserver.ResponseParameters getResponse(org.clojars.kyleannen.javaserver.RequestParameters requestParameters) throws java.io.IOException {
    ...
    return new org.clojars.kyleannen.javaserver.ResponseParameters.ResponseBuilder(200).setDate().setContentType(".json").setContentLength(responseJSON).setContentDisposition(".html").setBodyType(responseJSON).setBodyContent(responseJSON).setAccessControlAllowOrigin().build();
}