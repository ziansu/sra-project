public <S, T> org.apache.ofbiz.base.conversion.Converter<S, T> createConverter(java.lang.Class<S> sourceClass, java.lang.Class<T> targetClass) {
    ...
    return org.apache.ofbiz.base.util.UtilGenerics.cast(new org.apache.ofbiz.base.conversion.CollectionConverters.ArrayClassToList<>(sourceClass, targetClass));
}