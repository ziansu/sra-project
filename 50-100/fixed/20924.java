...
public void removeRequestRemovesTheGivenRequestOfTheRequestsReceivedTheUser() {
    unq.tpi.desapp.grupof.model.Request request = mock(unq.tpi.desapp.grupof.model.Request.class);
    unq.tpi.desapp.grupof.model.Request otherRequest = mock(unq.tpi.desapp.grupof.model.Request.class);
