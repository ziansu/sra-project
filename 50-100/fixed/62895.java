private void setMainView() {
    android.view.ViewGroup.LayoutParams layoutParamsH = new android.view.ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
