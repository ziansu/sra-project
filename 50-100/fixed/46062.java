...
public void sendMessage(bots.messages.BotTextMessage msg, java.lang.String channelTo) {
    ...
    for (java.lang.String messageToken : messagesWithoutNewline) {
        client.sendMessage(channelTo, java.lang.String.format("%s/%s/%s: %s", msg.getBotFrom().getClass().getSimpleName(), msg.getChannelFrom(), msg.getNicknameFrom(), messageToken));
    }
}