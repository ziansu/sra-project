public void onReady(play.mvc.WebSocket.In<java.lang.String> in, play.mvc.WebSocket.Out<java.lang.String> out) {
    if (gameUUID.equals("local")) {
        new models.GridObserver(controllers.Application.controller, out, gameUUID);
    }else {
        ...
        new models.GridObserver(controllers.Application.gameInstances.get(java.util.UUID.fromString(gameUUID)).getController(), out, gameUUID);
    }
}