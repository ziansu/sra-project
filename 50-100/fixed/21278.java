public org.joda.time.format.DateTimeFormatter determineDayFormatter() {
    try {
        return (customDayFormat) == null ? org.joda.time.format.DateTimeFormat.forStyle(((dateStyle.getToken()) + "-")) : org.joda.time.format.DateTimeFormat.forPattern(customDayFormat);
