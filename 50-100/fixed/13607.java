public void rebuildIndex(java.lang.String indexId) {
    ...
    java.util.Collection<org.zenframework.z8.server.base.table.Table> tables = org.zenframework.z8.server.search.SearchEngine.CLASS.asList(java.lang.Runtime.instance().tables(), true);
    index.clearIndex();
