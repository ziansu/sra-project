private void sendMessageToChatBot(java.lang.String containerId, java.lang.String status) {
    fr.aumjaud.antoine.services.common.http.HttpResponse httpResponse = httpHelper.postData(properties.getProperty("api-synology-chatbot.url"), properties.getProperty("api-synology-chatbot.secure-key"), ((("Deploy " + status) + " of ") + containerId));
