private void injectDelegateLifeCycleIntoConductorController(javassist.CtClass ctClass, weaver.instrumentation.injection.ClassInjector classInjector) throws java.lang.Exception {
    ...
    atTheBeginning(classInjector, onCreateView, (applied ? easymvp.weaver.ViewDelegateBinder.STATEMENT_CALL_INITIALIZE_WITH_FACTORY : easymvp.weaver.ViewDelegateBinder.STATEMENT_CALL_INITIALIZE), true);
