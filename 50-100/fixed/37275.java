private byte[] putColumnAuditorSchemaEntity(byte[] colFamilyForeignKey, org.commonvox.hbase_column_manager.ColumnAuditor columnAuditor) throws java.io.IOException {
    ...
    return putSchemaEntity(new org.commonvox.hbase_column_manager.Repository.RowId(SchemaEntityType.COLUMN_AUDITOR.getRecordType(), colFamilyForeignKey, columnAuditor.getName()), entityAttributeMap, false);
}