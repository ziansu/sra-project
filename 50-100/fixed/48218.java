private void getRWPermission() {
    boolean hasPermission = (android.support.v4.content.ContextCompat.checkSelfPermission(this.getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)) == (android.content.pm.PackageManager.PERMISSION_GRANTED);
    if (!hasPermission) {
