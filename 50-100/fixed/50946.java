private static org.eclipse.jdt.core.dom.ImportDeclaration getProblematicImport(org.eclipse.jdt.core.compiler.IProblem problem, org.eclipse.jdt.core.dom.CompilationUnit astRoot) {
    org.eclipse.jdt.core.dom.ASTNode coveringNode = new org.eclipse.jdt.core.dom.NodeFinder(astRoot, problem.getSourceStart(), ((problem.getSourceEnd()) - (problem.getSourceStart()))).getCoveringNode();
