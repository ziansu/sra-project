...
public boolean onMenuItemClick(android.view.MenuItem menuItem) {
    if (menuItem.getTitle().equals("Open on Youtube")) {
        android.widget.Toast.makeText(this, "Opening on Youtube", Toast.LENGTH_LONG).show();
        ...
        android.widget.Toast.makeText(this, "Whoops! I don't know what to do with that menu item!", Toast.LENGTH_LONG).show();
    }
    return true;
}