public byte[] renderGridToBuffer(com.ggasoftware.indigo.IndigoObject objects, int[] refAtoms, int ncolumns) {
    ...
    com.ggasoftware.indigo.Indigo.checkResult(this, objects, com.ggasoftware.indigo.IndigoRenderer._lib.indigoRenderGrid(objects.self, refAtoms, ncolumns, buf.self));
    return buf.toBuffer();
}