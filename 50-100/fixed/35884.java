...
public org.eclipse.che.ide.jseditor.client.text.TextRange getTextRangeForLine(final int line) {
    ...
    return new org.eclipse.che.ide.jseditor.client.text.TextRange(new org.eclipse.che.ide.jseditor.client.text.TextPosition(line, 0), new org.eclipse.che.ide.jseditor.client.text.TextPosition(line, length));
}