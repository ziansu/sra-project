...
public void setClassPathUrls(java.util.List<java.net.URL> classPathUrls) {
    ...
    java.lang.ClassLoader classLoader = new java.net.URLClassLoader(cp, null);
    io.ebean.enhance.Transformer transformer = new io.ebean.enhance.Transformer(classLoader, "debug=-1");
