public static void init() {
    ...
    com.Da_Technomancer.crossroads.dimensions.ModDimensions.prototypeDimType = net.minecraft.world.DimensionType.register(Main.MODID, "_prototype", 568, com.Da_Technomancer.crossroads.dimensions.WorkspaceWorldProvider.class, false);
