...
public void delete_TodoEntryNotFound_ShouldThrowException() {
    when(repositoryMock.delete(ru.doccloud.docs.service.RepositoryDocsCrudServiceTest.ID)).thenThrow(new ru.doccloud.common.exception.DocumentNotFoundException(""));
