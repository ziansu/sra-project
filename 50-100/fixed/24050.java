private void initRecycler() {
    ...
    com.jjacobson.groupshop.shoppinglist.list.ShoppingListAdapter adapter = new com.jjacobson.groupshop.shoppinglist.list.ShoppingListAdapter(com.jjacobson.groupshop.shoppinglist.item.Item.class, R.layout.row_items_list, com.jjacobson.groupshop.shoppinglist.list.ShoppingListHolder.class, database, list);
