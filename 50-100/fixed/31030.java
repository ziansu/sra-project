public boolean checkLocationPermission() {
    ...
    if ((android.support.v4.content.ContextCompat.checkSelfPermission(getContext(), android.Manifest.permission.ACCESS_FINE_LOCATION)) != (android.content.pm.PackageManager.PERMISSION_GRANTED)) {
        requestPermissions(new java.lang.String[]{ android.Manifest.permission.ACCESS_FINE_LOCATION }, com.example.android.climbtogether.fragment.HomeFragment.LOCATION_PERMISSION_REQUEST_CODE);
