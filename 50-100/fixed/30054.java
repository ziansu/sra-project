...
public void onClick(android.view.View v) {
    ...
    new com.pavelsikun.vintagechroma.ChromaDialog.Builder().initialColor(scrapbookColour).colorMode(ColorMode.RGB).indicatorMode(IndicatorMode.HEX).onColorSelected(new com.pavelsikun.vintagechroma.OnColorSelectedListener() {
        @java.lang.Override
