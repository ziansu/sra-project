private java.util.List<org.opendaylight.yangtools.yang.data.impl.leafref.LeafRefContext> getLeafRefsFor(final org.opendaylight.yangtools.yang.model.api.DataSchemaNode node, final org.opendaylight.yangtools.yang.model.api.Module module) {
    ...
    final java.util.List<org.opendaylight.yangtools.yang.data.impl.leafref.LeafRefContext> foundLeafRefs = new java.util.LinkedList<org.opendaylight.yangtools.yang.data.impl.leafref.LeafRefContext>();
