...
public void testAddDocumentNullMessage() {
    ...
    rest.addDocument(headers, org.mockito.Mockito.mock(javax.ws.rs.core.UriInfo.class), org.mockito.Mockito.mock(javax.servlet.http.HttpServletRequest.class), org.mockito.Mockito.mock(org.apache.cxf.jaxrs.ext.multipart.MultipartBody.class), null, null);
}