private static java.util.concurrent.locks.ReentrantLock getLock(java.lang.String projectTag) {
    if ((!(edu.scripps.yates.server.ProjectLocker.projectLocked.containsKey(projectTag))) || ((edu.scripps.yates.server.ProjectLocker.projectLocked.get(projectTag)) == null)) {
