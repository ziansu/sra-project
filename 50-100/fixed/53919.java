...
int[] grantResults) {
    if ((requestCode == (im.dino.dbinspector.fragments.TableListFragment.REQUEST_PERMISSION_CODE)) && (Manifest.permission.WRITE_EXTERNAL_STORAGE.equals(permissions[0]))) {
