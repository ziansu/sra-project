...
public void whenModuleIsReadyToRun_thenCorrespondingHealthFeatureShouldBeTrue() {
    ...
    org.assertj.core.api.Assertions.assertThat(new org.corpus_tools.pepper.core.ModuleFitnessChecker().checkHealth(module).getFitness(FitnessFeature.IS_READY_TO_RUN)).isEqualTo(true);
}