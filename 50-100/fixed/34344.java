...
public void onDataChange(com.google.firebase.database.DataSnapshot dataSnapshot) {
    ...
    databaseReference.child(pl.mirko.interactors.FirebaseDatabaseInteractor.COMMENTS).child(post.postId).push().setValue(newComment).addOnCompleteListener(new com.google.android.gms.tasks.OnCompleteListener<java.lang.Void>() {
        @java.lang.Override
