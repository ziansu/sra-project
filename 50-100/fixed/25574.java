public static java.lang.String getNBTString(org.bukkit.inventory.meta.ItemMeta meta, java.lang.String key) {
    try {
        java.lang.Object tag = ((java.util.Map<java.lang.String, java.lang.Object>) (me.yamakaja.commanditems.util.NMSUtil.unhandledTagsField.get(meta))).get(me.yamakaja.commanditems.util.NMSUtil.NBT_KEY);
        if (tag == null)
            return null;
