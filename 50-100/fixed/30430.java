...
public com.TestWeb.util.PageBean<T> findByDetachedCriteria(org.hibernate.criterion.DetachedCriteria detachedCriteria, com.TestWeb.util.PageBean<T> pageBean) {
    ...
    java.util.List<T> list = ((java.util.List<T>) (this.hibernateTemplate.findByCriteria(detachedCriteria, (((pageBean.getPage()) - 1) * (pageBean.getPageSize())), pageBean.getPageSize())));
