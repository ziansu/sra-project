...
public void testLoadRosterFailure() {
    org.mockito.Mockito.when(mockDataManager.getPlayers(org.mockito.ArgumentMatchers.anyString())).thenReturn(rx.Single.<java.util.List<com.kbaldauf.playerfinder.model.Player>>error(new java.lang.Throwable()));
