protected void createErrorAnnotation(org.antlr.v4.runtime.Token offendingToken, java.lang.String msg) {
    ...
    getAnnotationModel().addAnnotation(annotation, new org.eclipse.jface.text.Position(offendingToken.getStartIndex(), (((offendingToken.getStopIndex()) - (offendingToken.getStartIndex())) + 1)));
