public static void initEmptyDastList() {
    SimpleSetPerformanceAnalyzer.dastList = new SimpleSet[4];
    ...
    SimpleSetPerformanceAnalyzer.dastList[3] = new CollectionFacadeSet(new java.util.HashSet<java.lang.String>());
}