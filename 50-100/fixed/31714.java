public org.apache.hc.client5.http.fluent.Executor authPreemptive(final org.apache.hc.core5.http.HttpHost host) {
    if ((this.credentialsStore) != null) {
        final org.apache.hc.client5.http.auth.Credentials credentials = this.credentialsStore.getCredentials(new org.apache.hc.client5.http.auth.AuthScope(host), null);
        if (credentials == null) {
