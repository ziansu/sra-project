...
public void testProcessXor() throws net.torocraft.minecoprocessors.util.ParseException {
    ...
    net.torocraft.minecoprocessors.processor.ProcessorTest.assertRegisters(processor, 3, 6, 0, 0);
    ...
    processor.processXor();
    net.torocraft.minecoprocessors.processor.ProcessorTest.assertRegisters(processor, 0, 5, 0, 0);
