public void compute(ru.mrchebik.gui.node.CustomCodeArea customCodeArea) {
    ...
    if (isJDKCorrect) {
        ...
        ru.mrchebik.highlight.syntax.switcher.javaSymbolSolver.JavaSymbolSolverSyntax processSyntax = new ru.mrchebik.highlight.syntax.switcher.javaSymbolSolver.JavaSymbolSolverSyntax(customCodeArea);
        processSyntax.start();
    }
}