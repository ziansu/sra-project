    ...
    switch (viewType) {
        case TYPE_BOTTOM :
            if ((loadMore) != null) {
                ...
                return new com.lovejjfg.powerrecycle.holder.NewBottomViewHolder(android.view.LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_footer_new, parent, false));
            }
        default :
