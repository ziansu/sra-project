private FeedbackMessage executeSearch(java.lang.String keyword) throws java.io.IOException {
    ...
    if ((searchList.size()) != 0) {
        ...
        return new FeedbackMessage(java.lang.String.format(Logic.MESSAGE_SEARCH, "successfully"), searchList);
    }else {
        java.lang.String taskListContent = getTaskListContent(myTaskList);
        return new FeedbackMessage(java.lang.String.format(Logic.MESSAGE_SEARCH, "successfully"), myTaskList);
    }
}