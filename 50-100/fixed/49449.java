...
public void should_persist_and_read() throws java.lang.Exception {
    ...
    com.conference.spring.test.webassistant.persistence.AnswerEntity persist = entityManager.persist(com.conference.spring.test.webassistant.persistence.AnswerEntity.builder().text("answer").build());
