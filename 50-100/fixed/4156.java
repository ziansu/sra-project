private static cgeo.geocaching.models.Geocache downloadCache(final java.lang.String geocode) {
    final cgeo.geocaching.SearchResult searchResult = cgeo.geocaching.models.Geocache.searchByGeocode(geocode, null, true, cgeo.geocaching.connector.gc.WaypointsTest.handler);
