...
public void testExecuteQueryCommand() {
    ...
    org.junit.Assert.assertEquals("There should be two images returned", 2, diskImages.size());
    org.junit.Assert.assertEquals("DiskImage should contain the VmSnapshotDescription", org.ovirt.engine.core.bll.snapshots.GetAllDiskSnapshotsByStorageDomainIdQueryTest.snapshotDescription, diskImages.get(0).getVmSnapshotDescription());
}