...
android.graphics.drawable.Animatable animatable) {
    if (imageInfo != null) {
        eventDispatcher.dispatchEvent(new com.reactnative.photoview.ImageEvent(getId(), ImageEvent.ON_LOAD));
        eventDispatcher.dispatchEvent(new com.reactnative.photoview.ImageEvent(getId(), ImageEvent.ON_LOAD_END));
