private boolean updateGames(java.lang.String user, boolean won) {
    ...
    gamesPlayed += 1;
    gamesWon += (won) ? 1 : 0;
    userInfo.put(groupn.spin_counter.model.LocalScoreManager.GamesPlayedKey, gamesPlayed);
    userInfo.put(groupn.spin_counter.model.LocalScoreManager.GamesWonKey, gamesWon);
    return true;
}