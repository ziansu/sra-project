...
public void actionPerformed(java.awt.event.ActionEvent ae) {
    ...
    boa.gui.imageInteraction.ImageWindowManagerFactory.getImageManager().addImage(i.generateRawImage(getStructureIdx(ae.getActionCommand(), openRaw)), i, false, true);
}