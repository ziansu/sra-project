...
public void convertShouldSucceed() throws command.ValidateException, java.io.IOException, java.lang.InterruptedException {
    java.lang.String res = process.Pyicos.runConvert(process.test.PyicosTest.inSamFile.getCanonicalPath(), process.test.PyicosTest.outWigFile.getCanonicalPath(), true);
