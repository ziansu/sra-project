...
public void testUserNotRegistered() throws java.lang.Exception {
    ...
    teammates.test.pageobjects.AppPage.getNewPageInstance(teammates.test.cases.ui.browsertests.AllAccessControlUiTests.browser, nonExistentActionUrl, teammates.test.pageobjects.NotFoundPage.class);
}