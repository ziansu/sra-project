...
public com.daksh.tmdbsample.movielist.MovieListAdapter.ViewHolder onCreateViewHolder(android.view.ViewGroup parent, int viewType) {
    ...
    B.imagePoster.post(() -> B.imagePoster.getLayoutParams().height = ((int) (((double) (B.imagePoster.getWidth())) * (com.daksh.tmdbsample.movielist.MovieListAdapter.IMAGE_ASPECT_RATIO))));
