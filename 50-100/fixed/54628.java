...
public java.lang.Iterable<java.util.List<java.lang.Object>> deserialize(byte[] rawValue) {
    ...
    if (ts != null) {
        return com.google.common.collect.ImmutableList.of(new backtype.storm.tuple.Values(com.google.common.collect.ImmutableList.of(new org.apache.hadoop.io.LongWritable(ts), new org.apache.hadoop.io.BytesWritable(org.apache.metron.spout.pcap.PcapHelper.headerizeIfNecessary(rawValue)))));
    }else {
