...
public void test_createHUQueryBuilder_WithAfterPickingLocators_Warehouse01_BPartner01() {
    ...
    org.junit.Assert.assertEquals("Invalid HUs retrieved", java.util.Arrays.asList(hu_bp01_wh01_active, hu_bp01_wh01_picked), huSelectModel.createHUQueryBuilder().list());
}