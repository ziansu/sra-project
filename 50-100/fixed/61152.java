...
final com.spotify.docker.client.messages.RootFs rootFs) {
    return new com.spotify.docker.client.messages.AutoValue_ImageInfo(id, parent, comment, created, container, containerConfig, dockerVersion, author, config, architecture, os, size, virtualSize, rootFs);
}