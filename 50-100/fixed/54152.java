private void initImageLoader() {
    ...
    com.nostra13.universalimageloader.core.ImageLoaderConfiguration config = new com.nostra13.universalimageloader.core.ImageLoaderConfiguration.Builder(this).defaultDisplayImageOptions(options).build();
