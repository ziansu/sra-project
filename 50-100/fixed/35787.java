...
public int onStartCommand(android.content.Intent intent, int flags, int startId) {
    if ((intent == null) || ((intent.getAction()) == null))
        ...
        if (intent.getAction().equals(me.qishen.mockgps.service.MockLocationService.START_MOCK_CMD)) {
            android.util.Log.i(me.qishen.mockgps.service.MockLocationService.TAG, "Start command");
            startMock();
        }else
            if (intent.getAction().equals(me.qishen.mockgps.service.MockLocationService.STOP_MOCK_CMD)) {
                android.util.Log.i(me.qishen.mockgps.service.MockLocationService.TAG, "Stop command");
                stopMock();
            }
