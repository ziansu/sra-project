...
java.lang.Long[] ids) {
    com.krishagni.catissueplus.core.common.events.BulkDeleteEntityOp op = new com.krishagni.catissueplus.core.common.events.BulkDeleteEntityOp(new java.util.HashSet<>(java.util.Arrays.asList(ids)));
