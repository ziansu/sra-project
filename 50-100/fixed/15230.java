...
android.support.v4.app.Fragment fragment) {
    ...
    if ((Build.VERSION.SDK_INT) >= (Build.VERSION_CODES.JELLY_BEAN_MR1)) {
        ...
        return org.neotech.library.retainabletasks.TaskManager.getTaskManager(org.neotech.library.retainabletasks.internal.TaskRetainingFragment.getInstance(fragment.getActivity().getFragmentManager()), tag);
    }
}