org.parboiled.Rule ArraySubscript() {
    ...
    return Sequence(array.set(pop()), Keyword("["), Expression(), index.set(pop()), Keyword("]"), push(new org.teavm.flavour.templates.expr.BinaryExpr(array.get(), index.get(), BinaryOperation.GET_ELEMENT)), setLocations);
}