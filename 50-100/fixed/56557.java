...
public java.util.List<com.beehyv.nmsreporting.model.FlwImportRejection> getAllRejectedFlwImportRecordsWithBlockId(java.util.Date toDate, java.lang.Integer blockId) {
    ...
    criteria.add(org.hibernate.criterion.Restrictions.lt("modificationDate", toDate)).add(org.hibernate.criterion.Restrictions.eq("accepted", false)).add(org.hibernate.criterion.Restrictions.eq("blockId", blockId));
