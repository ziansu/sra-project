public void setLocationRequirement(T locationRequirement) {
    if (((locationRequirement.getClass()) != (eu.neclab.iotplatform.ngsi.api.datamodel.Point.class)) && ((locationRequirement.getClass()) != (eu.neclab.iotplatform.ngsi.api.datamodel.Circle.class))) {
