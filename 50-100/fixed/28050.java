public static void main(java.lang.String[] args) {
    osmo.tester.optimizer.multiosmo.MultiOSMO osmo = new osmo.tester.optimizer.multiosmo.MultiOSMO();
    ...
    osmo.generate(new osmo.tester.generator.endcondition.Time(10, java.util.concurrent.TimeUnit.HOURS), 1365);
}