protected com.arangodb.velocystream.Request deleteEdgeRequest(final java.lang.String key, final com.arangodb.model.EdgeDeleteOptions options) {
    final com.arangodb.velocystream.Request request = new com.arangodb.velocystream.Request(db, com.arangodb.velocystream.RequestType.DELETE, executor.createPath(ArangoDBConstants.PATH_API_GHARIAL, graph, ArangoDBConstants.EDGE, executor.createDocumentHandle(name, key)));
