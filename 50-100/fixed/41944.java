...
public void getResourcesShouldReturnResourceWithRootSetAndExistingFSConfig() throws java.lang.Exception {
    ...
    try (org.apache.metron.common.utils.ResourceLoader loader = new org.apache.metron.common.utils.ResourceLoader.Builder().withConfiguration(config).withFileSystemConfiguration(new org.apache.hadoop.conf.Configuration()).build()) {
