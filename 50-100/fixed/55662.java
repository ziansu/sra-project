private void cancelAlarmIntent(java.lang.String key) {
    android.content.Intent alarmIntent = new android.content.Intent(context.getApplicationContext(), au.com.wallaceit.pebblewatchfacescheduler.ScheduleReceiver.class);
