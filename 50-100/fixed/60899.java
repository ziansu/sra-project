public com.levigilad.javaplay.tictactoe.TicTacToeSymbol addParticipant(java.lang.String participantId) {
    ...
    if (mParticipants.get(TicTacToeSymbol.X).equals(com.levigilad.javaplay.tictactoe.TicTacToeTurn.NO_PARTICIPANT)) {
        participantSymbol = TicTacToeSymbol.X;
    }else
        if (mParticipants.get(TicTacToeSymbol.O).equals(com.levigilad.javaplay.tictactoe.TicTacToeTurn.NO_PARTICIPANT)) {
