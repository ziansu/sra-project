private static java.util.List<be.ehb.factories.MembershipResponse> createMembershipResponses(java.util.Set<be.ehb.entities.organizations.MembershipBean> memberships) {
