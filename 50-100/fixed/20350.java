...
public void theUserReceivesAPublicAndPrivateMessageThenTheAmountOfReceivedMessagesIsIncrementedByTwo() {
    unq.tpi.desapp.grupof.model.PublicMessage publicMessage = mock(unq.tpi.desapp.grupof.model.PublicMessage.class);
    unq.tpi.desapp.grupof.model.PrivateMessage privateMessage = mock(unq.tpi.desapp.grupof.model.PrivateMessage.class);
