public void changeTime(int dealy, boolean anticipate) {
    ...
    models.Remain secondRemain = logic.Utility.calculateRemains(second, anticipate);
    second = secondRemain.getValue();
    minute += secondRemain.getRemain();
    models.Remain minuteRemain = logic.Utility.calculateRemains(minute, anticipate);
