...
public void loadUserData(java.lang.String username, long connectionId, com.bolyartech.scram_sasl.server.ScramSaslServerProcessor processor) {
    ...
    try {
        com.bolyartech.scram_sasl.common.ScramUtils.NewPasswordStringData data = com.bolyartech.scram_sasl.common.ScramUtils.byteArrayToStringData(com.bolyartech.scram_sasl.common.ScramUtils.newPassword("ogre1234", salt, 4096, "SHA-256", "HmacSHA256"));
