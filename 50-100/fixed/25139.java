...
public void whenModuleHasName_thenCorrespondingFitnessFeatureShouldBeTrue() {
    ...
    org.assertj.core.api.Assertions.assertThat(new org.corpus_tools.pepper.core.ModuleFitnessChecker().checkFitness(module).getFitness(FitnessFeature.HAS_NAME)).isEqualTo(true);
}