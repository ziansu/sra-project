...
public void onSelectedChanged(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int actionState) {
    if ((actionState != (android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_IDLE)) && (viewHolder instanceof com.tobiadeyinka.me.android.utilities.list_adapter_utils.helpers.ItemTouchHelperViewHolder)) {
