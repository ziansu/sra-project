...
public void testPost() {
    com.manjesh.collector.domain.Event addEvent = new com.manjesh.collector.domain.Event(444, "Jai", "Ganesh", new com.manjesh.collector.domain.OID[]{ new com.manjesh.collector.domain.OID(1, "Ganesh") , new com.manjesh.collector.domain.OID(2, "Vignesh") });
