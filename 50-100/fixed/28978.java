public com.amazonaws.services.cloudwatch.model.DescribeAlarmsResult describeAlarms(com.amazonaws.services.elasticbeanstalk.model.EnvironmentDescription ed) {
    ...
    com.amazonaws.services.cloudwatch.model.DescribeAlarmsRequest req = org.sagebionetworks.stack.alarms.ElbAlarmSetup.createDescribeAlarmsRequest(ed.getEnvironmentName(), loadBalancer.getName(), topicArn);
