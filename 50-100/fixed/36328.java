private java.awt.image.BufferedImage scaleImage(java.awt.image.BufferedImage img, double scale) {
    java.awt.image.BufferedImage after = new java.awt.image.BufferedImage(((int) ((img.getWidth()) * scale)), ((int) ((img.getHeight()) * scale)), java.awt.image.BufferedImage.TYPE_INT_ARGB);
