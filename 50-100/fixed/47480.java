...
public java.lang.Object visitEnumEntryPMD(org.jetbrains.kotlin.psi.JetEnumEntry node, java.lang.Object data) {
    ...
    if (!(neededDelimiter.isEmpty())) {
        addViolation(getSavedData(), node.<net.sourceforge.pmd.lang.ast.Node>getCopyableUserData(KotlinASTNodeAdapter.OUTER_NODE_KEY), new java.lang.Object[]{ node.getName() , neededDelimiter });
    }
