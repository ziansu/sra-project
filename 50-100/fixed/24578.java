public byte[] transformForgeHooks(byte[] bytes) {
    ...
    if (method != null) {
        method.instructions.insertBefore(method.instructions.get(0), new micdoodle8.mods.miccore.MethodInsnNode(org.objectweb.asm.Opcodes.INVOKESTATIC, micdoodle8.mods.miccore.MicdoodleTransformer.CLASS_MICDOODLE_PLUGIN, "orientCamera", "()V", false));
