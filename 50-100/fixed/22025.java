private static java.lang.String hashString(java.lang.String input) throws java.io.UnsupportedEncodingException, java.security.NoSuchAlgorithmException {
    ...
    return base64Text != null ? new java.lang.String(base64Text).trim() : "";
}