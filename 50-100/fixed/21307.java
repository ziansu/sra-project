private static void assertSandhi(java.lang.String input, java.util.List<java.lang.String> expected, int trieNumber) throws java.io.FileNotFoundException, java.io.IOException {
    ...
    io.bdrc.lucene.sa.SkrtWordTokenizer skrtWordTokenizer = new io.bdrc.lucene.sa.SkrtWordTokenizer(true, (("resources/sanskrit-stemming-data/output/tries/" + (java.lang.Integer.toString(trieNumber))) + ".txt"));
