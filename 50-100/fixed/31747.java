static final com.fragmentime.markdownj.elements.Element LoadResourceFromClass(java.lang.Class c, java.lang.String resource) throws java.io.IOException {
    ...
    try (java.io.InputStream is = c.getResourceAsStream(resource);java.io.InputStreamReader isr = new java.io.InputStreamReader(is);java.io.BufferedReader br = new java.io.BufferedReader(isr)) {
