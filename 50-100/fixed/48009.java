public static boolean isTimePresent(java.lang.String date) {
    ...
    return (syntaxTreeString.contains(seedu.taskmanager.logic.parser.DateTimeUtil.EXPLICIT_TIME_SYNTAX)) || (syntaxTreeString.contains(seedu.taskmanager.logic.parser.DateTimeUtil.RELATIVE_TIME_SYNTAX));
}