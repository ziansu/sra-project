...
public org.exschool.pocketworld.building.ResourceBuildingDto apply(org.exschool.pocketworld.resource.building.model.ResourceBuilding resourceBuilding) {
    ...
    return org.exschool.pocketworld.building.ResourceBuildingDto.builder().type(resourceBuilding.getResourceType().name().toLowerCase()).level(resourceBuilding.getLevel()).position(resourceBuilding.getPosition()).build();
}