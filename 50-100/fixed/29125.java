public void addOneItemOnCategorySpinner(java.lang.String newCategory) {
    category_spinner = ((android.widget.Spinner) (view.findViewById(R.id.category_spinner)));
    category_list.add(newCategory);
    android.widget.ArrayAdapter<java.lang.String> dataAdapter = new android.widget.ArrayAdapter(this.getActivity(), android.R.layout.simple_spinner_item, category_list);
