public com.sun.tools.javac.util.List<com.sun.tools.javac.tree.JCTree> transform(com.redhat.ceylon.compiler.typechecker.tree.Tree.AttributeSetterDefinition decl) {
    ...
    return com.redhat.ceylon.compiler.codegen.AttributeDefinitionBuilder.setter(this, name, decl.getDeclarationModel().getParameter()).modifiers(transformAttributeGetSetDeclFlags(decl.getDeclarationModel())).setterBlock(body).build();
}