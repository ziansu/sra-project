...
public void testGetConfiguration() throws java.lang.Exception {
    ...
    org.wso2.mdm.integration.configuration.AssertUtil.jsonPayloadCompare(org.wso2.mdm.integration.configuration.PayloadGenerator.getJsonPayload(Constants.ConfigurationManagement.CONFIGURATION_RESPONSE_PAYLOAD_FILE_NAME, Constants.HTTP_METHOD_GET).toString(), response.getBody(), false);
}