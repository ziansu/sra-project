...
public void testQueryProgressParallel() throws java.lang.Throwable {
    ...
    testScriptFile(SCRIPT_TEXT, getBaseArgs(org.apache.hive.beeline.TestBeeLineWithArgs.miniHS2.getBaseJdbcURL()), org.apache.hive.beeline.TestBeeLineWithArgs.OutStream.ERR, EXPECTED_PATTERN, true);
}