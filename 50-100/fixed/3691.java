@org.junit.Test
public void testExtraTokenBug() throws java.io.IOException {
    ...
    java.lang.String input = "divase na";
    java.io.Reader reader = new java.io.StringReader(input);
    java.util.List<java.lang.String> expected = java.util.Arrays.asList("divasa", "na");
