@java.lang.SuppressWarnings(value = { "rawtypes" , "unchecked" , "cast" })
...
public static <T, R> io.reactivex.Flowable<R> zip(io.reactivex.Publisher<? extends io.reactivex.Publisher<? extends T>> sources, final io.reactivex.Function<? super java.lang.Object[], ? extends R> zipper) {
    ...
    return io.reactivex.Flowable.fromPublisher(sources).toList().flatMapPublisher(((io.reactivex.Function) (io.reactivex.FlowableInternalHelper.<T, R>zipIterable(zipper))));
}