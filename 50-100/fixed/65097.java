...
public void test27TitleOfResetAllToDefaultOnImageParams() {
    ...
    junit.framework.Assert.assertTrue(mMessage, com.example.zhengjin.funsettingsuitest.testutils.TestHelper.waitForUiObjectEnabled(resetItem));
    ...
    junit.framework.Assert.assertEquals(mMessage, IMAGE_PARAMS_SETTINGS_TITLE_ARR[5], title.getText());
}