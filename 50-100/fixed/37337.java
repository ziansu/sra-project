    ...
    synchronized(this) {
        switch (state) {
            case PENDING :
                ...
                break;
            case DONE :
                notifyDone(new com.wildducktheories.promise.impl.SyncCompletionTasklet<P, F>(com.wildducktheories.tasklet.SchedulerAPI.get().getScheduler(), callback, null), resolution);
            default :
        }
    }
    return this;
