public static android.content.Intent getDirectUrl(int position, boolean recording) {
    java.lang.StringBuilder result = new java.lang.StringBuilder((recording ? org.dvbviewer.controller.ui.fragments.StreamConfig.mediaUrl : org.dvbviewer.controller.ui.fragments.StreamConfig.liveUrl)).append(position).append(".ts");
