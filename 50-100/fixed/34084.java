private double[] getTopKTopicProbArr(java.util.Set<edu.virginia.cs.solr.model.Topic> topics, int tagSize, edu.virginia.cs.solr.repository.QuestionRepository repository) {
