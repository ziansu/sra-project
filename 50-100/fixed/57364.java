...
java.lang.String bodyJson) {
    ...
    org.fenixedu.cms.domain.Site site = site(siteId);
    java.util.Optional<org.fenixedu.cms.domain.MenuItem> menuItem = service.create(site, bean.getParent(), bean.getTitle(), bean.getBody());
