private void requestAuthorization(boolean read, boolean write) {
    ...
    cordova.requestPermissions(this, com.terikon.cordova.photolibrary.PhotoLibrary.REQUEST_AUTHORIZATION_REQ_CODE, permissions.toArray(new java.lang.String[0]));
}