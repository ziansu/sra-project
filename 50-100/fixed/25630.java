...
public org.springframework.web.servlet.ModelAndView chatBox(org.springframework.ui.ModelMap model) {
    ...
    org.springframework.web.servlet.ModelAndView mod = new org.springframework.web.servlet.ModelAndView();
    if (model.isEmpty()) {
