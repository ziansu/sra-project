static void addExtractorRecipes() {
    ...
    reborncore.api.recipe.RecipeHandler.addRecipe(new techreborn.init.ExtractorRecipe(new net.minecraft.item.ItemStack(ModBlocks.rubberLog), techreborn.init.ItemParts.getPartByName("rubber"), 400, 20, false));
}