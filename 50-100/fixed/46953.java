private void updateActivity(android.content.Intent i) {
    if (i.hasExtra(InternalBroadcasts.KEY_ACTIVITY_UPDATE)) {
        ...
        if (((mMarker) != null) && (topActivity != (latestActivityType))) {
            android.graphics.Bitmap bitmap = fi.aalto.trafficsense.trafficsense.ui.MainActivity.getBitmap(mContext, fi.aalto.trafficsense.trafficsense.ui.ActivityType.getActivityIcon(topActivity));
