public static boolean canUseName(org.bukkit.entity.Player player, java.lang.String name) {
    ...
    return ((shortenedName.equals(name)) || (com.Acrobot.ChestShop.Permission.otherName(player, name))) || ((!(name.isEmpty())) && (player.getUniqueId().equals(com.Acrobot.ChestShop.UUIDs.NameManager.getUUID(name))));
}