public static void setPath() {
    ...
    chen.mfmaker.io.IOManager.IOMap = chen.mfmaker.io.IOManager.getMap(chen.mfmaker.io.IOManager.path);
    java.lang.System.out.println(chen.mfmaker.io.IOManager.IOMap);
}