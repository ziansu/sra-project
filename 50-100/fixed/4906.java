public static void addMessag(java.lang.String message, org.safs.tools.mail.Mailer.MimeType msg_type, java.util.Map<java.lang.Integer, org.safs.tools.mail.Mailer.MimeContent> contents) {
    try {
        if (message == null) {
