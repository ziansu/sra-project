...
public void getSubItems(net.minecraft.item.Item item, net.minecraft.creativetab.CreativeTabs tab, java.util.List itemList) {
    ...
    java.util.Collections.sort(configList, new sidben.ateliercanvas.handler.CustomPaintingConfigItemComparator(sidben.ateliercanvas.handler.CustomPaintingConfigItemComparator.SortingType.TITLE));
