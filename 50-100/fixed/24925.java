public static void getAllGroups(final com.instructure.canvasapi.utilities.CanvasCallback<com.instructure.canvasapi.model.Group[]> callback) {
    ...
    callback.readFromCache(com.instructure.canvasapi.api.GroupAPI.getAllGroupsCacheFilename());
    com.instructure.canvasapi.api.GroupAPI.getFirstPageGroups(bridge);
}