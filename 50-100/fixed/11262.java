...
protected org.payn.chsm.io.ModelBuilder loadBuilder() throws java.lang.Exception {
    ...
    if (!(classPath.equals(""))) {
        return ((org.payn.chsm.io.ModelBuilder) (org.payn.chsm.io.ModelLoader.createObjectInstance(builderElem.getFile(pathRoot), classPath, java.lang.String.format("Builder %s", classPath))));
    }else {
        return null;
    }
}