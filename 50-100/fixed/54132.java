...
public io.caly.calyandroid.Adapter.RecommandListAdapter.ViewHolder onCreateViewHolder(android.view.ViewGroup parent, int viewType) {
    ...
    io.caly.calyandroid.Adapter.RecommandListAdapter.ViewHolder holder = new io.caly.calyandroid.Adapter.RecommandListAdapter.ViewHolder(parent.getContext(), view);
