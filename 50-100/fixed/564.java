org.opendaylight.yangtools.yang.data.api.schema.LeafSetNode<?> getClusterList(final org.opendaylight.yangtools.yang.data.api.schema.ContainerNode attributes) {
    final com.google.common.base.Optional<org.opendaylight.yangtools.yang.data.api.schema.NormalizedNode<?, ?>> maybeClusterList = org.opendaylight.yangtools.yang.data.api.schema.NormalizedNodes.findNode(attributes, this.clusterListPath);
