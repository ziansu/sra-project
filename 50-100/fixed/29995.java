...
protected java.lang.Object handleInvocation(java.util.List<java.lang.String> path, java.lang.reflect.Method method) throws java.lang.Throwable {
    lastPath.set(de.davherrmann.efficiently.immutable.PathRecorder.PathInvocationHandler.pathWith(method));
    ...
    return (defaultValue != null) || (!(returnType.isInterface())) ? defaultValue : pathFor(returnType, lastPath.get());
}