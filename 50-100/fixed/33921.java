public java.lang.String getServiceStatus(java.lang.String service) throws org.sleuthkit.autopsy.core.ServicesMonitor.UnknownServiceException {
    ...
    if (status == null) {
        throw new org.sleuthkit.autopsy.core.ServicesMonitor.UnknownServiceException(org.openide.util.NbBundle.getMessage(org.sleuthkit.autopsy.core.ServicesMonitor.class, "ServicesMonitor.unknownServiceName.excepton.txt", service));
    }
    return status;
}