...
public void onDateChanged(android.widget.DatePicker view, int year, int monthOfYear, int dayOfMonth) {
    ...
    reactContext.getNativeModule(com.facebook.react.uimanager.UIManagerModule.class).getEventDispatcher().dispatchEvent(new com.bitup.datepickercomponent.RNDatePickerComponentEvent(view.getId(), date));
}