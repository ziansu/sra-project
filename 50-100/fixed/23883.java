public com.flowcrypt.email.test.PgpContact getPgpContact(android.content.Context context, java.lang.String email) {
    ...
    android.database.Cursor cursor = contentResolver.query(getBaseContentUri(), null, ((com.flowcrypt.email.database.dao.source.ContactsDaoSource.COL_EMAIL) + " = ?"), new java.lang.String[]{ email.toLowerCase() }, null);
