...
public void actionPerformed(java.awt.event.ActionEvent e) {
    ...
    try {
        if (ba.unsa.etf.si.app.Inventura.Model.ValidacijaArtikla.validirajBarkod(txtBarkod.getText())) {
            ba.unsa.etf.si.app.Inventura.Model.Artikal art = new ba.unsa.etf.si.app.Inventura.Model.Artikal();
            art = ba.unsa.etf.si.app.Inventura.Kontroleri.ArtikliKontroler.nadjiBarKod(barkod);
