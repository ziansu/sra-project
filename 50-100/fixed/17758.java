long newTodo(nl.mprog.glimp.gidolimperg_pset5.TodoList list, java.lang.String todo) {
    ...
    return database.insert(DatabaseHelper.TABLE_NAME_TODO, null, contentValues);
}