...
public static void setUpBeforeClass() throws java.lang.Exception {
    net.sf.memoranda.test.DefectListPullingFromFileTest.today = net.sf.memoranda.date.CalendarDate.today();
    net.sf.memoranda.test.DefectListPullingFromFileTest.tomorrow = net.sf.memoranda.date.CalendarDate.tomorrow();
    net.sf.memoranda.test.DefectListPullingFromFileTest.dayAfterTomorrow = net.sf.memoranda.test.DefectListPullingFromFileTest.tomorrow.tomorrow();
