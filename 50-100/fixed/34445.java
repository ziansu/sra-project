...
public void testTelemetryInitializedWhenContextAvailable() {
    ...
    org.junit.Assert.assertEquals(com.microsoft.applicationinsights.extensibility.initializer.docker.DockerContextInitializerTests.DEFAULT_CONTAINER_NAME, com.microsoft.applicationinsights.extensibility.initializer.docker.DockerContextInitializerTests.telemetry.getContext().getDevice().getId());
