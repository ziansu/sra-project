...
public android.support.v4.app.Fragment getItem(int position) {
    switch (position) {
        case 0 :
            ...
            return invTab;
        case 1 :
            com.pommerening.quinn.foodtruck.fragment.tabs.employee.EmployeeOrderFragment orderTab = com.pommerening.quinn.foodtruck.fragment.tabs.employee.EmployeeOrderFragment.newInstance(mUsername);
            return orderTab;
        case 2 :
