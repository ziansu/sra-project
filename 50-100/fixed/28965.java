private org.apache.lucene.search.TopDocs getTopFieldDocs() throws java.io.IOException {
    ...
    return org.apache.lucene.search.TopFieldDocs.merge(queryExecution.sort, queryExecution.start, queryExecution.rows, topFieldDocsList.toArray(new org.apache.lucene.search.TopFieldDocs[topFieldDocsList.size()]), true);
}