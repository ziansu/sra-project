public static ba.unsa.etf.si.app.Inventura.Model.TipZaposlenika provjerUserPass(java.lang.String username, java.lang.String password) throws java.lang.Exception {
    try {
        ba.unsa.etf.si.app.Inventura.Model.TipZaposlenika zaposlenik = new ba.unsa.etf.si.app.Inventura.Model.TipZaposlenika();
        zaposlenik = ba.unsa.etf.si.app.Inventura.Kontroleri.TipZaposlenikaKontroler.nadjiKorisnickoIme(username);
