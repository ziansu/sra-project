...
java.lang.String username) {
    ...
    edu.hawaii.its.holiday.controller.WsGetMembersResults wsGetMembersResults = new edu.hawaii.its.holiday.controller.GcGetMembers().assignActAsSubject(wsSubjectLookup).addSubjectAttributeName("uid").addGroupName(grouping).assignIncludeSubjectDetail(true).execute();
