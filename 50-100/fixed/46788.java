private boolean receiveRequest(org.xtreemfs.foundation.pbrpc.server.RPCServerRequest request, org.xtreemfs.foundation.pbrpc.server.RPCNIOSocketServerConnection con) {
    try {
        request.getHeader();
