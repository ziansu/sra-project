...
int number) {
    ...
    org.springframework.http.ResponseEntity<java.lang.String> response = restTemplate.exchange(((com.org.gameofthree.PlayerApp.GAME_SERVER) + gameId), HttpMethod.POST, httpEntity, java.lang.String.class);
