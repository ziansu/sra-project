public int updateLastUseOfPgpContact(android.content.Context context, com.flowcrypt.email.test.PgpContact pgpContact) {
    ...
    if ((pgpContact != null) && (contentResolver != null)) {
        ...
        return contentResolver.update(getBaseContentUri(), contentValues, ((com.flowcrypt.email.database.dao.source.ContactsDaoSource.COL_EMAIL) + " = ?"), new java.lang.String[]{ pgpContact.getEmail().toLowerCase() });
    }else
        return -1;
