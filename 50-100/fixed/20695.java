private static void upgradeCacheDatabase() {
    ...
    if (oldVersion != 0) {
        android.util.Log.i(android.webkit.WebViewDatabase.LOGTAG, (((("Upgrading cache database from version " + oldVersion) + " to ") + (android.webkit.WebViewDatabase.CACHE_DATABASE_VERSION)) + ", which will destroy all old data"));
    }
