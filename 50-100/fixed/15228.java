public void execute() {
    ObjectService.Util.getInstance().hideGroupSharedFolder(session.getPrimaryGroup().getId(), virtualFolder.getId(), new edu.umn.msi.tropix.webgui.client.AsyncCallbackImpl<java.lang.Void>() {
        @java.lang.Override
