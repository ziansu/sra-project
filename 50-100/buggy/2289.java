...
private rx.Observable<rx.schedulers.Timestamped<java.util.List<com.murki.flckrdr.viewmodel.FlickrCardVM>>> obtainUsableObservable() {
    ...
    if (recentPhotosObservable == null) {
        ...
        recentPhotosObservable = flickrDomainService.getRecentPhotos(flickrListAdapter.getTimestampMillis()).cache().observeOn(rx.android.schedulers.AndroidSchedulers.mainThread());
