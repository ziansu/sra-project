...
public void verificationTest() {
    ...
    if (isMobile()) {
        ...
        io.wcm.qa.galenium.util.VerificationUtil.verify(new io.wcm.qa.galenium.verification.CssClassVerification(org.adaptto.galenium.example.constants.Selectors.SELECTOR_NAV_LINK_HOME, org.adaptto.galenium.example.ConferenceIT.CSS_CLASS_NAVLINK_ACTIVE), new io.wcm.qa.galenium.verification.NoCssClassVerification(org.adaptto.galenium.example.constants.Selectors.SELECTOR_NAV_LINK_CONFERENCE, org.adaptto.galenium.example.ConferenceIT.CSS_CLASS_NAVLINK_ACTIVE));
    }
