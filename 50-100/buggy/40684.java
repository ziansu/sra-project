...
public void preInit(net.minecraftforge.fml.common.event.FMLPreInitializationEvent event) {
    ...
    sidben.villagertweaks.ModVillagerTweaks.NetworkWrapper.registerMessage(NetworkHelper.GolemEnchantmentHandler.class, sidben.villagertweaks.network.MessageGolemEnchantments.class, 0, Side.CLIENT);
}