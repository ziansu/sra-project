...
public com.ibasco.agql.core.session.SessionId createId(com.ibasco.agql.core.AbstractMessage message) {
    ...
    java.lang.String id = new java.lang.StringBuffer().append(createIdStringFromMsg(message)).append(":").append(((com.ibasco.agql.protocols.valve.source.query.SourceRconMessage) (message)).getRequestId()).toString();
