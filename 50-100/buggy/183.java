public static void registerMCBindings() {
    ...
    for (moze_intel.projecte.utils.PEKeybind k : moze_intel.projecte.utils.PEKeybind.values()) {
        net.minecraft.client.settings.KeyBinding mcK = new net.minecraft.client.settings.KeyBinding(net.minecraft.util.StatCollector.translateToLocal(k.keyName), k.defaultKeyCode, moze_intel.projecte.PECore.MODID);
        builder.put(mcK, k);
