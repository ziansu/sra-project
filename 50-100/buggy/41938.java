...
public void testWikiConfigureWithDotVersion() {
    ...
    org.mockito.Mockito.verify(mockSynapseClient).getEntityBundleForVersion(org.mockito.Matchers.eq(entityId), org.mockito.Matchers.eq(versionNumber), org.mockito.Matchers.anyInt(), any(com.google.gwt.user.client.rpc.AsyncCallback.class));
}