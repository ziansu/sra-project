private void clearDefaultList() {
    try {
        com.google.api.services.tasks.model.Tasks tasks = com.todoroo.astrid.gtasks.GtasksApiTest.service.getAllGtasksFromListId(com.todoroo.astrid.gtasks.GtasksApiTest.DEFAULT_LIST, false, false);
