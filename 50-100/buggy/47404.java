protected static void replaceDistinctWithGroupBy(java.lang.StringBuilder sql) {
    ...
    if ((distinctIndex > 0) && (distinctIndex < selectEndIndex)) {
        ...
        sql.append(" group by").append(org.hibernate.dialect.SQLServer2005Dialect.getSelectFieldsWithoutAliases(sql));
    }
}