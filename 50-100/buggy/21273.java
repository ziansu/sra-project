...
protected void initChannel(io.netty.channel.socket.SocketChannel ch) throws java.lang.Exception {
    ...
    pipeline.addLast(new io.netty.handler.codec.serialization.ObjectEncoder(), new io.netty.handler.codec.serialization.ObjectDecoder(io.netty.handler.codec.serialization.ClassResolvers.cacheDisabled(loader)));
