public void unlink(cam72cam.immersiverailroading.entity.EntityLinkableRollingStock train) {
    if ((train.getPersistentID()) == (this.getCoupledUUID(cam72cam.immersiverailroading.entity.EntityLinkableRollingStock.CouplerType.FRONT))) {
        unlink(cam72cam.immersiverailroading.entity.EntityLinkableRollingStock.CouplerType.FRONT);
    }else
        if ((train.getPersistentID()) == (this.getCoupledUUID(cam72cam.immersiverailroading.entity.EntityLinkableRollingStock.CouplerType.BACK))) {
