...
final net.minecraft.nbt.NBTTagCompound compound) {
    compound.setInteger(com.minecolonies.coremod.entity.ai.citizen.miner.Node.TAG_X, x);
    compound.setInteger(com.minecolonies.coremod.entity.ai.citizen.miner.Node.TAG_Z, z);
