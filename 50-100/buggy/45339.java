private long testGsonPath() {
    ...
    org.junit.Assert.assertEquals(personModelList.size(), gsonpath.PeopleModelTest.PEOPLE_SIZE);
    org.junit.Assert.assertEquals(personModelList.get(0).getFirstName(), "Lachlan");
    return duration;
}