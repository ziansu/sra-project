...
public void activate(final com.enonic.xp.server.udc.impl.UdcConfig config) {
    ...
    final com.enonic.xp.server.udc.impl.UdcInfoGenerator generator = new com.enonic.xp.server.udc.impl.UdcInfoGenerator();
    final com.enonic.xp.server.udc.impl.PingSenderImpl sender = new com.enonic.xp.server.udc.impl.PingSenderImpl(generator, config.url());
