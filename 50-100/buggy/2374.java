...
public void displayMap() {
    if (((getSupportFragmentManager().findFragmentByTag(com.whiterabbit.pisabike.screens.main.MainActivity.MAP_TAG)) != null) && ((getSupportFragmentManager().getBackStackEntryCount()) > 0)) {
