...
protected java.util.ArrayList<com.muyunluan.bakingapp.data.BakingRecipe> doInBackground(java.lang.Void... params) {
    try {
        ...
        android.util.Log.i(com.muyunluan.bakingapp.widget.RecipeAppRemoteViewsFactory.TAG, ("doInBackground: updated Baking Recipe data size - " + (mBakingRecipeData.size())));
