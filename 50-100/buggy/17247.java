...
public void onPause() {
    ...
    android.content.SharedPreferences.Editor prefEditor = android.preference.PreferenceManager.getDefaultSharedPreferences(activity.getApplicationContext()).edit();
