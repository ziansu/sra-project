...
public void onResume() {
    ...
    if (sharedpreferences.contains(com.example.bobthebuilder.MainActivity.BuiltScore)) {
        tToast(sharedpreferences.getString(com.example.bobthebuilder.MainActivity.BuiltScore, ""));
    }
    if (sharedpreferences.contains(com.example.bobthebuilder.MainActivity.UnBuiltScore)) {
        tToast(sharedpreferences.getString(com.example.bobthebuilder.MainActivity.UnBuiltScore, ""));
    }
}