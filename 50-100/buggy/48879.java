public static mcgill.ca.fragilitysurvey.quiz.questions.Question getQuestionById(int id, final android.content.res.Resources res) {
    java.util.List<mcgill.ca.fragilitysurvey.quiz.questions.Question> questions = mcgill.ca.fragilitysurvey.quiz.questions.Questions.completeSurveyQuestions(res);
