public static java.lang.String updatePOM(org.apache.commons.fileupload.FileItem _inputFile) {
    ...
    try {
        ...
        if (strUpdated.equals(fr.paris.lutece.plugins.lutecetools.service.XMLParser.CANCELLED)) {
            return fr.paris.lutece.plugins.lutecetools.service.XMLParser.CANCELLED;
        }
