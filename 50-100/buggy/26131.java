private org.openhab.binding.zwave.handler.ZWaveThingChannel createChannel(java.lang.String type) {
    ...
    args.put("type", type);
    return new org.openhab.binding.zwave.handler.ZWaveThingChannel(uid, org.openhab.binding.zwave.handler.ZWaveThingChannel.DataType.DecimalType, CommandClass.METER_TBL_MONITOR.toString(), 0, args);
}