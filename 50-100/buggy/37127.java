public void deregisterInstancesFromLoadBalancer(java.lang.String loadBalancerName, java.util.List<org.apache.stratos.aws.extension.Instance> instances, java.lang.String region) {
    ...
    try {
        ...
        org.apache.stratos.aws.extension.DeregisterInstancesFromLoadBalancerResult result = elbClient.deregisterInstancesFromLoadBalancer(deregisterInstancesFromLoadBalancerRequest);
