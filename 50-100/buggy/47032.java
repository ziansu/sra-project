...
public org.finra.herd.model.jpa.TagTypeEntity getTagTypeByDisplayName(java.lang.String displayName) {
    ...
    javax.persistence.criteria.Predicate queryRestriction = builder.equal(builder.upper(tagTypeEntity.get(TagTypeEntity_.displayName)), tagTypeCode.toUpperCase());
