...
public void setUp(com.hazelcast.simulator.test.TestContext testContext) throws java.lang.Exception {
    ...
    operationSelectorBuilder.addOperation(com.hazelcast.simulator.tests.jmx.PartitionServiceMBeanTest.Operation.IsClusterSafe, isLocalMemberSafeProb).addDefaultOperation(com.hazelcast.simulator.tests.jmx.PartitionServiceMBeanTest.Operation.IsLocalMemberSafe);
}