public void notifyChallengeComplete() {
    if (((numOfChallengesComplete)++) == (numOfChallenges)) {
        ...
        challenge = new com.tigerzone.fall2016server.tournament.Challenge(this, com.tigerzone.fall2016server.server.TournamentServer.seed, com.tigerzone.fall2016server.server.TournamentServer.tournamentPlayers);
