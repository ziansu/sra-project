...
public void createDocumentReferenceWhenPageParameterEmpty() throws java.lang.Exception {
    ...
    org.mockito.Mockito.when(this.resolver.resolve(new org.xwiki.model.reference.EntityReference("space", org.xwiki.model.EntityType.SPACE, new org.xwiki.model.reference.EntityReference("wiki", org.xwiki.model.EntityType.WIKI)))).thenReturn(reference);
