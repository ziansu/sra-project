private long heartbeatPeriodMillis() {
    com.hazelcast.instance.GroupProperties props = nodeEngine.getGroupProperties();
    int callTimeoutMs = props.getInteger(com.hazelcast.instance.GroupProperty.OPERATION_CALL_TIMEOUT_MILLIS);
