private static void checkColor(java.awt.Color expected, org.apache.poi.sl.usermodel.PaintStyle actualStyle) {
    org.junit.Assert.assertTrue((actualStyle instanceof org.apache.poi.sl.usermodel.PaintStyle.SolidPaint));
    ...
    org.junit.Assert.assertArrayEquals(expRGB, actRGB, 1.0E-4F);
}