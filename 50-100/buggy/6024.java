public void requireFeature(java.lang.String name, java.lang.String range, boolean mandatory) {
    if (mandatory) {
        ...
        org.apache.karaf.features.internal.resolver.ResourceUtils.addIdentityRequirement(res, name, org.apache.karaf.features.internal.resolver.ResourceUtils.TYPE_FEATURE, range);
