...
public void test_id_token() {
    ...
    if (null == file) {
        com.here.account.oauth2.tutorial.GetHereClientCredentialsIdTokenTutorialTest.setTestCreds(tutorial, com.here.account.oauth2.tutorial.Helper.getSystemCredentials());
    }
