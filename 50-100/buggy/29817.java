...
public void setUpIndexes() {
    ...
    database.getCollection(database.DatabaseStringConstants.EXPERIMENT_COLLECTION).createIndex(new com.mongodb.BasicDBObject(database.DatabaseStringConstants.COURSE_PROBLEM_ID, 1).append(database.DatabaseStringConstants.USER_ID, 1).append("unique", true));
