public void testVerify() throws java.lang.Exception {
    ...
    authSession.verify(new com.feedhenry.sdk.api.FHAuthSession.Callback() {
        @java.lang.Override
    ...
    assertTrue(valid);
    assertEquals(com.feedhenry.sdk.tests.api.FHAuthSessionTest.TEST_TOKEN, authSession.getToken());
}