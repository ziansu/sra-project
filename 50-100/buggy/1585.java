private eionet.webq.dao.orm.UserFile userFileServiceWillReturnUserFileFromCdr() {
    ...
    org.mockito.Mockito.when(userFileHelper.getUserFile(org.mockito.Matchers.anyInt(), org.mockito.Matchers.any(javax.servlet.http.HttpServletRequest.class))).thenReturn(userFile);
    return userFile;
}