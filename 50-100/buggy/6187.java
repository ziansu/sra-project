...
public boolean update(java.lang.String id, com.ai.paas.ipaas.search.common.JsonBuilder jsonBuilder) {
    ...
    org.elasticsearch.action.update.UpdateResponse response = client.prepareUpdate(indexName, indexName, id).setRefresh(true).setConsistencyLevel(WriteConsistencyLevel.DEFAULT).setDoc(jsonBuilder.getBuilder()).get();
