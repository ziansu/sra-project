public void write(java.io.OutputStream outputStream) throws java.io.IOException, javax.ws.rs.WebApplicationException {
    ...
    try (java.io.InputStream inputStream = is) {
        org.apache.tika.server.resource.TikaResource.parse(parser, org.apache.tika.server.resource.TikaResource.LOG, info.getPath(), inputStream, handler, metadata, context);
    }
}