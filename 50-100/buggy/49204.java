public static void startStopwatch(final ru.spbstu.ptime.constructor.TimeController controller, final ru.spbstu.ptime.constructor.ViewUpdater<java.lang.Long> updater) {
    ...
    ru.spbstu.ptime.constructor.TimeCounter counter = new ru.spbstu.ptime.constructor.TimeCounter(currentTime, java.lang.Long.MAX_VALUE, 30, ru.spbstu.ptime.constructor.TimeEngine.mHandler) {
        @java.lang.Override
