@java.lang.Override
public void run() {
    com.example.alv_chi.improject.greendao.DataBaseUtil.getDataBaseInstance().create(new com.example.alv_chi.improject.greendao.MessageRecord(0L, baseItem.getUserName(), dataManagerInstance.getCurrentMasterUserName(), baseItem.getCurrentTimeStamp(), baseItem.getMesage(), baseItem.getCurrentTimeStamp(), baseItem.getMesage(), baseItem.getUserJID(), baseItem.getTypeView(), baseItem.isReceivedMessage(), baseItem.isOnline()));
