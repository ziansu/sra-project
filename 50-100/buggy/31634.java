...
public void onSensorChanged(android.hardware.SensorEvent event) {
    if ((event.sensor.getType()) == (android.hardware.Sensor.TYPE_MAGNETIC_FIELD)) {
        ...
        wr.appendData(io.github.kajdreef.smartphonesensing.Sensor.Magnetometer.geomagnetic[0], io.github.kajdreef.smartphonesensing.Sensor.Magnetometer.geomagnetic[1], io.github.kajdreef.smartphonesensing.Sensor.Magnetometer.geomagnetic[2], Type.NONE);
