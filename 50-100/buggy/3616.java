private java.util.Optional<java.net.URL> getXMLUrl(final java.lang.String aUrl) {
    ...
    if (id.isPresent()) {
        try {
            return java.util.Optional.of(new java.net.URL(java.lang.String.format(de.mediathekview.mserver.crawler.dreisat.tasks.DreisatFilmDetailsTask.XML_SERVICE_URL_PATTERN, id)));
