...
public void onReceive(android.content.Context context, android.content.Intent intent) {
    ...
    long checkFrequencyInMinutes = ((java.lang.Long.parseLong(android.preference.PreferenceManager.getDefaultSharedPreferences(context).getString(SettingsActivity.PREF_CHECK_FREQUENCY_KEY, "0"))) * (android.text.format.DateUtils.MINUTE_IN_MILLIS)) / 5;
