private void initMenuButtonAnimations(android.content.res.TypedArray attr) {
    ...
    mImageToggleShowAnimation = android.view.animation.AnimationUtils.loadAnimation(getContext(), showResId);
    ...
    mImageToggleHideAnimation = android.view.animation.AnimationUtils.loadAnimation(getContext(), hideResId);
}