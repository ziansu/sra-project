...
public void testRandomFish2() {
    ...
    org.junit.Assert.assertEquals(generatedFish.getPosition().getPosX(), lasersharks.Position.getWidthPanel(), 0);
    org.junit.Assert.assertEquals(expectedSize2, generatedFish.getSize(), 1);
