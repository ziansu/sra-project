public static com.ustadmobile.core.controller.CatalogController makeUserCatalog(com.ustadmobile.core.impl.UstadMobileSystemImpl impl, java.lang.Object context) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
    ...
    return com.ustadmobile.core.controller.CatalogController.makeControllerByURL(opdsServerURL, impl, com.ustadmobile.core.controller.CatalogController.USER_RESOURCE, activeUser, activeUserAuth, com.ustadmobile.core.controller.CatalogController.CACHE_ENABLED, context);
}