private static org.mapsforge.map.layer.cache.TileCache createTileCache() {
    org.mapsforge.map.layer.cache.TileCache firstLevelTileCache = new org.mapsforge.map.layer.cache.InMemoryTileCache(128);
    java.io.File cacheDirectory = new java.io.File(java.lang.System.getProperty("java.io.tmpdir"), "mapsforge");
