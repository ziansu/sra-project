...
public boolean matches(java.lang.Object argument) {
    ...
    org.junit.Assert.assertThat(((org.eclipse.jface.viewers.StructuredSelection) (argument)).toList(), org.hamcrest.Matchers.not(org.hamcrest.collection.IsCollectionContaining.hasItems(treeItemC.getData())));
    return true;
}