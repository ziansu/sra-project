public static <T> void mergeSort(T[] array, java.util.Comparator<T> comparator, int fromIndex, int toIndex) {
    ...
    com.lopina.important.take2.mergeSort.MergeSort.mergeSort(array, comparator, 0, breakingPoint);
    com.lopina.important.take2.mergeSort.MergeSort.mergeSort(array, comparator, (breakingPoint + 1), toIndex);
    com.lopina.important.take2.mergeSort.MergeSort.merge(array, comparator, 0, breakingPoint, (breakingPoint + 1), toIndex);
}