public static void main(java.lang.String[] args) {
    ...
    new Ui.UserInterface(java.lang.System.in, warehouse, catalogue, basket, new CatalogueActions.CatalogueActions(catalogue), new WarehouseActions.WarehouseActions(warehouse), new BasketActions.BasketActions(basket, catalogue, warehouse)).start();
