public static void main(java.lang.String[] args) {
    ...
    edu.drexel.psal.jstylo.generics.Verifier v = new edu.drexel.psal.jstylo.verifiers.DistractorlessVerifier(test.getTrainingInstances(), test.getTestInstances(), true);
    v.verify();
