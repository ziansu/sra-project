public void testAgainstSlowVersion() {
    for (int i = 0; i < 100000; i++) {
        ...
        double expected = org.apache.lucene.util.SloppyMath.haversinMeters(lat1, lon1, lat2, lon2);
        double actual = org.apache.lucene.util.TestSloppyMath.slowHaversin(lat1, lon1, lat2, lon2);
