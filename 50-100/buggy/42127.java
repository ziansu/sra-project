public javax.management.remote.JMXConnector newJMXConnector(javax.management.remote.JMXServiceURL serviceURL, java.util.Map<java.lang.String, ?> environment) throws java.io.IOException {
    ...
    if (((org.jboss.remotingjmx.Constants.PROTOCOL.equals(protocol)) || (org.jboss.remotingjmx.Constants.HTTP_PROTOCOL.equals(protocol))) || (org.jboss.remotingjmx.Constants.HTTPS_PROTOCOL.equals(org.jboss.remotingjmx.Constants.PROTOCOL))) {
