...
public void init(javax.servlet.ServletConfig config) throws javax.servlet.ServletException {
    super.init(config);
    mealRestController = new ru.javawebinar.topjava.web.meal.MealRestController();
    try (org.springframework.context.ConfigurableApplicationContext appCtx = new org.springframework.context.support.ClassPathXmlApplicationContext("spring/spring-app.xml")) {
        ...
        ru.javawebinar.topjava.web.meal.MealRestController mealRestController = appCtx.getBean(ru.javawebinar.topjava.web.meal.MealRestController.class);
