public void removeDateFromTaskDetails(java.lang.String textToRemove) {
    ...
    if (taskDetails.startsWith(textToRemove)) {
        ...
        taskDetails = Parser.CommandParser.cleanupExtraWhitespace(taskDetails.replace(((ParserConstants.STRING_WHITESPACE) + textToRemove), ParserConstants.STRING_WHITESPACE));
    }
}