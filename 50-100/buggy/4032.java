...
public com.codepath.apps.tweetter.TweetAdapter.ViewHolder onCreateViewHolder(android.view.ViewGroup parent, int viewType) {
    com.codepath.apps.tweetter.TweetAdapter.context = parent.getContext();
    if ((inflater) == null) {
        inflater = android.view.LayoutInflater.from(com.codepath.apps.tweetter.TweetAdapter.context);
    }
