private static void getData() {
    ...
    ClassificationMethods.activeData = ((java.util.ArrayList<java.util.ArrayList<java.lang.Double>>) (ClassificationMethods.data.subList(0, 1347)));
    ClassificationMethods.nonActiveData = ((java.util.ArrayList<java.util.ArrayList<java.lang.Double>>) (ClassificationMethods.data.subList(1347, DataRetrievalLayer.dataLength)));
