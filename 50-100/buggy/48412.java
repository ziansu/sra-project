...
public void doesNotReopenBrowserIfItFailed() {
    ...
    org.mockito.Mockito.verify(container, org.mockito.Mockito.never()).isBrowserStillOpen(org.mockito.ArgumentMatchers.any(org.openqa.selenium.WebDriver.class));
}