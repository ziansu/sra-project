...
public void compressedResponse() {
    ...
    final org.springframework.http.ResponseEntity<java.util.List<org.springframework.cloud.netflix.feign.encoding.app.domain.Invoice>> response = invoiceClient.saveInvoices(invoices);
