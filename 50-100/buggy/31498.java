...
public void test_remove_index_notation() {
    ...
    org.junit.Assert.assertEquals(participants.size(), 1);
    org.junit.Assert.assertEquals(participants.get(0).get("id"), 1);
    org.junit.Assert.assertEquals(participants.get(0).get("name"), "Waverly");
}