public void googleSignIn(android.app.Activity context, int requestCode) {
    ...
    mGoogleApiClient = new com.google.android.gms.common.api.GoogleApiClient.Builder(context).addApi(Auth.GOOGLE_SIGN_IN_API, gso).addScope(Plus.SCOPE_PLUS_LOGIN).build();
