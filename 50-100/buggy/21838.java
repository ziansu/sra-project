...
public com.example.andrew.prokhor.eyecare.ui.adapters.ExpandableCursorRecyclerViewAdapter.MyParentViewHolder onCreateParentViewHolder(android.view.ViewGroup parentViewGroup) {
    ...
    com.example.andrew.prokhor.eyecare.ui.adapters.ExpandableCursorRecyclerViewAdapter.MyParentViewHolder holder = new com.example.andrew.prokhor.eyecare.ui.adapters.ExpandableCursorRecyclerViewAdapter.MyParentViewHolder(mContext, view, initExpand);
    if (initExpand) {
        initExpand = false;
    }
    return holder;
