public org.apache.calcite.rel.RelNode convert(org.apache.calcite.rel.RelNode rel) {
    ...
    return new org.apache.phoenix.calcite.PhoenixSort(rel.getCluster(), traitSet, convert(sort.getInput(), traitSet.replace(RelCollationImpl.EMPTY)), sort.getCollation(), sort.offset, sort.fetch);
}