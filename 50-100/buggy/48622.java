public void addFeatures(java.util.Set<de.tudarmstadt.ukp.dkpro.tc.api.features.Feature> features) {
    ...
    for (de.tudarmstadt.ukp.dkpro.tc.api.features.Feature f : features) {
        featTmp.add(f);
    }
