private static java.util.Map<net.parostroj.timetable.model.changes.SpecialTrainTimeIntervalList.Type, java.lang.String> getTilDescs() {
    java.util.Map<net.parostroj.timetable.model.changes.SpecialTrainTimeIntervalList.Type, java.lang.String> map = new java.util.EnumMap<net.parostroj.timetable.model.changes.SpecialTrainTimeIntervalList.Type, java.lang.String>(SpecialTrainTimeIntervalList.Type.class);
