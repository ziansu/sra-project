public void testGetClusterId() {
    ...
    org.voltdb.ProcedureRunner runner = new org.voltdb.ProcedureRunner(gcip, site, null, org.voltdb.VoltDB.instance().getCatalogContext().database.getProcedures().get(org.voltdb.TestVoltProcedure.GetClusterIdProcedure.class.getName()));
