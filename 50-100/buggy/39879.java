...
protected boolean isDisjoint(org.apache.lucene.search.Range o) {
    ...
    return ((org.apache.lucene.util.StringHelper.compare(bMin.length, bMin, 0, other.max.getAddress(), 0)) > 0) || ((org.apache.lucene.util.StringHelper.compare(bMax.length, bMax, 0, other.min.getAddress(), 0)) < 0);
}