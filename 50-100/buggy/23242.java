private void onOK() {
    try {
        ...
        javax.swing.JOptionPane.showMessageDialog(new javax.swing.JFrame(), errorMessage, canNotSaveSettingsToRegistryMessage, javax.swing.JOptionPane.ERROR_MESSAGE);
    }
    dispose();
}