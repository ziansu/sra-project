...
public void testCreateIntervention() {
    entity.Intervention intervention = new entity.Intervention(new java.util.Date(), "Intervention 1", "263 Avenue Général Leclerc", "35000", "Rennes", entity.DisasterCode.FHA);
