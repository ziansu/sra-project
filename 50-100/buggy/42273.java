...
public void onReceive(android.content.Context context, android.content.Intent intent) {
    ...
    if (SurveyService.ALL_SENT_SURVEYS_ACTION.equals(intent.getAction())) {
        ...
        org.eyeseetea.malariacare.layout.utils.LayoutUtils.setListViewHeightBasedOnChildren(getListView());
        ((org.eyeseetea.malariacare.DashboardActivity) (getActivity())).loadFinished();
    }
}