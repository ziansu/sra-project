...
public void testEspresso() {
    ...
    android.support.test.espresso.ViewInteraction interaction2 = android.support.test.espresso.Espresso.onView(org.hamcrest.CoreMatchers.allOf(withId(R.id.editText), withText("how about new text")));
