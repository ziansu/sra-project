...
public void testInvalidChoice() throws org.quattor.pan.exceptions.SyntaxException {
    ...
    type.validate(context, org.quattor.pan.dml.data.StringProperty.getInstance("C"));
}