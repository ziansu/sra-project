...
private org.springframework.web.servlet.ModelAndView logSerpImpression(@net.media.adserver.controller.RequestParam
...
java.lang.String qId, @net.media.adserver.controller.RequestParam
...
java.lang.String page_name) {
    return net.media.adserver.controller.util.JsonPResponse.getJsonPResponse(true, loggingService.logSerpImpression(adUnitId, url, referrer, publisherId, net.media.adserver.common.RequestInfo.of(request), requestId), callback, qId, requestId);
}