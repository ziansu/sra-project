private void addStepWatch(com.sun.jdi.request.EventRequestManager erm, com.sun.jdi.event.Event event) {
    com.sun.jdi.request.StepRequest stepRequest = erm.createStepRequest(((com.sun.jdi.event.VMStartEvent) (event)).thread(), StepRequest.STEP_LINE, StepRequest.STEP_INTO);
