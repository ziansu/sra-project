...
public void Returns_500_when_service_error() throws java.lang.Exception {
    ...
    org.mockito.BDDMockito.given(vehicleDataService.getVehicleData(org.mockito.Matchers.any())).willThrow(new java.lang.RuntimeException("Database is not ready"));
