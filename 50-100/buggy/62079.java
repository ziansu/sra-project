public org.kframework.krun.api.SearchResults stepAll(int steps) throws org.kframework.krun.KRunExecutionException {
    ...
    org.kframework.krun.api.SearchResults results = executor.search(null, steps, SearchType.PLUS, org.kframework.krun.api.ExecutorDebugger.defaultPattern, getState(currentState).getRawResult(), org.kframework.krun.api.ExecutorDebugger.defaultPatternInfo);
