...
public void isHoldingRequest() {
    ...
    org.junit.Assert.assertTrue(test.com.uaihebert.uaimockserver.validation.HoldTheRequestTest.ASSERTING_TEXT, (timeLapseRequestWithHold >= regularRequestWithHoldTime));
}