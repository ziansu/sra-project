private void setLeftChartContent(int selectedItemIndex) {
    ...
    org.jfree.chart.JFreeChart chart = de.hs.mannheim.modUro.controller.diagram.SimulationDiagramController.createChart(dataset, simulationDiagram.getMetricTypes().get(selectedItemIndex).getName());
