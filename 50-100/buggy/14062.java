public void startDataFlow(javax.servlet.http.HttpServletRequest request) {
    ...
    switch (path) {
        case ranian.bookkeeping.system.dataflow.DataFlowCarrier.AddOrEditTransRecordData.PATH :
            ...
            break;
        case ranian.bookkeeping.system.dataflow.DataFlowCarrier.QueryFormData.PATH :
            this.queryFormData = new ranian.bookkeeping.system.dataflow.DataFlowCarrier.QueryFormData(request);
            break;
    }
