...
public void onFailure(final org.jboss.gwt.flow.FunctionContext context) {
    ...
    elemental.client.Browser.getDocument().getBody().appendChild(org.jboss.hal.client.bootstrap.BootstrapFailed.create(resources.constants().bootstrapException(), context.getErrorMessage()).asElement());
}