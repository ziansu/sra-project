...
public void getById() throws java.lang.Exception {
    ...
    mockMvc.perform(get(com.cinema.controller.rest.CustomerControllerTest.CUSTOMER_GET_BY_ID_ID_1).accept(MediaType.APPLICATION_JSON)).andDo(org.springframework.test.web.servlet.result.MockMvcResultHandlers.print()).andExpect(status().isFound());
}