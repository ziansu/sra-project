...
public void onLoadFinished(android.content.Loader<android.database.Cursor> cursorLoader, android.database.Cursor cursor) {
    ...
    android.support.v7.widget.GridLayoutManager gridLayoutManager = new android.support.v7.widget.GridLayoutManager(this, columnCount, android.support.v7.widget.LinearLayoutManager.VERTICAL, false);
