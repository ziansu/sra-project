...
public void addTestDevice() {
    ...
    hestia.backend.Activator testButton = new hestia.backend.Activator(com.rugged.application.hestia.BackendInteractorTest.TEST_ACTIVATOR_ID, testState, "testButton");
