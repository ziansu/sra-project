public static void matchPatternGen() {
    ...
    java.lang.String[] keywords = new java.lang.String[]{ "Verify" , "Correlation" , "(\\w+[,( \\w+)]*)" , "nextLine" , "Piggybacking" , "(None|Map-only|MapReduce)" , "nextLine" , "MapOnly" , "mapOutputPercentage" , "(\\d+)" , "nextLine" , "MapReduce" , "IntermediateOutputPercentage" , "(\\d+)" , "nextLine" , "[;]{0,1}" };
