public void btnMakeTransfer(android.view.View v, uk.ac.ncl.csc2022.t14.bankingapp.models.Account accountTo, double amount) {
    ...
    uk.ac.ncl.csc2022.t14.bankingapp.models.Account accountB = uk.ac.ncl.csc2022.t14.bankingapp.Utilities.DataStore.sharedInstance().getCurrentUser().getAccountForId(uk.ac.ncl.csc2022.t14.bankingapp.activities.TransferActivity.accountFromId);
    transferrer.makeTransfer(accountA, accountB, amount, ((uk.ac.ncl.csc2022.t14.bankingapp.server.interfaces.TransferDelegate) (this.getActivity())));
}