...
public void searchFailedProcessInstances_should_throw_exception_when_transaction_content_failed() throws java.lang.Exception {
    ...
    doThrow(new org.bonitasoft.engine.persistence.SBonitaReadException(new java.lang.Exception("plop"))).when(processInstanceService).getNumberOfFailedProcessInstances(org.mockito.Matchers.any(org.bonitasoft.engine.persistence.QueryOptions.class));
