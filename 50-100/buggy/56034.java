...
public void getSessionExpired() {
    ...
    org.mockito.Mockito.when(redisOperations.boundHashOps(org.springframework.session.data.redis.RedisOperationsSessionRepository.getKey(expiredId))).thenReturn(boundHashOperations);
