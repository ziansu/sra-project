...
private void customizeMaxHttpHeaderSize(org.springframework.boot.context.embedded.tomcat.TomcatEmbeddedServletContainerFactory factory) {
    factory.addConnectorCustomizers(new org.springframework.boot.context.embedded.tomcat.TomcatConnectorCustomizer() {
        ...
        public void customize(org.apache.catalina.connector.Connector connector) {
            ...
            if (handler instanceof org.apache.coyote.http11.AbstractHttp11Protocol) {
                ...
                protocol.setMaxHttpHeaderSize(org.springframework.boot.autoconfigure.web.ServerProperties.Tomcat.this.maxHttpHeaderSize);
            }
        }
    });
}