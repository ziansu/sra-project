...
public com.example.lisamwatkins.sunshine.ForecastAdapter.ForecastViewHolder onCreateViewHolder(android.view.ViewGroup viewGroup, int viewType) {
    int layoutId;
    if (viewType == (com.example.lisamwatkins.sunshine.ForecastAdapter.VIEW_TYPE_TODAY)) {
        layoutId = R.layout.list_item_forecast_today;
    }else
        if (viewType == (com.example.lisamwatkins.sunshine.ForecastAdapter.VIEW_TYPE_FUTURE_DAY)) {
