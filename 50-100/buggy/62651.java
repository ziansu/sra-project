public boolean shouldWatch(java.io.File directory) {
    final boolean result = ((rootSubset.isInRootsOrAncestorOrAnyRoot(directory)) || (org.gradle.internal.filewatch.jdk7.WatchPointsRegistry.isAncestorOfAnyRoot(directory, allRequestedRoots, true))) && (!(org.gradle.internal.filewatch.jdk7.WatchPointsRegistry.isAncestorOfAnyRoot(directory, currentWatchPoints, true)));
