...
com.idonans.doodle.DoodleData doodleData) {
    com.idonans.doodle.demo.MainActivity.DoodleDataAsyncTask.save("play", doodleData, new com.idonans.doodle.demo.MainActivity.DoodleDataAsyncTask.DoodleDataSaveCallback() {
        @java.lang.Override
            ...
            com.idonans.acommon.lang.Threads.runOnUi(new java.lang.Runnable() {
                ...
                public void run() {
                    if (com.idonans.doodle.demo.MainActivity.this.isAvailable()) {
                        android.content.Intent intent = com.idonans.doodle.demo.DoodlePlayActivity.start(com.idonans.doodle.demo.MainActivity.this, path);
