public void verify() throws org.silverpeas.authentication.exception.AuthenticationException {
    if ((getUser()) == null) {
        ...
        if (!(isUserStateValid())) {
            throw new org.silverpeas.authentication.exception.AuthenticationUserAccountBlockedException("UserCanLoginVerifier.verify()", com.stratelia.webactiv.util.exception.SilverpeasException.ERROR, "authentication.EX_VERIFY_USER_CAN_LOGIN", ((getUser()) != null ? "Login=" + (getUser().getLogin()) : ""));
        }
