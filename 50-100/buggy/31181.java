...
android.os.Bundle savedInstanceState) {
    ...
    fireBaseClient = new com.example.gerardo.free.FireDataBase.FireBaseClient(getActivity().getApplicationContext(), com.example.gerardo.free.Fragments.FragmentImages.DB_URL, recyclerView);
