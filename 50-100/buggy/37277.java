...
public void getsListOfAssignments() {
    ...
    org.junit.Assert.assertThat(exec.recommender_reimplementation.pbn.PBNAnalysisUtil.getAssignmentList(methodDecl.getBody()), org.hamcrest.Matchers.is(expectedAssignments));
}