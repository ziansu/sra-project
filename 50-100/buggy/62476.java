...
public void testManchesterSyntaxGeneration() throws java.lang.Exception {
    ...
    java.lang.String restrictedName = "Restricted_Single_Phenotype";
    org.lha.phenoman.man.PhenotypeOntologyManager manager = new org.lha.phenoman.man.PhenotypeOntologyManager(path, true);
    manager.addAbstractSinglePhenotype(new de.onto_med.ontology_service.AbstractSinglePhenotype(abstractName, org.semanticweb.owlapi.vocab.OWL2Datatype.XSD_INTEGER, "Category_1"));
