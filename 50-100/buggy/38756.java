...
public final void checkConnection() {
    com.thoughtworks.go.domain.materials.tfs.AbstractTfsCommand.LOGGER.info(java.lang.String.format(java.lang.String.format("[TFS] Checking Connection: Server %s, Domain %s, User %s, Project Path %s", url, domain, userName, projectPath)));
    try {
