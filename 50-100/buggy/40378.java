...
java.lang.String inputNumber) throws java.net.URISyntaxException {
    ...
    return menuBuilder(ussdGroupUtil.createGroupPrompt(sessionUser, za.org.grassroot.webapp.controller.ussd.USSDGroupController.thisSection, (((groupMenus) + (za.org.grassroot.webapp.controller.ussd.USSDGroupController.createGroupMenu)) + (doSuffix))));
}