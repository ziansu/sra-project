@juja.microservices.teams.controller.PutMapping(value = "/teams/users/{uuid}", produces = "application/json")
...
java.lang.String uuid) {
    ...
    return org.springframework.http.ResponseEntity.ok(team.toString());
}