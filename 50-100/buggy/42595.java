...
int houseId, @ge.edu.freeuni.sdp.iot.router.HeaderParam(value = "Origin")
java.lang.String origin) {
    ...
    return addHeaders(javax.ws.rs.core.Response.ok().entity((("{\"atHome\":" + (house.isAnynoneAtHome())) + "}")), origin);
}