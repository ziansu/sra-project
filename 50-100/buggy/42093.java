public void testUnequalOperation1() {
    ...
    assertEquals(parsedExpression.accept(new org.nlamah.QL.Model.Expression.Evalutation.ExpressionEvaluator()), referenceExpression.accept(new org.nlamah.QL.Model.Expression.Evalutation.ExpressionEvaluator()));
