public static com.handup.handup.controller.course.content.ContentFragment newInstance(float dpWidth, float density) {
    ...
    args.putInt(com.handup.handup.controller.course.content.ContentFragment.ARG_COLUMN_COUNT, ((int) (dpWidth / (com.handup.handup.helper.Constants.ContentListBaseSize))));
