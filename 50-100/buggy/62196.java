private int updateState(int state) {
    if ((state & (((chongxuocmanhinh.sound_plusplus.PlaybackService.FLAG_EMPTY_QUEUE) | (chongxuocmanhinh.sound_plusplus.PlaybackService.FLAG_ERROR)) | (chongxuocmanhinh.sound_plusplus.PlaybackService.FLAG_NO_MEDIA))) != 0)
