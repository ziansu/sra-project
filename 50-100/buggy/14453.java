private boolean isSuperCall(com.puppycrawl.tools.checkstyle.api.DetailAST literalSuperAst) {
    ...
    if ((literalSuperAst.getType()) == (com.puppycrawl.tools.checkstyle.api.TokenTypes.LITERAL_SUPER)) {
        ...
        if ((((dotAst.getType()) == (com.puppycrawl.tools.checkstyle.api.TokenTypes.DOT)) && (!(isSameNameMethod(literalSuperAst)))) && (!(com.puppycrawl.tools.checkstyle.checks.coding.AbstractSuperCheck.hasArguments(dotAst)))) {
