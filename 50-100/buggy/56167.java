public void process(java.lang.String RECIEVED_IP, int RECIEVED_PORT) throws java.io.IOException {
    ...
    lk.filetributed.model.protocols.FileTableProtocol fileTableProtocol = new lk.filetributed.model.protocols.FileTableProtocol(lk.filetributed.client.Client.CLIENT_IP, lk.filetributed.client.Client.CLIENT_PORT, fileTable);
    java.lang.String fileTableMSG = fileTableProtocol.toString();
    outBuffer.add(new lk.filetributed.model.DispatchMessage(fileTableMSG, RECIEVED_IP, RECIEVED_PORT));
}