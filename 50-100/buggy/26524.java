...
final java.lang.String applicationCode, final javax.servlet.http.HttpServletRequest request) {
    ...
    if (((waterConnectionDetails.getCloseConnectionType()) != null) && ((org.egov.wtms.utils.constants.WaterTaxConstants.PERMENENTCLOSECODE.equals(waterConnectionDetails.getCloseConnectionType())) || (org.egov.wtms.utils.constants.WaterTaxConstants.TEMPERARYCLOSECODE.equals(waterConnectionDetails.getCloseConnectionType()))))
