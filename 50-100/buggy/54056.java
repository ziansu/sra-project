...
public void EmergencySend(byte[] data) throws com.ANT.MiddleWare.Entities.FileFragment.FileFragmentException, java.io.IOException {
    com.ANT.MiddleWare.Entities.FileFragment f = new com.ANT.MiddleWare.Entities.FileFragment(numIP, 0, data.length, com.ANT.MiddleWare.WiFi.WiFiBroad.WiFiBroad.EMERGEN_SEND_TAG, (-1));
    f.setData(data);
    data = f.toBytes();
