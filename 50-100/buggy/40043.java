...
public void testBuySell() throws java.lang.Exception {
    ...
    java.lang.String marketId = "unused";
    org.cld.stock.analyze.AnalyzeBase.validateAllStrategyByStock(pFile, aconf, "nasdaq", marketId, startDate, endDate, sn, null, TradeHour.Normal);
}