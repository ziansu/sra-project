...
public void testBoundedInput() {
    ...
    org.apache.beam.sdk.values.PCollection<java.lang.Long> input = p.apply(org.apache.beam.sdk.io.CountingInput.upTo(numElements));
    org.apache.beam.sdk.io.CountingInputTest.addCountingAsserts(input, numElements);
    p.run();
}