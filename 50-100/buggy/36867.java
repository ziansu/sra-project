public static org.apache.hadoop.hdfs.server.blockmanagement.DatanodeDescriptor getLocalDatanodeDescriptor(boolean initializeStorage) {
    org.apache.hadoop.hdfs.server.blockmanagement.DatanodeDescriptor dn = new org.apache.hadoop.hdfs.server.blockmanagement.DatanodeDescriptor(new io.hops.metadata.StorageMap(), org.apache.hadoop.hdfs.DFSTestUtil.getLocalDatanodeID());
