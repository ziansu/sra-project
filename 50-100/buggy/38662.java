protected void unbindHttpCacheHandlingRule(final com.adobe.acs.commons.httpcache.rule.HttpCacheHandlingRule cacheHandlingRule, final java.util.Map<java.lang.String, java.lang.Object> configs) {
    ...
    if (com.adobe.acs.commons.httpcache.engine.impl.HttpCacheEngineImpl.cacheHandlingRules.contains(servicePid)) {
        com.adobe.acs.commons.httpcache.engine.impl.HttpCacheEngineImpl.cacheHandlingRules.remove(cacheHandlingRule);
