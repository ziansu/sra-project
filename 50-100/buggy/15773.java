private void checkOutput(final org.killbill.billing.invoice.api.Invoice invoice, final java.lang.String template, final java.lang.String expected, final java.util.Locale locale) {
    ...
    data.put("invoice", new org.killbill.billing.invoice.template.formatters.DefaultInvoiceFormatter(config, invoice, locale, null, resourceBundleFactory, internalCallContext, defaultInvoiceFormatterFactory.getCurrencyLocaleMap()));
