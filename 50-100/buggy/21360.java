...
public void resolveTypeHandlerNoAssignable() {
    ...
    expectedException.expectMessage(org.hamcrest.core.Is.is("Type java.lang.Integer is not a valid TypeHandler because it does not implement TypeHandler interface"));
