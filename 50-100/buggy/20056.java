public static edu.illinois.library.cantaloupe.script.ScriptEngine getScriptEngine() throws edu.illinois.library.cantaloupe.script.DelegateScriptDisabledException, java.io.IOException, javax.script.ScriptException {
    if ((edu.illinois.library.cantaloupe.script.ScriptEngineFactory.scriptEngine) == null) {
        synchronized(edu.illinois.library.cantaloupe.script.ScriptEngineFactory.lock) {
