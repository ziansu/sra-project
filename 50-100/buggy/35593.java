public void unwrap(java.io.InputStream is, java.io.OutputStream os, org.ietf.jgss.MessageProp msgProp) throws org.ietf.jgss.GSSException {
    if ((ctxState) != (org.apache.kerby.kerberos.kerb.gss.impl.GssContext.STATE_ESTABLISHED)) {
        throw new org.ietf.jgss.GSSException(org.ietf.jgss.GSSException.NO_CONTEXT, (-1), "Context invalid for unwrap");
    }
