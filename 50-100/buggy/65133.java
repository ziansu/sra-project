private void loadAccountTypesList() {
    ...
    android.widget.ArrayAdapter<java.lang.String> accountTypesAdapter = new android.widget.ArrayAdapter<java.lang.String>(getActivity(), android.R.layout.simple_list_item_1, accountTypes);
