private void loginToSpotifyAccount() {
    ...
    builder.setShowDialog(true).setScopes(new java.lang.String[]{ "user-read-private" , "playlist-read-private" , "playlist-read-collaborative" , "streaming" , "user-library-read" });
