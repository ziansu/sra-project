...
public void test_should_call_onViewReady_with_pops_out_on_home_page_on_back_navigation() throws java.lang.Throwable {
    ...
    waitTest(1200);
    lifeCycleValidator.expect(LifeCycle.onCreateViewNull, LifeCycle.onViewCreatedNull, LifeCycle.onViewReadyFirstTime, LifeCycle.onViewReadyPopOut, LifeCycle.onPoppedOutToFront);
}