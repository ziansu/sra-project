...
public void applyAugmentedRowsEvent(final com.booking.replication.augmenter.AugmentedRowsEvent augmentedRowsEvent, final com.booking.replication.pipeline.PipelineOrchestrator pipeline) {
    ...
    com.booking.replication.applier.HBasePreparedAugmentedRowsEvent hBasePreparedAugmentedRowsEvent = new com.booking.replication.applier.HBasePreparedAugmentedRowsEvent(hbaseNamespace, augmentedRowsEvent);
