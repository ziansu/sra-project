protected void sendEvent(de.dennismaass.emp.stonemaster.stackmaster.controller.comport.command.answer.ComAnswer answer) {
    for (de.dennismaass.emp.stonemaster.stackmaster.controller.comport.command.answer.ComAnswerListener listener : answerListener) {
        ...
        listener.handleAnswer(new de.dennismaass.emp.stonemaster.stackmaster.controller.comport.command.answer.ComAnswerEvent(this, answer, ((calculator.getCountOfDenominator(answer.getValue())) * (de.dennismaass.emp.stonemaster.stackmaster.controller.comport.communicator.ComCommunicator.FACTOR_CM_TO_MM))));
    }
}