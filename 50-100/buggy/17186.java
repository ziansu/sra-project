public void renderGridToFile(com.ggasoftware.indigo.IndigoObject objects, int[] refAtoms, int ncolumns, java.lang.String filename) {
    ...
    com.ggasoftware.indigo.Indigo.checkResult(this, com.ggasoftware.indigo.IndigoRenderer._lib.indigoRenderGridToFile(objects.self, refAtoms, ncolumns, filename));
}