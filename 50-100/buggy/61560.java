...
public r48.map.StuffRenderer rendererFromMap(r48.RubyIO map) {
    ...
    return new r48.map.StuffRenderer(imageLoader, tileRenderer, eventRenderer, r48.map.StuffRenderer.prepareTraditional(tileRenderer, new int[]{ 0 }, eventRenderer, imageLoader, map, "Back", true, true, 0, 0, 0, 0, 1));
}