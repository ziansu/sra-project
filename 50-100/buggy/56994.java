public void annotate(edu.stanford.nlp.pipeline.Annotation annotation) {
    ...
    for (edu.stanford.nlp.util.CoreMap sentence : sentences) {
        java.util.List<edu.stanford.nlp.ling.CoreLabel> tokens = com.articulate.nlp.pipeline.SentenceUtil.getLastSentence(annotation).get(CoreAnnotations.TokensAnnotation.class);
