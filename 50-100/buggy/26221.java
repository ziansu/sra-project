...
public void onNewClusterRead(uk.ac.ebi.pride.spectracluster.clusteringfilereader.objects.ICluster newCluster) {
    ...
    if (clusterFilter.apply(clusterStatistics)) {
        ...
        uk.ac.ebi.pride.spectracluster.statistics.listener.ClusterSourceListener.logger.warn("Cluster {} failed filter: {}", clusterStatistics.getId(), clusterStatistics.getPeptideSequenceWithHighestRatio());
    }
}