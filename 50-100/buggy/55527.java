...
public void instanceAutobindForPhysical8SocketNotEnoughUneven() {
    ...
    assertEquals(null, autobindRules.selectBestPools(consumer, new java.lang.String[]{ productId }, pools, compliance, null, new java.util.HashSet<java.lang.String>(), false));
}