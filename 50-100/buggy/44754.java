...
public void securityTest1() {
    request = makeRequest(1, nc.sumy.edu.webcontainer.sequrity.ServerSecurityTest.IP_VAR1, nc.sumy.edu.webcontainer.sequrity.ServerSecurityTest.NC_COM);
    ...
    request = makeRequest(1, "93.49.37.56", nc.sumy.edu.webcontainer.sequrity.ServerSecurityTest.NC_COM);
