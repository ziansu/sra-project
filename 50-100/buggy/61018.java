...
double latitude, @org.springframework.web.bind.annotation.RequestParam(value = "longitude")
double longitude, @org.springframework.web.bind.annotation.RequestParam(value = "startIndex", required = false)
