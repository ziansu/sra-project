...
minium.developer.config.WebDriversProperties.DeveloperWebDriverProperties webDriverProperties, @org.springframework.web.bind.annotation.RequestParam(value = "withRecorder", defaultValue = "false")
boolean withRecorder) throws java.io.IOException {
    ...
    org.openqa.selenium.WebDriver webDriver = webDriverService.createWebDriver(webDriverProperties, withRecorder);
