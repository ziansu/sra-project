protected void onHandleIntent(android.content.Intent intent) {
    android.util.Log.d(no.hiof.skaalsveen.eskerud.olsen.prototype2.NetworkIntentService.TAG, "NetworkIntentService is workin!");
    ...
    android.util.Log.d(no.hiof.skaalsveen.eskerud.olsen.prototype2.NetworkIntentService.TAG, "NetworkIntentService is done!");
}