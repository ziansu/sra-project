private static assembler.OpCodeNode rootIN() {
    ...
    assembler.InstructionSet.branch = new assembler.OpCodeNode[]{ new assembler.OpCodeNode(Z80.patLIT_A, Z80.BAD_OPCODE) , new assembler.OpCodeNode(Z80.patIND_C, "IN_1") , new assembler.OpCodeNode(Z80.patEXP_ADD, "IN_2") };
