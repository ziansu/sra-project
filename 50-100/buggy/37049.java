public static void addItemToKit(java.lang.String kitName, java.lang.String item) {
    ninja.leaping.configurate.ConfigurationNode valueNode = io.github.hsyyid.kits.config.Configs.getConfig(io.github.hsyyid.kits.utils.ConfigManager.playerConfig).getNode(((java.lang.Object[]) ((("kits." + kitName) + ".item").split("\\."))));
