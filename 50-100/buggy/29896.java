public void testIterLimitOffsetLongStringID() {
    siena.core.async.SienaFuture<java.lang.Iterable<siena.base.test.model.PersonStringID>> future = pm.createQuery(siena.base.test.model.PersonStringID.class).order("n").iter(2, 1);
    java.lang.Iterable<siena.base.test.model.PersonStringID> people = future.get();
