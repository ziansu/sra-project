private void goPlayAgain(float touchX, float touchY) {
    com.simpsonstrial2.views.CircularTransition transition = new com.simpsonstrial2.views.CircularTransition(this, findViewById(R.id.RootLayout), true, touchX, touchY);
