...
public com.google.android.gms.cast.framework.CastOptions getCastOptions(android.content.Context context) {
    com.google.android.gms.cast.framework.media.NotificationOptions notificationOptions = new com.google.android.gms.cast.framework.media.NotificationOptions.Builder().setActions(java.util.Arrays.asList(MediaIntentReceiver.ACTION_TOGGLE_PLAYBACK, MediaIntentReceiver.ACTION_STOP_CASTING), new int[]{ 1 , 2 }).build();
