@org.springframework.web.bind.annotation.RequestMapping(value = "/properties/proxy/add", method = org.springframework.web.bind.annotation.RequestMethod.POST)
public java.lang.String addProxyServers(@org.springframework.validation.annotation.Validated
vms.models.ProxyServer proxyServer, org.springframework.validation.BindingResult bindingResult, @org.springframework.web.bind.annotation.RequestParam(value = "login")
...
java.lang.Long port) {
    ...
    vms.models.ProxyServer server = new vms.models.ProxyServer(login, password, token, ip, port);
    try {
