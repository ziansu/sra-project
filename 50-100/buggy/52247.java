protected org.jboss.netty.handler.execution.OrderedMemoryAwareThreadPoolExecutor createExecutorService() {
    ...
    return new org.jboss.netty.handler.execution.OrderedMemoryAwareThreadPoolExecutor(configuration.getMaximumPoolSize(), 0L, 0L, 30, java.util.concurrent.TimeUnit.SECONDS, factory);
}