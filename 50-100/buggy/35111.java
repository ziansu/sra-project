private boolean verifyRSAToken(java.lang.String token, java.lang.String algorithmCode, java.lang.String[] pemKeys) {
    for (java.lang.String pemKey : pemKeys) {
        try {
            com.auth0.jwt.algorithms.Algorithm algorithm = pl.surreal.finance.transaction.auth.SignAlgorithm.getAlgorithm(algorithmCode, pemKeys).orElseThrow(() -> new java.lang.Exception("can't obtain algorithm"));
