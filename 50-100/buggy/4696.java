protected void startWaiting(java.lang.String message, boolean canStop) {
    ...
    org.gridchem.client.gui.filebrowser.FileBrowserImpl.topURIPanel.setEnabled(false);
    if (canStop) {
        org.gridchem.client.gui.filebrowser.FileBrowserImpl.stopButton.setEnabled(true);
    }
}