public uk.ac.stfc.isis.ibex.configserver.configuration.Configuration asConfiguration() {
    ...
    return new uk.ac.stfc.isis.ibex.configserver.internal.IocFilteredConfiguration(new uk.ac.stfc.isis.ibex.configserver.internal.ComponentFilteredConfiguration(config));
}