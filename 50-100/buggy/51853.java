...
public void getAllBySessionId() throws java.lang.Exception {
    ...
    mockMvc.perform(get("/customer/getAllBySessionId?id=2").accept(MediaType.APPLICATION_JSON)).andDo(org.springframework.test.web.servlet.result.MockMvcResultHandlers.print()).andExpect(status().isFound());
}