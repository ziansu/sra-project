private void sendRequest(final io.crate.executor.transport.distributed.DistributedResultRequest request) {
    ...
    try {
        transportDistributedResultAction.pushResult(node, request, new io.crate.executor.transport.distributed.DistributingDownstream.DistributedResultResponseActionListener(this));
