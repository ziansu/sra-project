...
java.lang.String flavorId) {
    ...
    return alien4cloud.rest.model.RestResponseBuilder.<alien4cloud.rest.cloud.CloudComputeResourcesDTO>builder().data(new alien4cloud.rest.cloud.CloudComputeResourcesDTO(cloud.getComputeTemplates(), cloud.getImageMapping(), cloud.getFlavorMapping())).build();
}