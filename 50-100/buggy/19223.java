public void writeWeakWrapperTo(javax.annotation.processing.Filer filer) throws java.io.IOException {
    com.stefandekanski.weakwrap.processor.MethodSpec constructor = createConstructor(originalClassName);
    com.stefandekanski.weakwrap.processor.FieldSpec weakWrapField = createWeakWrapField(originalClassName);
    java.util.List<com.stefandekanski.weakwrap.processor.MethodSpec> wrappedMethods = createWrappedMethods(typeElement);
