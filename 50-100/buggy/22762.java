private void startTouchAnimation(int animationDelay, final long touchTime, long secondTouchOffset) {
    long startOffset = (animationDelay > 0) ? animationDelay * (org.literacyapp.handgesture.Constants.MILLISECONDS) : org.literacyapp.handgesture.Constants.DEFAULT_ANIMATION_DELAY;
