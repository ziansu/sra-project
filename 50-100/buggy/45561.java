...
public void onBackPressed() {
    ...
    if ((mode) == (org.wycliffeassociates.translationrecorder.Playback.PlaybackActivity.MODE.VERSE_MARKER)) {
        ...
        if (actionsToSave()) {
            ...
            org.wycliffeassociates.translationrecorder.FilesPage.ExitDialog exit = org.wycliffeassociates.translationrecorder.FilesPage.ExitDialog.Build(this, R.style.Theme_AppCompat_Light_Dialog, true, isPlaying, mWavFile.getFile());
            exit.show();
        }else {
            super.onBackPressed();
        }
