...
java.lang.String templateId) {
    try {
        java.lang.String decode = new java.lang.String(templateId.getBytes("ISO-8859-1"), "utf-8");
    ...
    org.activiti.engine.repository.ProcessDefinition pd = core.getTemplateService().getProcessTemplate(templateId);
    if (pd == null) {
