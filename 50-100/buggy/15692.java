public static void main(java.lang.String[] args) throws java.io.IOException, java.text.ParseException {
    ...
    Classifier.supervised.ALogisticRegression alr = new Classifier.supervised.ALogisticRegression(mains.CRFMain.numClass, mains.CRFMain.numFeature, 1.0, mains.CRFMain.featureTable, mains.CRFMain.label);
