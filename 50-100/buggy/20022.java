public java.lang.String deleteUser(ro.msg.edu.business.user.dto.UserDTO user) {
    try {
        ...
        java.lang.String notificationMessage = getNotificationMessageDeactivateUser(userDeactivated);
        notificationFacade.createNotification(NotificationType.USER_DEACTIVATED, notificationMessage, ro.msg.edu.client.beans.UserBean.DELETE_USER_URL, new ro.msg.edu.business.bug.dto.BugDTO(), userFacade.findAllAdministrators());
