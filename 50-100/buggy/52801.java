...
public org.eclipse.jface.resource.ImageDescriptor getImageDescriptor(mesfavoris.url.internal.Context context, mesfavoris.model.Bookmark bookmark) {
    java.lang.String iconAsBase64 = bookmark.getPropertyValue(mesfavoris.url.UrlBookmarkProperties.PROP_FAVICON);
    if (iconAsBase64 == null) {
        iconAsBase64 = bookmark.getPropertyValue(mesfavoris.url.UrlBookmarkProperties.PROP_ICON);
    }
    if (iconAsBase64 == null) {
