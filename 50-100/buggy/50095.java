public static org.liveSense.core.session.SessionFactory getInstance(long defaultSessionTimeout, long sessionTimeoutCheckInterval, long sessionCloseTimeout, long factoryCloseTimeout) {
    if ((org.liveSense.core.session.SessionFactoryImpl.factory) == null) {
        org.liveSense.core.session.SessionFactoryImpl.log.info("Creating liveSense Session Factory. \n   Default session timeout: {}\n   Session timeout check interval: {}\n   Session close timeout: {}\n    Factory close timeout: {} ", new java.lang.Object[]{ defaultSessionTimeout , sessionTimeoutCheckInterval , sessionCloseTimeout , factoryCloseTimeout });
        ...
        org.liveSense.core.session.SessionFactoryImpl.factory.factoryCloseTimeout = factoryCloseTimeout;
