...
long movieId, @org.springframework.web.bind.annotation.RequestParam(value = "movietitle")
java.lang.String movietitle, @org.springframework.web.bind.annotation.RequestParam(value = "name")
java.lang.String name, @org.springframework.web.bind.annotation.RequestParam(value = "rating")
...
java.lang.String occupation) {
    ...
    io.braxton.moviereviewer.models.Review newReview = new io.braxton.moviereviewer.models.Review(movietitle, name, rating, age, gender, occupation, movie);
