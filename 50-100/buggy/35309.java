...
public void ratingDialogIsShown() {
    ...
    android.support.test.espresso.Espresso.onView(withid(R.id.rating_how_many)).check(android.support.test.espresso.assertion.ViewAssertions.matches(android.support.test.espresso.matcher.ViewMatchers.isDisplayed()));
}