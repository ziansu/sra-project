...
public ai.labs.persistence.mongo.IHistoryResource<T> readHistory(java.lang.String id, java.lang.Integer version) {
    ...
    org.bson.Document query = new org.bson.Document(ai.labs.persistence.mongo.MongoResourceStorage.ID_FIELD, objectId);
    org.bson.Document doc = historyCollection.find(com.mongodb.client.model.Filters.eq(query)).first();
    if (doc == null) {
        return null;
    }
