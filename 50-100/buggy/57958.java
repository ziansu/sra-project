...
public void fmlLifeCycleEvent(net.minecraftforge.fml.common.event.FMLInitializationEvent event) {
    ...
    net.minecraftforge.fml.common.registry.GameRegistry.addRecipe(new net.minecraft.item.ItemStack(srh), new java.lang.Object[]{ "   " , " A " , "   " , 'A' , net.minecraft.init.Blocks.dirt });
}