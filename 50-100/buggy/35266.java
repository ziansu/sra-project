public static com.stratio.crossdata.common.logicalplan.Filter createFilter(java.lang.String catalogName, java.lang.String tableName, java.lang.String columnName, com.stratio.crossdata.common.statements.structures.Operator operator, java.lang.Long data, boolean indexed) {
    ...
    com.stratio.crossdata.common.statements.structures.IntegerSelector rightSelector = new com.stratio.crossdata.common.statements.structures.IntegerSelector(data.toString());
