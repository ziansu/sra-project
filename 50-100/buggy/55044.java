public boolean startProxy() {
    if ((proxy) == null) {
        try {
            ...
            proxy = new com.smartdevicelink.proxy.SdlProxyALM(this, com.jacobarau.streamplayer.sdl.SdlProxyHost.APP_NAME, true, com.jacobarau.streamplayer.sdl.SdlProxyHost.APP_ID, xprt);
            return true;
