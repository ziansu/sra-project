...
final java.lang.String serviceName) {
    if (serviceName == null) {
        registry.add(new ratpack.zipkin.internal.RatpackServerClientLocalSpanState.ClientEndpointValue(registry.get(ratpack.zipkin.internal.RatpackServerClientLocalSpanState.ServerEndpointValue.class).get()));
    }else {
        ...
        registry.add(new ratpack.zipkin.internal.RatpackServerClientLocalSpanState.ClientEndpointValue(endpoint));
    }
}