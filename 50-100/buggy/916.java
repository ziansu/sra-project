private Item randomItemSelector(boolean pop) {
    ...
    int randomIdx = edu.princeton.cs.algs4.StdRandom.uniform(0, numElementsWithNulls);
    while ((stackArray[randomIdx]) == null)
        randomIdx = edu.princeton.cs.algs4.StdRandom.uniform(0, numElementsWithNulls);
