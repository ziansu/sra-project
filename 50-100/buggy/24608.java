...
private void sendEmailNotification(java.lang.String email, java.lang.String link) {
    ...
    new org.fenixedu.academic.domain.util.email.Message(systemSender, systemSender.getConcreteReplyTos(), java.util.Collections.EMPTY_LIST, org.fenixedu.bennu.RegistrationProcessConfiguration.getConfiguration().storeEmailSubject(), body, email);
}