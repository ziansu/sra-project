...
public void errorInputInfoTest2() {
    ...
    org.junit.Assert.assertEquals(dataMap.containsKey(nc.sumy.edu.webcontainer.deployment.WebXMLAnalyzerTest.SERVLET1), false);
    org.junit.Assert.assertEquals(dataMap.containsKey(nc.sumy.edu.webcontainer.deployment.WebXMLAnalyzerTest.SERVLET2), false);
}