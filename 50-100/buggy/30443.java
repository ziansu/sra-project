@org.testng.annotations.Test(groups = { "AdsVuapResolvedState" }, dataProviderClass = com.wikia.webdriver.common.dataprovider.ads.AdsDataProvider.class, dataProvider = "adsVuapDesktop")
public void vuapResolvedShouldEnd(com.wikia.webdriver.common.core.url.Page page, java.lang.String slot) {
    com.wikia.webdriver.pageobjectsfactory.pageobject.adsbase.AdsBaseObject ads = openPageWithVideoInLocalStorage(page);
