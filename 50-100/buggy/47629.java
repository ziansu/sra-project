...
public java.lang.Object getAdapter(java.lang.Object adaptableObject, java.lang.Class adapterType) {
    if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
        ...
        org.eclipse.core.resources.IResource resource = ((org.eclipse.core.resources.IResource) (editor.getEditorInput().getAdapter(org.eclipse.core.resources.IResource.class)));
        if (resource != null) {
