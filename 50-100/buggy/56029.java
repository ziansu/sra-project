...
public void testUnexpectedChar() throws java.lang.Exception {
    ...
    final java.lang.String[] expected = new java.lang.String[]{ "7:9: " + (getCheckMessage(com.puppycrawl.tools.checkstyle.checks.naming.MemberNameCheck.class, com.puppycrawl.tools.checkstyle.checks.naming.AbstractNameCheck.MSG_INVALID_PATTERN, (("" + ((char) (195))) + ((char) (1071))), "^[a-z][a-zA-Z0-9]*$")) };
