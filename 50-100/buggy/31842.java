public java.util.HashMap<java.lang.String, java.lang.String> getUserDetails() {
    ...
    user.put(edu.scu.levelup.UserSessionManager.key_role, pref.getString(edu.scu.levelup.UserSessionManager.key_role, null));
    user.put(edu.scu.levelup.UserSessionManager.key_userID, pref.getString(edu.scu.levelup.UserSessionManager.key_userID, null));
    return user;
}