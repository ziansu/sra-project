...
public void whenCheckingHealthForMultipleModules_thenReturnListOfFitnessValues() {
    ...
    java.util.List<org.corpus_tools.pepper.common.ModuleFitness> fitnesses = new org.corpus_tools.pepper.core.ModuleFitnessChecker(null).checkHealth(java.util.Arrays.asList(healthyModule, criticalModule));
