...
public void modify(edu.unl.csce361.group4.cookbook.Ingredient ingredient) {
    ...
    dataSource.update(sql, new java.lang.Object[]{ ingredient.getIngredientName() , ingredient.getMeasuringUnits() , ingredient.getRetailPrice() , ingredient.getServingSize() , ingredient.getContainerAmount() , ingredient.getIngredientId() });
}