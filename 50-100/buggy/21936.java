...
org.auraframework.util.json.JsonSerializable data) {
    ...
    final org.auraframework.throwable.ClientSideError customError = new org.auraframework.throwable.ClientSideError(message, org.auraframework.throwable.AuraExceptionUtil.getStackTrace(thrown), data, errorId);
