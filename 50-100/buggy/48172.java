...
java.util.UUID projectId, de.btu.openinfra.backend.db.pojos.ProjectPojo project) {
    java.util.UUID uuid = new de.btu.openinfra.backend.db.rbac.ProjectRbac(projectId, de.btu.openinfra.backend.db.OpenInfraSchemas.PROJECTS).createOrUpdate(de.btu.openinfra.backend.db.rbac.OpenInfraHttpMethod.valueOf(request.getMethod()), uriInfo, null, project);
