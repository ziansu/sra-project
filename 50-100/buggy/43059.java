...
public void lookupITISSynonymSuccess() throws org.eol.globi.service.PropertyEnricherException {
    ...
    org.junit.Assert.assertThat(enrich.get(PropertyAndValueDictionary.EXTERNAL_ID), org.hamcrest.Matchers.is("ITIS:680665"));
    org.junit.Assert.assertThat(enrich.get(PropertyAndValueDictionary.NAME), org.hamcrest.Matchers.is("Ariopsis felis"));
}