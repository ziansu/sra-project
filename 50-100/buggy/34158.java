public int updateNameOfPgpContact(android.content.Context context, java.lang.String email, java.lang.String name) {
    ...
    if (contentResolver != null) {
        ...
        return contentResolver.update(getBaseContentUri(), contentValues, ((com.flowcrypt.email.database.dao.source.ContactsDaoSource.COL_EMAIL) + " = ?"), new java.lang.String[]{ email });
    }else
        return -1;
