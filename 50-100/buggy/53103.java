public Model.GameObject.Item.Items.Takables.Quest addQuest(java.lang.String name, java.lang.String description, int x, int y, int level, Model.GameObject.Item.Items.Takables.Quest requiredItem, Model.StatStruc modify) {
    id = ItemEnum.QUEST;
