...
public void overrideClassWideAttributeOnMethodWhenAttributesAreSame() throws java.lang.Throwable {
    ...
    com.orhanobut.tracklytics.AssertTracker.assertTrack(tracker).event("event").noTags().attribute("key", "method").attribute("key1", "method1").noSuperAttributes().noFilters();
}