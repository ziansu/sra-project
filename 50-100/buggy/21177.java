...
public bizartxo.udacity.nanodegree.androiddeveloper.popularmoviesapp.MovieAdapter.MovieViewHolder onCreateViewHolder(android.view.ViewGroup parent, int viewType) {
    ...
    bizartxo.udacity.nanodegree.androiddeveloper.popularmoviesapp.MovieAdapter.MovieViewHolder movieViewHolder = new bizartxo.udacity.nanodegree.androiddeveloper.popularmoviesapp.MovieAdapter.MovieViewHolder(view, mMovieDataList.get(viewType));
