private static NotificationCompat.Action ignoreReminder(android.content.Context context) {
    ...
    android.support.v4.app.NotificationCompat.Action ignoreReminder = new android.support.v4.app.NotificationCompat.Action(R.drawable.ic_plus, context.getString(R.string.ignore_reminder), ignoreReminderPendingIntent);
