public edu.jalc.automobile.onlinebuilder.builders.dodgeram.ram1500.builders.TruckDodgeRamBuilderInterface askForTruckDrive() {
    ...
    try {
        int truckDriveChoice = truckDrivePrompter.addType("Drive").addOption(new edu.jalc.automobile.onlinebuilder.builders.dodgeram.ram1500.builders.FourByTwoTruckDrive()).addOption(new edu.jalc.automobile.onlinebuilder.builders.dodgeram.ram1500.builders.FourByFourTruckDrive()).sort().build().ask();
