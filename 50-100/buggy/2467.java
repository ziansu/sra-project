...
public void testRegionIsFoundWithPolyphenGreaterThan() {
    ...
    regions.add(region);
    java.util.List<uk.ac.ebi.eva.lib.utils.RepositoryFilter> filters = uk.ac.ebi.eva.lib.utils.RepositoryFilterUtils.getRepositoryFilters(null, ">0.5", null, null, null);
