private java.awt.Point getClosestPoint(java.awt.Point source, java.util.List<java.awt.geom.Point2D> pool) {
    ...
    for (java.awt.geom.Point2D possibleClosestPoint : pool) {
        if (closestPoint == null) {
            ...
            closestPoint = normalizePoint(games.strategy.triplea.ui.RouteOptimizer.getPoint(possibleClosestPoint));
        }else {
