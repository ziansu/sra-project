...
public void test3CreateViewFolder() {
    ...
    org.junit.Assert.assertTrue(((org.openflexo.foundation.view.File) (org.openflexo.foundation.view.TestBasicOntologyEditorView.viewFolder.getSerializationArtefact())).exists());
}