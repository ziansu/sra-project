private static ConceptGraph.Input.Scraper getScraper(ConceptGraph.Output.FileOutputAssistant fileOutput, ConceptGraph.Output.Logging.Logger logger) throws java.io.FileNotFoundException {
    ConceptGraph.Processor processor = new ConceptGraph.Processor(fileOutput);
