public void showWarning(java.lang.String message, final hu.agabor.framework.BPresenter.DialogListener listener) {
    ...
    dialogBuilder.setTitle(android.R.string.dialog_alert_title).setMessage(message).setCancelable(true).setPositiveButton(android.R.string.ok, new android.content.DialogInterface.OnClickListener() {
        @java.lang.Override
