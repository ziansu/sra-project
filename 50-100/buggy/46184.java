public com.thrashplay.jounce.entity.GameObject createTopWall() {
    ...
    topWall.addComponent(new com.thrashplay.jounce.entity.Collider(CollisionCategory.TOP_WALL, new com.thrashplay.luna.api.geom.Rectangle(0, 0, gameBounds.getWidth(), 5)));
    return topWall;
}