...
public void createJobWithNegativePerson() throws User.AuthFailure, xyz.swordfeng.jobsystem.ValidationError {
    ...
    xyz.swordfeng.jobsystem.Job job = new xyz.swordfeng.jobsystem.Job(user, name, address, (-1), skills, education);
    org.junit.Assert.fail("should throw ValidationError exception");
}