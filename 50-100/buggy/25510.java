public void addHomeScreenFragment() {
    ...
    homeSc.setEnterTransition(new android.transition.Slide(android.view.Gravity.RIGHT));
    homeSc.setExitTransition(new android.transition.Slide(android.view.Gravity.LEFT));
