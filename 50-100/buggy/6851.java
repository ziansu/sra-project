...
public void initialize(java.net.URL url, java.util.ResourceBundle rb) {
    ...
    TournamentColumn.setCellFactory(new javafx.scene.control.cell.PropertyValueFactory<>("name"));
    DateColumn.setCellFactory(new javafx.scene.control.cell.PropertyValueFactory<>("date"));
    UpdateView();
}