public org.apache.calcite.rel.RelNode convert(org.apache.calcite.rel.RelNode rel) {
    ...
    return new org.apache.phoenix.calcite.PhoenixProject(project.getCluster(), traitSet, convert(project.getInput(), traitSet), project.getProjects(), project.getRowType());
}