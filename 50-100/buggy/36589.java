...
org.openlmis.distribution.domain.Distribution distribution, javax.servlet.http.HttpServletRequest request) {
    org.openlmis.web.response.OpenLmisResponse openLmisResponse = new org.openlmis.web.response.OpenLmisResponse("distribution", distributionService.getDistribution(distribution, loggedInUserId(request), new org.openlmis.distribution.domain.DistributionDataFilter(true)));
