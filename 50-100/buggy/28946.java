...
java.lang.String password) throws com.github.kubernetes.java.client.exceptions.KubernetesClientException, java.net.URISyntaxException {
    ...
    com.github.kubernetes.java.client.interfaces.KubernetesAPIClientInterface client = new com.github.kubernetes.java.client.v2.KubernetesApiClient(((serverUrl.toString()) + "/api/v1beta1/"), username, password, factory);
    client.getAllPods();
