public java.util.Set<org.ggp.base.util.propnet.architecture.components.Proposition> propNext(org.ggp.base.util.statemachine.Move move, org.ggp.base.util.statemachine.MachineState state) {
    markActions(state);
    markBases(state);
    java.util.Map<org.ggp.base.util.gdl.grammar.GdlSentence, org.ggp.base.util.propnet.architecture.components.Proposition> bases = propNet.getBasePropositions();
