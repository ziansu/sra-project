...
public java.lang.String getBooks(org.springframework.ui.Model model) {
    ...
    java.lang.System.out.println(("All books collection is -- " + (bookservice.getAll().size())));
    java.lang.System.out.println(("Available  books -- " + (bookservice.availableBooks().size())));
    return "books";
}