...
java.lang.String limit, @uk.ac.ebi.quickgo.ontology.controller.RequestParam(value = "similarityThreshold", required = false)
java.lang.Float similarityThreshold) {
    com.google.common.base.Preconditions.checkArgument((similarityThreshold != null), "The value for similarityThreshold should not be empty");
