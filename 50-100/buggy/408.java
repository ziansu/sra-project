...
public void findById_TodoEntryNotFound_ShouldThrowException() {
    when(repositoryMock.findById(ru.doccloud.docs.service.RepositoryDocsCrudServiceTest.ID)).thenThrow(new ru.doccloud.common.exception.DocumentNotFoundException("", found));
