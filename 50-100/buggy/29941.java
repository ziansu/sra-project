private void deleteProxyEntry(java.lang.String instanceId) {
    java.io.File sitesenabled = new java.io.File((("/etc/apache2/sites-enabled/005-" + (instanceId_)) + ".conf"));
    sitesenabled.delete();
    java.io.File sitesavailable = new java.io.File((("/etc/apache2/sites-available/005-" + (instanceId_)) + ".conf"));
