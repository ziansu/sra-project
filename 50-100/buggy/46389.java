public static void main(final java.lang.String[] args) {
    ...
    if (org.yawlfoundation.yawl.editor.core.util.FileUtil.isWindows()) {
        if (!(org.yawlfoundation.yawl.editor.ui.util.UserSettings.getPostUpdatesCompleted())) {
            if (new org.yawlfoundation.yawl.editor.ui.update.PostUpdateTasks().go()) {
