private java.lang.String getDataSetURLSuffix(org.runnerup.export.format.GoogleFitData.DataSourceType source, long startTime, long endTime) {
    ...
    urlSuffix.append(GoogleFitUploader.REST_DATASOURCE).append("/").append(org.runnerup.export.FormCrawler.URLEncode(source.getDataStreamId())).append("/").append(GoogleFitUploader.REST_DATASETS).append("/").append(startTime).append("-").append(endTime);
