public java.util.List<java.util.List<java.lang.Integer>> move(java.util.List<java.util.List<java.lang.Integer>> firstPlayerPositions, java.util.List<java.util.List<java.lang.Integer>> secondPlayerPositions) throws com.blackship.battlesheep.game.state.exceptions.WrongStateException {
    ...
    com.blackship.battlesheep.game.Game.log.info(java.lang.String.format("Positions to shoot from the first player: %s", firstPlayerPositions));
    com.blackship.battlesheep.game.Game.log.info(java.lang.String.format("Positions to shoot from the second player: %s", secondPlayerPositions));
    com.blackship.battlesheep.game.Game.log.info(java.lang.String.format("Positions shot: %s", shotPositions));
