static org.apache.parquet.schema.MessageType fromParquetSchema(java.util.List<org.apache.parquet.format.SchemaElement> schema) {
    ...
    org.apache.parquet.format.converter.ParquetMetadataConverter.buildChildren(builder, iterator, root.getNum_children());
