public static at.ezylot.IncrementalBallGame.MovableCircle createMovableCircle(double x, double y, double radius) {
    ...
    return new at.ezylot.IncrementalBallGame.MovableCircle(x, y, radius, javafx.scene.paint.Paint.valueOf(color), new java.util.Random().nextInt(359), Main.RootStage.getScene());
}