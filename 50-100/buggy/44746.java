...
public org.micromanager.display.DisplaySettings copySettings(org.micromanager.display.DataViewer sourceDisplay, org.micromanager.display.DisplaySettings source, org.micromanager.display.DisplaySettings dest) {
    ...
    org.micromanager.display.DisplaySettings.ContrastSettings oldSettings = source.getSafeContrastSettings(channelIndex_, org.micromanager.display.internal.DefaultDisplayManager.getInstance().getContrastSettings(0, 0, 1.0, null));
    org.micromanager.display.DisplaySettings.ContrastSettings newSettings = dest.getSafeContrastSettings(sourceIndex, null);
