...
public void testGetEvaluatorDeprecated() throws org.apache.hadoop.hive.ql.parse.SemanticException {
    ...
    org.apache.hadoop.hive.ql.udf.generic.GenericUDAFEvaluator eval = udf.getEvaluator(new org.apache.hadoop.hive.serde2.typeinfo.TypeInfo[]{ com.yahoo.sketches.hive.theta.MergeSketchUDAFTest.binaryType , com.yahoo.sketches.hive.theta.MergeSketchUDAFTest.intType });
