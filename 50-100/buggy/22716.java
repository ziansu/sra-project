...
public void onMessageEvent(com.sndp.kunnathunadu.uniondatabank.greenrobot.events.ShowSakhaDetailsEvents event) {
    ...
    manager.beginTransaction().replace(R.id.content_main, fragment, com.sndp.kunnathunadu.uniondatabank.activites.MainActivity.SAKHA_DETAILS_FRAGMENT).addToBackStack(com.sndp.kunnathunadu.uniondatabank.activites.MainActivity.SAKHA_DETAILS_FRAGMENT).commit();
}