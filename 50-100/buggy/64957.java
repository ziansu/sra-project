...
public void addOOVRules(int sourceWord, java.util.List<org.apache.joshua.decoder.ff.FeatureFunction> featureFunctions) {
    ...
    org.apache.joshua.decoder.ff.tm.Rule oovRule = new org.apache.joshua.decoder.ff.tm.Rule(nt_i, new int[]{ nt_i , sourceWord }, new int[]{ -1 , targetWord }, "", 1, org.apache.joshua.decoder.ff.tm.OwnerMap.UNKNOWN_OWNER);
    addRule(oovRule);
