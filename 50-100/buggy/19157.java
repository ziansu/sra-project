private java.util.List<org.onebusaway.transit_data.model.StopBean> getStopsForBounds(org.onebusaway.geospatial.model.CoordinateBounds bounds, long currentTime) {
    if (bounds != null) {
