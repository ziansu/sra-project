...
public info.smartkit.hairy_batman.domain.WxSimpleSubscriber process(final info.smartkit.hairy_batman.domain.WxSimpleSubscriber wxFoo) throws java.lang.Exception {
    ...
    new info.smartkit.hairy_batman.query.SogouSearchQuery(new info.smartkit.hairy_batman.domain.WxComplexSubscriber(wxFoo.getId(), wxFoo.getCode(), wxFoo.getStore(), null, null, null, null, wxFoo.getSubscribeId(), null, null)).parseWxOpenId();
    return wxFoo;
}