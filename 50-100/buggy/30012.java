protected org.payn.chsm.io.reporters.ReporterFactoryXML<?> getReporterFactory(org.payn.chsm.io.xmltools.ElementReporter outputElem) throws java.lang.Exception {
    ...
    if (!(classPath.equals(""))) {
        return ((org.payn.chsm.io.reporters.ReporterFactoryXML<?>) (createObjectInstance(getClass().getClassLoader(), outputElem.getFile(pathRoot), classPath, java.lang.String.format("Reporter factory %s", classPath))));
    }else {
        return null;
    }
}