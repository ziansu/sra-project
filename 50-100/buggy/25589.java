private java.lang.String buildClientVariantUrl(java.lang.String context, org.opencms.gwt.shared.CmsClientVariantInfo info) {
    ...
    java.lang.String targetUrl = ((((((currentUrl + connector) + (org.opencms.gwt.shared.CmsGwtConstants.PARAM_DISABLE_DIRECT_EDIT)) + "=true") + "&") + (org.opencms.gwt.shared.CmsGwtConstants.PARAM_TEMPLATE_CONTEXT)) + "=") + context;
    return targetUrl;
}