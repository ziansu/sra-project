...
public void testGetAuthenticatedUser(java.lang.String fullQualifiedName, java.lang.String username) throws java.lang.Exception {
    ...
    assertEquals(org.wso2.carbon.identity.oauth.OAuthUtil.getAuthenticatedUser(fullQualifiedName).getUserName(), username, ("Should set the " + "cleared username from fullyQualifiedName."));
}