...
int id) {
    ...
    project3.objectcontainer.PostContainer pos = new project3.objectcontainer.PostContainer(post.getAuthor().getUsername(), post.getTitle(), post.getContent(), post.getId());
