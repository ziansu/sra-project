public void init() {
    ...
    track = new android.media.AudioTrack(android.media.AudioManager.STREAM_VOICE_CALL, 16000, android.media.AudioFormat.CHANNEL_OUT_MONO, android.media.AudioFormat.ENCODING_PCM_16BIT, (maxJitter * 50), android.media.AudioTrack.MODE_STREAM);
    lin = new byte[1024];
    num = 0;
