...
public org.springframework.cache.ehcache.EhCacheManagerFactoryBean cacheManager() {
    ...
    bean.setConfigLocation(org.apereo.cas.util.ResourceUtils.prepareClasspathResourceIfNeeded(casProperties.getTicket().getRegistry().getEhcache().getConfigLocation()));
