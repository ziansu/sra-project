public com.hea3ven.tools.asmtweaks.editors.MethodEditor fieldInsn(int opcode, java.lang.String owner, java.lang.String name, java.lang.String desc) {
    ...
    mode.apply(new com.hea3ven.tools.asmtweaks.editors.FieldInsnNode(opcode, getClass(owner).getPath(((obfuscation) != (ObfuscationMode.SRG) ? getActualObfuscation() : true)), fld.getName(getActualObfuscation()), getDesc(desc)));
    return this;
}