public static void main(java.lang.String[] args) throws com.dreamproduction.lsa.WrongDimensionException {
    com.dreamproduction.lsa.LSA lsa = new com.dreamproduction.lsa.LSA(new com.dreamproduction.lsa.TxtReader().loadFile(new java.io.File("src/main/resources/test-docs.txt")), 2);
