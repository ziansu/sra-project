com.fourspaces.couchdb.CouchResponse put(java.lang.String url, java.lang.String content) {
    ...
    if (content != null) {
        ...
        try {
            ...
            put.setHeader(new org.apache.http.message.BasicHeader("Content-Type", com.fourspaces.couchdb.Session.MIME_TYPE_JSON));
