public int updateUser(io.github.data4all.model.data.User user) {
    ...
    int count = db.update(io.github.data4all.model.DataBaseHandler.TABLE_USER, values, ((io.github.data4all.model.DataBaseHandler.KEY_USERNAME) + "=?"), new java.lang.String[]{ user.getUsername() });
    return count;
}