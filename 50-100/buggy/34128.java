...
public void start() {
    super.start();
    if ((scheduledItems) > 0) {
        org.apache.logging.log4j.core.config.LOGGER.debug("{} starting {} threads", scheduledItems, org.apache.logging.log4j.core.config.ConfigurationScheduler.SIMPLE_NAME);
