public static com.example.anna.shedule.application.schedule.model.helper.WeekPeriodicity getPeriodicity(long timeInMillis) {
    ...
    return (currentWeek % 2) == 0 ? com.example.anna.shedule.application.schedule.model.helper.WeekPeriodicity.BLUE : com.example.anna.shedule.application.schedule.model.helper.WeekPeriodicity.RED;
}