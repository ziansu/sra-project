...
private void initialize() {
    ...
    javafx.scene.layout.BackgroundSize size = new javafx.scene.layout.BackgroundSize(javafx.scene.layout.BackgroundSize.AUTO, javafx.scene.layout.BackgroundSize.AUTO, false, false, true, true);
