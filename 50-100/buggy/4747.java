...
public void loadModel(net.devintia.commons.bukkit.command.CommandArguments args) {
    ...
    net.devintia.commons.bukkit.armorstand.ArmorStandModel model = net.devintia.commons.bukkit.armorstand.ArmorStandModelImporter.importModel(args.getArg(0), file);
