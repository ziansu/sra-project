...
public void fetchChunk(long streamId, int chunkIndex, org.apache.spark.network.client.ChunkReceivedCallback callback) {
    ...
    context.write(new org.apache.spark.network.rdma.RdmaMessage(new org.apache.spark.network.protocol.ChunkFetchRequest(streamChunkId), ((long) (streamChunkId.hashCode()))), callback);
}