...
public graphql.schema.GraphQLInputType getInputType(com.bretpatterson.schemagen.graphql.IGraphQLObjectMapper graphQLObjectMapper, java.lang.reflect.Type type) {
    if (type instanceof java.lang.reflect.ParameterizedType) {
        ...
        return new graphql.schema.GraphQLList(graphQLObjectMapper.getOutputType(parameterizedType.getActualTypeArguments()[0]));
    }else {
        return new graphql.schema.GraphQLList(graphQLObjectMapper.getOutputType(java.lang.Object.class));
    }
}