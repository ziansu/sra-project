public java.lang.String getSensorLocation() {
    ...
    if ((mRSCSensorLocation) < (com.example.android.bluetoothlegatt.pack.BluetoothRscp.sLocations.length)) {
        return com.example.android.bluetoothlegatt.pack.BluetoothRscp.sLocations[mRSCSensorLocation];
    }
    return null;
}