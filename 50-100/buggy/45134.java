public static boolean toLoadImage(android.content.Context context) {
    boolean updateNonWIFI = android.preference.PreferenceManager.getDefaultSharedPreferences(context).getBoolean(context.getString(R.string.key_load_image_preference), true);
