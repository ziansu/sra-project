...
public void getValueTest() throws java.lang.Exception {
    ...
    java.math.BigDecimal expected = model.taxes.ImportedGoodTaxTest.DUMMY_PRICE.multiply(importedGoodTax.getPercentage()).divide(new java.math.BigDecimal(100), java.math.BigDecimal.ROUND_UNNECESSARY);
