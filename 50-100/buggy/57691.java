private static javax.jcr.Repository createRepository(org.apache.jackrabbit.oak.plugins.document.util.MongoConnection connection) {
    org.apache.jackrabbit.oak.plugins.document.DocumentNodeStore store = new org.apache.jackrabbit.oak.plugins.document.DocumentMK.Builder().setClusterId(1).memoryCacheSize(((64 * 1024) * 1024)).setPersistentCache("target/persistentCache,time").setMongoDB(connection.getDB()).getNodeStore();
