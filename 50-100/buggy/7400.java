@java.lang.Override
public java.util.List<uk.co.olimor.BMBTApi_boot.model.TestResult> getResultHistory(final int userId) throws uk.co.olimor.BMBTApi_boot.exception.ApiException {
    log.entry(userId);
