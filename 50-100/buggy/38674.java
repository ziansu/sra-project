...
public void processResult(int rc, java.lang.String path, java.lang.Object ctx, byte[] bytes, org.apache.zookeeper.data.Stat stat) {
    ...
    org.apache.curator.framework.imps.CuratorEvent event = new org.apache.curator.framework.imps.CuratorEventImpl(client, CuratorEventType.RECONFIG, rc, path, null, ctx, stat, bytes, null, null, null);
