...
tabletop.domain.user.User user, org.springframework.validation.Errors errors, java.lang.String mail) {
    if (errors.hasErrors()) {
    ...
    return tabletop.controllers.utils.ResponseUtils.created(userService.editMail(user, mail));
}