...
java.lang.String accessKey, org.springframework.validation.BindingResult result, org.springframework.ui.Model model, javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) {
    super.populateModelWithHeatmapData(((uk.ac.ebi.atlas.model.differential.microarray.MicroarrayExperiment) (experimentTrader.getExperiment(experimentAccession, accessKey))), preferences, result, model, request);
