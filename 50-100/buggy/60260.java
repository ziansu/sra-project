private void showFavoriteStops() {
    ...
    getSupportFragmentManager().beginTransaction().add(R.id.left_dynamic_fragments_frame, mFavoriteStopsFragment, au.com.kbrsolutions.melbournepublictransport.activities.MainActivity.FAVORITE_STOPS_TAG).addToBackStack(au.com.kbrsolutions.melbournepublictransport.activities.MainActivity.FAVORITE_STOPS_TAG).commit();
}