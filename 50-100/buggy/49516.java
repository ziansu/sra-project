...
public void perspectivePreDeactivate(org.eclipse.ui.IWorkbenchPage page, org.eclipse.ui.IPerspectiveDescriptor perspective) {
    org.eclipse.ui.internal.cheatsheets.views.CheatSheetView cheetSheet = org.talend.commons.ui.utils.CheatSheetUtils.getInstance().findCheetSheet("org.talend.datacleansing.core.ui.dqcheatsheet");
    if (null != cheetSheet) {
