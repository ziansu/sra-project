private void initializeEventSummaryView() {
    ...
    adapter = new edu.washington.ischool.commoncents.commoncents.adapters1.UsersListAdapter(getBaseContext(), this, edu.washington.ischool.commoncents.commoncents.AppState.getCurrentState().getSelectedEvent().getUsersInvolved());
