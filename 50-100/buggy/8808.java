...
public de.hshannover.f4.trust.visitmeta.gui.util.RestConnection copy() {
    de.hshannover.f4.trust.visitmeta.gui.util.RestConnection tmp = new de.hshannover.f4.trust.visitmeta.gui.util.RestConnection(getDataserviceConnection(), getConnectionName());
    tmp.setUrl(getUrl());
