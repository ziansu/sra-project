...
public java.util.List<java.time.LocalDate> calcNearestDatesByCronPatternAfter(java.util.Set<java.time.LocalDate> holidays, java.lang.String cronPattern) {
    ...
    java.util.List<java.time.LocalDate> businessDayList = com.github.uryyyyyyy.bizCalendarUtil.impl.ImplUtil.calcHolidayAfter(cronDayList, holidays);
    return com.github.uryyyyyyy.bizCalendarUtil.impl.ImplUtil.trim(businessDayList, minDay, maxDay);
}