...
public boolean isApplicable(org.ow2.authzforce.core.pdp.api.EvaluationContext context) throws org.ow2.authzforce.core.pdp.api.IndeterminateEvaluationException {
    try {
        ...
        throw new org.ow2.authzforce.core.pdp.api.IndeterminateEvaluationException(("Error checking whether Policy(Set) referenced by " + (this)), ((e.getStatusCode()) + " is applicable to the request context"), e);
    }
}