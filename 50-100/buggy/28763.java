    ...
    for (int retry = 1; ; retry++) {
        try {
            if (readWriteLock(lockInstanceIdentifier, lockData)) {
                ...
                org.opendaylight.lockmanager.LockManager.LOG.debug("Already locked after waiting {}ms, try {}", org.opendaylight.lockmanager.LockManager.DEFAULT_WAIT_TIME_IN_MILLIS, retry);
            }
