...
public void onGet(java.lang.Object item) {
    if (checkValidCache(item)) {
        ...
        setIsLoading(false);
        android.support.design.widget.Snackbar snackbar = android.support.design.widget.Snackbar.make(getView(), R.string.cached_content, Snackbar.LENGTH_SHORT);
        org.gdg.frisbee.android.view.ColoredSnackBar.info(snackbar).show();
    }else {
