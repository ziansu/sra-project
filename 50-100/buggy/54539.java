public static void testParseSystemCapabilities() throws java.lang.Exception {
    aQute.launcher.plugin.Workspace ws = aQute.launcher.plugin.Workspace.getWorkspace(aQute.launcher.plugin.IO.getFile("test/ws"));
