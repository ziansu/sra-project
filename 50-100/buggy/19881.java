public static void main(java.lang.String[] args) throws java.rmi.RemoteException {
    try {
        ...
        rmi.ViewListener viewListener = null;
        rmi.ImplementCli serventeCli = new rmi.ImplementCli(refServenteServidor, viewListener);
        viewListener = new rmi.ViewListener(refServenteServidor, serventeCli);
