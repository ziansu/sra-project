public MaterialService.PreviewResult previewTexture(spix.app.material.Texture texture) {
    ...
    spix.app.material.MaterialService.PreviewResult res = requestPreview(texPreviewMaterial, "Default", spix.app.material.MaterialAppState.DisplayType.FullScreenQuad, 0);
