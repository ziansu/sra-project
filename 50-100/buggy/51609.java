public javax.swing.JPanel messagePanel() {
    ...
    timeLabel = new javax.swing.JLabel((("游戏时间:" + (java.lang.Integer.toString(timeLength))) + "秒"));
    showTime();
    javax.swing.JLabel resultLabel = new javax.swing.JLabel("   状态:游戏进行中");
    javax.swing.JLabel minesCountLabel = new javax.swing.JLabel(("   剩余地雷个数:" + (minesCount)));
