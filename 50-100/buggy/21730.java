public int extractIdFromFilename(java.lang.String filename) throws com.dbdeploy.exceptions.UnrecognisedFilenameException {
    ...
    return java.lang.Integer.parseInt(matches.group(1));
}