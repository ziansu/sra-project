...
public void freeParkingSpot(java.lang.String vehicleId, org.matsim.api.core.v01.Id<org.matsim.api.core.v01.network.Link> linkId) {
    ...
    org.matsim.api.core.v01.network.Network network = scenario.getNetwork();
    ...
    ((org.matsim.contrib.carsharing.manager.supply.OneWayContainer) (vehiclesContainer)).freeParkingSpot(link);
}