...
public boolean validateStorageProviderConnection(com.emc.storageos.storagedriver.model.StorageProvider storageProvider) {
    ...
    try {
        com.emc.storageos.driver.dellsc.helpers.DellSCConnectionManager.getInstance().getConnection(storageProvider.getProviderHost(), storageProvider.getPortNumber(), storageProvider.getUsername(), storageProvider.getPassword());
