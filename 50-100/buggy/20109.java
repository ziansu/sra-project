...
public void setup() {
    ...
    lk.ac.mrt.cse.dbs.simpleexpensemanager.data.impl.PresistentTransactionDAO presistentTransactionDAO = new lk.ac.mrt.cse.dbs.simpleexpensemanager.data.impl.PresistentTransactionDAO();
