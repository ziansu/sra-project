...
protected org.payn.chsm.processors.ControllerHolon loadController() throws java.lang.Exception {
    ...
    if (procElem != null) {
        ...
        if (!(classPath.equals(""))) {
            return ((org.payn.chsm.processors.ControllerHolon) (org.payn.chsm.io.ModelLoader.createObjectInstance(getClass().getClassLoader(), procElem.getFile(pathRoot), classPath, java.lang.String.format("Controller %s", classPath))));
        }
    }
    return null;
}