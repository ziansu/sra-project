...
public okhttp3.Response intercept(com.tomeokin.lspush.injection.module.Chain chain) throws java.io.IOException {
    ...
    okhttp3.CacheControl cacheControl = new okhttp3.CacheControl.Builder().maxAge(2, java.util.concurrent.TimeUnit.MINUTES).onlyIfCached().maxStale(0, java.util.concurrent.TimeUnit.SECONDS).build();
