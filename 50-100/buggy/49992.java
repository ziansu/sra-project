private void copyResources(java.lang.String file) throws java.io.IOException {
    java.lang.ClassLoader classLoader = getClass().getClassLoader();
    try (java.io.InputStream source = classLoader.getResourceAsStream(("html/templates/" + file))) {
