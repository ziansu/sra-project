...
public void testLastCommit() throws java.lang.Exception {
    org.junit.Assert.assertEquals(new java.util.Date(0), com.gitblit.utils.JGitUtils.getLastChange(null, null));
    ...
    java.util.Date date = com.gitblit.utils.JGitUtils.getLastChange(repository, null);
    repository.close();
