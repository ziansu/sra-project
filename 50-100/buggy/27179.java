private void processError(java.lang.String endpointId, org.eclipse.che.api.core.jsonrpc.commons.JsonRpcResponse response, java.lang.String key) {
    ...
    org.eclipse.che.api.core.jsonrpc.commons.JsonRpcPromise<org.eclipse.che.api.core.jsonrpc.commons.JsonRpcError> jsonRpcPromise = org.eclipse.che.api.core.jsonrpc.commons.ResponseDispatcher.cast(promises.get(key));
