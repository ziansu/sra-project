@java.lang.Override
protected void onSwiped(de.aw.awlib.adapters.AWCursorDragDropRecyclerViewAdapter adapter, android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int direction, int position, long id) {
    try {
