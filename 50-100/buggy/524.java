public static void initFeatures() {
    ...
    org.epoxide.surge.features.FeatureManager.registerFeature(new org.epoxide.surge.features.bedbug.FeatureBedBug(), "Bed Bug", "Fixes being stuck in the bed when the packet gets lost");
}