...
public void removeBatchShouldReturn() throws java.lang.Exception {
    ...
    org.junit.Assert.assertTrue("batch removal succeeds", constructor.removeBatch("Search Suggestions", this.getRandString(), this.getRandString(), this.getRandString()));
}