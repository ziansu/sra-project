...
public void onRender(net.minecraftforge.client.event.RenderGameOverlayEvent.Pre event) {
    ...
    if (((event.type) == (net.minecraftforge.client.event.RenderGameOverlayEvent.ElementType.JUMPBAR)) || ((event.type) == (net.minecraftforge.client.event.RenderGameOverlayEvent.ElementType.HOTBAR))) {
