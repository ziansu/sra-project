...
public com.catify.initializr.domain.Domain createSample() {
    ...
    domain.addService(new com.catify.initializr.domain.MicroService("service-a", "0.0.1-SNAPSHOT"));
    domain.addService(new com.catify.initializr.domain.MicroService("service-b", "0.0.1-SNAPSHOT"));
    return domain;
}