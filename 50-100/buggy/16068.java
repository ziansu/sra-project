...
public void distinctWithFetch() {
    ...
    io.ebean.Query<org.tests.model.basic.Customer> query = io.ebean.Ebean.find(org.tests.model.basic.Customer.class).setDistinct(true).fetch("billingAddress", "city").setMaxRows(100);
