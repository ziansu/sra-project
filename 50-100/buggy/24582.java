...
public void listen() {
    try {
        ...
        while (running) {
            ...
            de.jattyv.jcapi.server.network.ServerThread st = new de.jattyv.jcapi.server.network.ServerThread(new de.jattyv.jcapi.server.network.data.Connection(this, s), dc);
