public static org.bugkillers.core.result.BaseResult<org.bugkillers.core.model.User> loginValidator(org.bugkillers.core.model.User user) {
    ...
    if (((null == user) || (org.apache.commons.lang.StringUtils.isEmpty(user.getEmail()))) || ((org.apache.commons.lang.StringUtils.isEmpty(user.getUserName())) & (org.apache.commons.lang.StringUtils.isEmpty(user.getPassword())))) {
