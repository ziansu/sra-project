private boolean permissionCheck() {
    while (((cn.tonlyshy.app.fmpet.utility.PermissionCheckerer.checkFloatWindowPermission(this)) != true) || ((cn.tonlyshy.app.fmpet.utility.PermissionCheckerer.checkNotificationListenerPermission(this)) != true)) {
