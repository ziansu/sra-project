private void createApplicationMainUserIfDoesntExist() {
    try {
        loggedInUser = ((com.matteoveroni.mydiary.user.ApplicationUser) (databaseManager.read(com.matteoveroni.mydiary.user.ApplicationUser.class, ElementOnWhichOperate.FIRST)));
