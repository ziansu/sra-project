...
public void onAddRemoteStream(org.webrtc.MediaStream remoteStream, int endPoint) {
    ...
    org.webrtc.VideoRendererGui.update(localRender, fr.pchab.androidrtc.RtcActivity.LOCAL_X_CONNECTED, fr.pchab.androidrtc.RtcActivity.LOCAL_Y_CONNECTED, fr.pchab.androidrtc.RtcActivity.LOCAL_WIDTH_CONNECTED, fr.pchab.androidrtc.RtcActivity.LOCAL_HEIGHT_CONNECTED, VideoRendererGui.ScalingType.SCALE_ASPECT_FIT);
}