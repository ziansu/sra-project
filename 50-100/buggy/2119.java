...
public android.view.View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container, android.os.Bundle savedInstanceState) {
    ...
    getData();
    android.widget.Toast.makeText(com.example.sony.ecommerce.Fragment.FragmentExploreChild.context, com.example.sony.ecommerce.Fragment.FragmentExploreChild.catName, Toast.LENGTH_SHORT).show();
    return view;
}