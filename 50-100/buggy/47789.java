...
public void getResourcesShouldReturnResourceWithNoRootSetAndExistingFSConfig() throws java.lang.Exception {
    org.apache.metron.common.utils.ResourceLoader loader = new org.apache.metron.common.utils.ResourceLoader.Builder().withFileSystemConfiguration(new org.apache.hadoop.conf.Configuration()).build();
