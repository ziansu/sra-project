...
public void testConstructor() {
    ...
    applicationLoader = new com.moc.chitchat.application.ApplicationLoader((applicationLoader = new com.moc.chitchat.application.ApplicationLoader(mockConfiguration, mockAuthenticationStage, mockMainStage)));
