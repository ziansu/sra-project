private org.jasig.portal.groups.pags.IPersonTester initializeTester(org.jasig.portal.groups.pags.dao.IPersonAttributesGroupTestDefinition test) {
    try {
        ...
        java.lang.reflect.Constructor<?> c = testerClass.getConstructor(new java.lang.Class[]{ org.jasig.portal.groups.pags.dao.IPersonAttributesGroupTestDefinition.class });
        java.lang.Object o = c.newInstance(new java.lang.Object[]{ test });
