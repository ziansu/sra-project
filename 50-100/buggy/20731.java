public static void bindButton(final android.view.View parent, final android.widget.Button button, final nl.jmuijsenberg.androiddemo.viewmodels.base.Command command) {
    if (button != null) {
