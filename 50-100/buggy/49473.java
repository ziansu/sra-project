public void keyReleased(int key, char c) {
    switch (key) {
        ...
        case org.newdawn.slick.Input.KEY_SPACE :
            tMain.enterState(5, new org.newdawn.slick.state.transition.FadeOutTransition(org.newdawn.slick.Color.black), new org.newdawn.slick.state.transition.FadeInTransition(org.newdawn.slick.Color.black));
            break;
        default :
            break;
    }
