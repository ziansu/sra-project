public static java.lang.String format(java.lang.String sql, java.lang.String dbType, java.util.List<java.lang.Object> parameters, com.alibaba.druid.sql.SQLUtils.FormatOption option, boolean prettyFormat) {
    try {
        ...
        return com.alibaba.druid.sql.SQLUtils.toSQLString(statementList, dbType, parameters, option, null, prettyFormat);
