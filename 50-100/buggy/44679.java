private void publishEvent(final org.hudsonci.rest.model.build.BuildEventDTO event) {
    assert event != null;
    try {
        org.cometd.bayeux.server.ServerChannel channel = org.hudsonci.rest.plugin.cometd.CometdProvider.getBayeux().getChannel(org.hudsonci.rest.plugin.cometd.BuildEventPublisher.CHANNEL);
        if (channel != null) {
