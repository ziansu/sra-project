...
public boolean workCycle() {
    ...
    if (currentRecipe.fillRecipe) {
        ...
        status = forestry.core.fluids.FluidHelper.drainContainers(tankManager, this, InventoryBottler.SLOT_LEFT_PROCESSING, InventoryBottler.SLOT_OUTPUT_EMPTY_CONTAINER);
    }
