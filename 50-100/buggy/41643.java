private java.io.ByteArrayOutputStream createThumbnail(java.lang.String imagePath, net.coobird.thumbnailator.util.exif.Orientation orientation) {
    ...
    try {
        net.coobird.thumbnailator.Thumbnails.of(imagePath).size(thumbnailWidth, thumbnailHeight).rotate(calculateAngle(orientation)).outputFormat("jpg").toOutputStream(stream);
        stream.close();
