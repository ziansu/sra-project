...
public void onClick(android.view.View v) {
    ...
    android.content.Intent intent = new android.content.Intent(getActivity(), tom.chinesefootballtracker.ScoutActivity.class).putExtra(tom.chinesefootballtracker.MainFragment.SCOUT, tom.chinesefootballtracker.Roster.getPreferredPlayer(getContext()));
