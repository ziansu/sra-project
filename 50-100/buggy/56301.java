...
java.lang.Integer meta, java.lang.Integer charge) {
    net.minecraftforge.common.config.Property prop = new net.minecraftforge.common.config.Property(item, new java.lang.String[]{ meta.toString() , charge.toString() }, Property.Type.INTEGER);
