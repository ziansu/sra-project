private static void initHttpClient() {
    ...
    httpClientBuilder.addNetworkInterceptor(new com.dorothy.v2ex.http.AddCookieIntercepter(com.dorothy.v2ex.http.V2EXHttpClient.context));
    httpClientBuilder.addInterceptor(new com.dorothy.v2ex.http.RecivedCookieIntercepter(com.dorothy.v2ex.http.V2EXHttpClient.context));
