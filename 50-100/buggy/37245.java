...
double amount) {
    com.tealcube.minecraft.bukkit.facecore.utilities.MessageUtils.sendMessage(sender, (((("&aBonus drop mult changed to " + amount) + "x from ") + (plugin.getMultiplierManager().getDropMult())) + "x!"));
