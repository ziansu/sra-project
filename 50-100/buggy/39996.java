public org.apache.flink.api.java.DataSet<org.apache.flink.api.java.tuple.Tuple2<java.lang.Integer, java.lang.String>> getDataCleanerTestDataFromCsv() {
    ...
    return environment.readCsvFile(testData.toString()).includeFields("11").fieldDelimiter(";").ignoreInvalidLines().types(java.lang.Integer.class, java.lang.String.class);
}