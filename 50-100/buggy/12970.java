...
public java.util.List<de.blackcraze.grb.model.entity.StockType> findByNameLike(java.lang.String name, java.util.Locale locale) {
    ...
    java.util.function.Predicate<de.blackcraze.grb.model.entity.StockType> filter = ( stock) -> !(de.blackcraze.grb.i18n.Resource.getItem(stock.getName(), locale).toLowerCase().contains(name));
