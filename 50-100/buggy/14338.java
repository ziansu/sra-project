public static void reScheduleAllReminders(android.content.Context context) {
    ...
    for (com.github.trainjezelf.datastore.Reminder reminder : dataStore.getReminders()) {
        ...
        if (com.github.trainjezelf.alarm.AlarmScheduler.hasPendingAlarm(context, uniqueId)) {
            com.github.trainjezelf.alarm.AlarmScheduler.scheduleNextReminder(context, reminder.getUniqueId());
        }
    }
}