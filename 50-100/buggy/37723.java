...
public org.springframework.http.ResponseEntity<com.nekretnine.dto.ResponseDTO> myEstates(java.security.Principal principal) {
    ...
    java.util.List<com.nekretnine.models.Advertisement> page = advertisementService.findBySoldto(customer);
    return new org.springframework.http.ResponseEntity(new com.nekretnine.dto.ResponseDTO(("" + (page.size()))), org.springframework.http.HttpStatus.OK);
}