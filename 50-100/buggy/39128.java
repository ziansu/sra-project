...
public void testRegionIsFoundWithSiftLessThan() {
    ...
    regions.add(region);
    java.util.List<uk.ac.ebi.eva.lib.utils.RepositoryFilter> filters = uk.ac.ebi.eva.lib.utils.RepositoryFilterUtils.getRepositoryFilters(null, null, "<0.5", null, null);
    testFiltersHelperRegion(regions, filters, new java.util.ArrayList<>(), 11);
}