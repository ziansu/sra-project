...
public void testQueryProgressHidden() throws java.lang.Throwable {
    ...
    testScriptFile(SCRIPT_TEXT, EXPECTED_PATTERN, false, getBaseArgs(org.apache.hive.beeline.TestBeeLineWithArgs.miniHS2.getBaseJdbcURL()), org.apache.hive.beeline.TestBeeLineWithArgs.OutStream.ERR);
}