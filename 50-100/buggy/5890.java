...
protected static java.io.File getLoaderFile(java.lang.Class<?> clazz, java.lang.String str) {
    ...
    assert plugin != null;
    return new java.io.File(new java.io.File(plugin.getPath(), "loader"), "loader.exe");
}