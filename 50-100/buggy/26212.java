private java.util.Set<org.eclipse.buildship.core.configuration.BuildConfiguration> createBuildConfigsFor(java.util.Set<org.eclipse.core.resources.IProject> projects) {
    ...
    for (org.eclipse.core.resources.IProject project : projects) {
        buildConfigs.add(org.eclipse.buildship.core.CorePlugin.configurationManager().createBuildConfiguration(project.getLocation().toFile(), com.gradleware.tooling.toolingclient.GradleDistribution.fromBuild(), false, false, false));
    }
    return buildConfigs;
}