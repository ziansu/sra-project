public static java.io.File joinFiles(javax.swing.JFrame parent, java.io.File[] inputFileArray, java.lang.Integer minNumberSamples) {
    ...
    if (file != null) {
        new org.fhaes.tools.FHOperations(parent, inputFileArray, file, 0, 0, 1.0, org.fhaes.enums.FireFilterType.NUMBER_OF_EVENTS, true, false, false, minNumberSamples, null);
        return file;
    }
    return null;
}