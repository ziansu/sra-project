public static io.github.emanuelpalm.plisp.front.parser.TreeNode of(final io.github.emanuelpalm.plisp.front.lexer.Token t, final io.github.emanuelpalm.plisp.front.parser.TreeNode.List args) {
    ...
    return (ts.size()) > 0 ? new io.github.emanuelpalm.plisp.front.parser.TreeNode.Call(t, ts.get(0), new io.github.emanuelpalm.plisp.front.parser.TreeNode.List(t, ts.subList(1, ((ts.size()) - 2)))) : new io.github.emanuelpalm.plisp.front.parser.TreeNode.Void(t);
}