...
java.lang.String flag, @com.sinosoft.one.mvc.web.annotation.Param(value = "oldFlag")
java.lang.String oldFlag, @com.sinosoft.one.mvc.web.annotation.Param(value = "boardNo")
...
java.lang.String productNoStr, com.sinosoft.one.mvc.web.Invocation inv) throws java.io.IOException {
    java.lang.String jsonStr = synthesisService.makeBoard(boardNo, flag, oldFlag, productNoStr, inv);
