...
android.view.MenuItem item) {
    switch (item.getItemId()) {
        case R.id.action_liveboard :
            setView(be.hyperrail.android.MainActivity.VIEW_TYPE_LIVEBOARD);
            break;
        case R.id.action_route :
            setView(be.hyperrail.android.MainActivity.VIEW_TYPE_ROUTE);
            break;
        case R.id.action_disturbances :
            setView(be.hyperrail.android.MainActivity.VIEW_TYPE_DISTURBANCE);
            break;
