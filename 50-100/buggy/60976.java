...
public void preInit(cpw.mods.fml.common.event.FMLPreInitializationEvent event) {
    ...
    com.subsistence.Subsistence.network.registerMessage(PacketSyncContents.PacketSyncContentsHandler.class, com.subsistence.common.network.PacketSyncContents.class, 0, Side.CLIENT);
    com.subsistence.Subsistence.network.registerMessage(PacketSyncContents.PacketSyncContentsHandler.class, com.subsistence.common.network.PacketSyncContents.class, 0, Side.SERVER);
