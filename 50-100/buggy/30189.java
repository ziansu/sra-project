...
public void handleMessage(android.os.Message message) {
    if ((de.tbjv.rmxmc2.activity.ControllerActivity.currentTrain) == (message.what)) {
        ...
        de.tbjv.rmxmc2.activity.ControllerActivity.throttleFragment.moveThrottle(de.tbjv.rmxmc2.activity.ControllerActivity.throttleScale.stepToPosition(trainSpeed));
    }
}