...
public static void beforeClass() throws java.lang.Exception {
    ...
    co.cask.cdap.data2.dataset2.lib.table.hbase.HBaseTableTest.ddlExecutor = new co.cask.cdap.data2.util.hbase.HBaseDDLExecutorFactory(co.cask.cdap.data2.dataset2.lib.table.hbase.HBaseTableTest.cConf, co.cask.cdap.data2.dataset2.lib.table.hbase.HBaseTableTest.TEST_HBASE.getHBaseAdmin().getConfiguration()).get();
