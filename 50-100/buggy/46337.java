...
protected void keyTyped(char par1, int par2) {
    ...
    ((net.minecraft.client.gui.GuiButton) (buttonList.get(com.anion155.tfc_advancedblueprint.GUI.GuiAdvBlueprintViewer.done_bt_ind))).enabled = (nameTextField.getText().trim().length()) > 0;
