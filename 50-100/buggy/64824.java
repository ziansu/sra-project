...
public void store_page_body_if_element_not_present() throws java.io.IOException {
    ...
    org.hamcrest.MatcherAssert.assertThat(pageBody, org.hamcrest.Matchers.both(org.hamcrest.Matchers.containsString("christian-draeger")).and(org.hamcrest.Matchers.containsString("GitHub")));
}