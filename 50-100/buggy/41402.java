public parking.beans.document.Account registerUser(parking.beans.document.Account user, int number, javax.servlet.http.HttpServletRequest request) throws parking.exceptions.ApplicationException {
