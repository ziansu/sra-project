public com.iquanwai.platon.biz.po.WarmupSubmit getWarmupSubmit(java.lang.Integer planId, java.lang.Integer questionId, java.lang.Integer profileId) {
    ...
    try {
        com.iquanwai.platon.biz.po.WarmupSubmit submit = run.query("SELECT * FROM WarmupSubmit where PlanId=? and QuestionId=? and ProfileId=?", h, profileId, questionId, planId);
        return submit;
