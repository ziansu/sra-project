public void onCompleted(com.facebook.internal.ImageResponse response) {
    ...
    try {
        me.twango.twango.entity.User.setUser(context, uid, email, name, NameConstant.LOGIN_TYPE_FACEBOOK, bitmap, com.facebook.internal.ImageRequest.getProfilePictureUri(object.getString("id"), 100, 100).toString());
