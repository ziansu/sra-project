...
public void ShouldNotCreateFacilityIfPhoneNumberAlreadyExists() throws org.motechproject.ghana.national.exception.FacilityAlreadyFoundException {
    ...
    org.mockito.Mockito.when(mockAllFacilities.facilities()).thenReturn(java.util.Arrays.asList(new org.motechproject.ghana.national.domain.Facility().phoneNumber(testPhoneNumber)));
