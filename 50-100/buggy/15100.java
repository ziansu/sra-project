private void menuSettings() {
    ...
    android.util.Log.w(net.ddns.raylam.sliding_puzzle.ui.overflow.ActionBarOverflow.NAME, ((("soundEnabled = " + (sp.getBoolean(PuzzleActivity.NAME_SOUND_ENABLED, false))) + ", difficulty = ") + (sp.getInt(PuzzleActivity.NAME_DIFFICULTY, (-1)))));
