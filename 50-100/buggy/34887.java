public static org.sosy_lab.common.io.Path getNativeLibraryPath() {
    if ((org.sosy_lab.common.NativeLibraries.nativePath) == null) {
        ...
        org.sosy_lab.common.NativeLibraries.nativePath = org.sosy_lab.common.NativeLibraries.getPathToJar().getParent().getParent().getParent().resolve(org.sosy_lab.common.io.Paths.get("native", ((arch + "-") + os)));
    }
