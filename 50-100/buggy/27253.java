public static org.apache.stratos.messaging.domain.topology.Topology retrieveTopology() {
    java.lang.Object obj = org.apache.stratos.cloud.controller.registry.RegistryManager.getInstance().read(CloudControllerConstants.TOPOLOGY_RESOURCE);
    if (obj != null) {
        try {
            java.lang.Object dataObj = org.apache.stratos.cloud.controller.registry.Deserializer.deserializeFromByteArray(((byte[]) (obj)));
