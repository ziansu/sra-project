...
public void testConfigurableBufferSize() throws java.io.IOException {
    ...
    try (final java.io.RandomAccessFile raf = new java.io.RandomAccessFile(file, "rw")) {
        ...
        final org.apache.logging.log4j.core.appender.RandomAccessFileManager manager = new org.apache.logging.log4j.core.appender.RandomAccessFileManager(raf, file.getName(), os, false, bufferSize, null, null, true);
