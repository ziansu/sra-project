...
public void testOnDetachedFromRecyclerView() {
    ...
    com.xamoom.android.xamoomcontentblocks.Adapters.ContentBlockAdapter adapter = new com.xamoom.android.xamoomcontentblocks.Adapters.ContentBlockAdapter(fragment, contentBlockList, null, new com.xamoom.android.xamoomsdk.EnduserApi("api"), false, "apikey", null);
