public void fetchCount(final tk.lefourretoutsonore.lefourre_toutsonore.RecyclerAdapter.EventViewHolder holder, final int position) {
    ...
    tk.lefourretoutsonore.lefourre_toutsonore.PlayListRelated.PlayList pl = new tk.lefourretoutsonore.lefourre_toutsonore.PlayListRelated.PlayList(choiceSource[position], context, null);
