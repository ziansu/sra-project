private void createRoom(int roomID, java.lang.String[] wallDescriptors) {
    ...
    com.semaphore_soft.apps.cypher.PortalActivity.serverService.writeAll(((com.semaphore_soft.apps.cypher.networking.NetworkConstants.PREFIX_RESERVE_ROOM) + roomID));
}