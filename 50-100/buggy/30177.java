...
public void testLocationButton() {
    android.support.test.espresso.Espresso.onView(android.support.test.espresso.matcher.ViewMatchers.withId(R.id.locationButton)).perform(android.support.test.espresso.action.ViewActions.scrollTo(), android.support.test.espresso.action.ViewActions.click());
