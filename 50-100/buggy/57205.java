...
public static void loadTrainingData() throws com.aic.sentiment_analysis.preprocessing.PreprocessingException, java.io.FileNotFoundException, java.net.URISyntaxException {
    ...
    com.aic.sentiment_analysis.classification.EvaluationTest.trainingSamples = sampleLoader.load(com.aic.sentiment_analysis.classification.EvaluationTest.class.getClassLoader().getResource(Constants.CLASSIFIER_TRAINING_FILE_PATH).toURI());
