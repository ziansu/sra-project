...
public void refreshContent(com.github.mikephil.charting.data.Entry e, int dataSetIndex) {
    if (e instanceof com.github.mikephil.charting.data.CandleEntry) {
        ...
        tvContent.setText(("" + (com.github.mikephil.charting.utils.Utils.formatNumber(ce.getHigh(), 0, true))));
    }else {
        tvContent.setText(("" + (com.github.mikephil.charting.utils.Utils.formatNumber(e.getVal(), 0, true))));
    }
}