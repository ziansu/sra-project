...
public void screenChanged(edu.chl.proximity.Controllers.ScreenChanger.ScreenChanger.ScreenType newScreen) {
    switch (newScreen) {
        case MainMenu :
            ...
            break;
        case GameOver :
            game.setScreen(new edu.chl.proximity.Controllers.GameStates.GameOverScreen(game, map, edu.chl.proximity.Models.Player.Players.GameData.getInstance().getPlayer()));
            break;
        default :
            break;
    }
