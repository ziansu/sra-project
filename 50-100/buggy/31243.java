...
public void apply(final com.tinkerpop.gremlin.process.Traversal.Admin<?, ?> traversal, final com.tinkerpop.gremlin.process.TraversalEngine engine) {
    ...
    if (endStep instanceof com.tinkerpop.gremlin.process.graph.marker.Reducing)
        com.tinkerpop.gremlin.process.util.TraversalHelper.replaceStep(endStep, new com.tinkerpop.gremlin.process.graph.strategy.ReducingStrategy.ReducingIdentity(traversal, ((com.tinkerpop.gremlin.process.graph.marker.Reducing) (endStep)).getReducer()), traversal);
