...
@org.springframework.web.bind.annotation.RequestMapping(value = "all", method = org.springframework.web.bind.annotation.RequestMethod.GET, produces = javax.ws.rs.core.MediaType.APPLICATION_XML)
public org.springframework.http.ResponseEntity<org.openbox.sf5.model.listwrappers.GenericXMLListWrapper<org.openbox.sf5.model.Settings>> getSettingsByUserLoginXML() throws org.openbox.sf5.json.exceptions.NotAuthenticatedException {
    ...
    if (settList.isEmpty()) {
        return new org.springframework.http.ResponseEntity<org.openbox.sf5.model.listwrappers.GenericXMLListWrapper<org.openbox.sf5.model.Settings>>(org.springframework.http.HttpStatus.NO_CONTENT);
    }
