...
public boolean equals(java.lang.Object that) {
    ...
    if (that instanceof org.atlasapi.persistence.content.listing.ContentListingCriteria) {
        ...
        return (((this.progress.equals(other.progress)) && (this.publishers.equals(other.publishers))) && (this.progress.equals(other.progress))) && (this.categories.equals(other.categories));
    }
    return false;
}