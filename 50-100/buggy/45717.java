...
public org.springframework.http.ResponseEntity<java.util.Set<ru.moneymanager.web.beans.User>> listAllUsers() {
    java.util.Set<ru.moneymanager.web.beans.User> users = userService.getAllUser();
    if (users.isEmpty()) {
