public io.swagger.config.SwaggerConfig getConfig() {
    ...
    if ((configId) != null) {
        ...
        if ((sc) != null) {
            configIdKey = ((sc.getInitParameter(SwaggerConfig.CONFIG_ID_KEY)) != null) ? (io.swagger.config.SwaggerConfig.CONFIG_ID_PREFIX) + (configId) : io.swagger.config.SwaggerConfig.CONFIG_ID_DEFAULT;
        }else {
