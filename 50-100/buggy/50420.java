private void processResult(java.lang.String endpointId, org.eclipse.che.api.core.jsonrpc.commons.JsonRpcResponse response, java.lang.String key, java.lang.Class<?> rClass) {
    ...
    if (result.isSingle()) {
        processOne(endpointId, result, rClass, org.eclipse.che.api.core.jsonrpc.commons.ResponseDispatcher.cast(promises.get(key).getSuccessConsumer()));
    }else {
        processMany(endpointId, result, rClass, org.eclipse.che.api.core.jsonrpc.commons.ResponseDispatcher.cast(promises.get(key).getSuccessConsumer()));
    }
}