private void preparingAdminConfigCache() throws java.lang.Exception {
    ...
    if (((com.superwebsitebuilder.espider.util.Utils.checkNotNull(adminConfigMap)) && (com.superwebsitebuilder.espider.util.Utils.checkNotNull(allSWData))) && ((allSWData.size()) > 0)) {
