private void getNewProcessingSystemsFromDatabase() {
    ...
    for (pl.edu.uj.fais.wpz.msom.entities.Model m : models) {
        ...
        if (!(isProcessingSystemOnLocalList(id))) {
            pl.edu.uj.fais.wpz.msom.model.ProcessingSystemMockup processingSystem = new pl.edu.uj.fais.wpz.msom.model.ProcessingSystemMockup(controllerUnitService, distributionService, modelService, moduleService, pathService, taskService, taskTypeService);
