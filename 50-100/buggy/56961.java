public cn.ximoon.rxretrofitframework.logic.processor.NetProcessor getUser(cn.ximoon.rxretrofitframework.core.callback.NetResultCallback<cn.ximoon.rxretrofitframework.bean.UserBean> callback) {
    ...
    return new cn.ximoon.rxretrofitframework.logic.processor.NetProcessor<cn.ximoon.rxretrofitframework.bean.UserBean>().onCallback(callback).onRetry(true).onClazz(cn.ximoon.rxretrofitframework.bean.UserBean.class).onUrl("/get/user").onQueryMap(params).get();
}