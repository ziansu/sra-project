...
public void testGetUsers() throws java.lang.Exception {
    ...
    org.mockito.Mockito.when(this.bankApi.getUsers(userFilter)).thenReturn(com.cmartin.learn.mybank.test.TestUtils.createUsers(2));
    ...
    org.mockito.Mockito.verify(this.bankApi).getUsers(org.mockito.Matchers.any(com.cmartin.learn.mybank.api.UserFilter.class));
}