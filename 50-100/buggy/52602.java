public edu.stanford.nlp.fsm.DFSA<java.lang.String, java.lang.Integer> getViterbiSearchGraph(java.util.List<IN> doc, java.lang.Class<? extends edu.stanford.nlp.ling.CoreAnnotation<java.lang.String>> answerField) {
    if (doc.isEmpty()) {
