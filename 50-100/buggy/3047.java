...
public org.springframework.http.ResponseEntity exit(javax.servlet.http.HttpSession httpSession) {
    if ((httpSession.getAttribute("userId")) == null) {
        return org.springframework.http.ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new sample.models.Status(sample.models.Status.ERROR_UNAUTHORIZED, "user not authorized"));
    }
