...
android.os.Bundle savedInstanceState) {
    ...
    recyclerView.setLayoutManager(new android.support.v7.widget.GridLayoutManager(com.excitingboat.freshmanspecial.view.fragment.Style.PictureGridFragment.getContext(), 2));
