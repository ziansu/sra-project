...
public void onFailure(retrofit2.Call<polyu.comp.funing.service.ShoppingCartR> call, java.lang.Throwable t) {
    ...
    java.util.List<polyu.comp.funing.model.ShoppingCartDetail> shoppingCartDetails = polyu.comp.funing.model.ScDbProcess.NewScDbProcess(getActivity().getApplicationContext()).scDbGetLocalScD();
