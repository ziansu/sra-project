...
public void onClick(android.content.DialogInterface dialogInterface, int which) {
    ...
    android.support.v4.app.DialogFragment dialog = com.kappa_labs.ohunter.client.utilities.Wizard.getServerCommunicationDialog(com.kappa_labs.ohunter.client.activities.DummyApplication.getContext());
