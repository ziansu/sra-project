protected java.lang.String getIdFromToken(java.lang.String token) {
    ...
    org.glassfish.jersey.client.ClientResponse response = client.target((((ge.edu.freeuni.sdp.xo.rooms.service.RoomsService.LOGIN_SERVICE) + "?token=") + token)).request(MediaType.APPLICATION_JSON_TYPE).get(org.glassfish.jersey.client.ClientResponse.class);
