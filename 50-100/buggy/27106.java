...
public void changed(cg.group4.view.screen.ChangeEvent event, com.badlogic.gdx.scenes.scene2d.Actor actor) {
    cg.group4.game_logic.StandUp.getInstance().getStroll().joinMultiPlayerEvent(java.lang.Integer.getInteger(cCode.getText()), new cg.group4.server.database.ResponseHandler() {
        @java.lang.Override
