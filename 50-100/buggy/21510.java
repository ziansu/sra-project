...
public void onDataChange(com.google.firebase.database.DataSnapshot dataSnapshot) {
    if (!(dataSnapshot.hasChild(com.stuart.hackatonproject.util.FirebaseUtils.getCurrentUniqueUserId()))) {
        ...
        user.setEmail(com.stuart.hackatonproject.helper.LoginHelper.getAuth().getCurrentUser().getDisplayName());
        user.setName(com.stuart.hackatonproject.helper.LoginHelper.getAuth().getCurrentUser().getEmail());
        user.save();
    }
