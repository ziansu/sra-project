...
public edu.utah.nanofab.coralapiserver.core.MemberProjects[] get(@javax.ws.rs.QueryParam(value = "member")
...
edu.utah.nanofab.coralapiserver.auth.User user) {
    ...
    java.util.ArrayList<edu.utah.nanofab.coralapiserver.core.MemberProjects> returnSet;
    returnSet = ((java.util.ArrayList<edu.utah.nanofab.coralapiserver.core.MemberProjects>) (operation.perform()));
    return returnSet.toArray(new edu.utah.nanofab.coralapiserver.core.MemberProjects[0]);
}