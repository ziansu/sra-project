...
public android.view.View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container, android.os.Bundle savedInstanceState) {
    ...
    flipView.setAdapter(new com.plusonesoftwares.plusonesoftwares.bignews.TravelAdapter(getContext(), getActivity(), utils.getFollowedCategoriesLink(getContext(), false)));
    return flipView;
}