...
public void testDecideOnDirectory() throws java.io.IOException {
    ...
    fi.helsinki.cs.tmc.langs.LanguagePlugin mockLanguagePlugin = org.mockito.Mockito.mock(fi.helsinki.cs.tmc.langs.LanguagePlugin.class);
    fi.helsinki.cs.tmc.langs.domain.Filer filer = new fi.helsinki.cs.tmc.langs.domain.Filer().setLanguagePlugin(mockLanguagePlugin).setToPath(toPath);
