public void preinit(net.minecraftforge.fml.common.event.FMLPreInitializationEvent event) {
    ...
    com.himself12794.powersapi.storage.PropertiesManager.instance().registerPropertyClass(com.himself12794.powersapi.storage.EffectsEntity.class, net.minecraft.entity.EntityLivingBase.class);
    com.himself12794.powersapi.storage.PropertiesManager.instance().registerPropertyClass(com.himself12794.powersapi.storage.PowersEntity.class, net.minecraft.entity.EntityLivingBase.class);
}