...
java.lang.String image_url, @org.springframework.web.bind.annotation.RequestParam
java.lang.String createTime) {
    com.cidic.sdx.model.Style style = new com.cidic.sdx.model.Style();
    style.setId(id);
    style.setImageUrl(image_url);
    style.setCreateTime(com.cidic.sdx.util.DateUtil.stringToDate(createTime));
    try {
