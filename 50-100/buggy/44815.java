...
public org.springframework.http.ResponseEntity<java.lang.String> registerGame(@org.springframework.web.bind.annotation.RequestHeader(value = "Authorization")
...
br.edu.ufcg.es.model.DTO.RegisterGame registerGame) {
    ...
    return new org.springframework.http.ResponseEntity("Partida criada com sucesso.", org.springframework.http.HttpStatus.CREATED);
}