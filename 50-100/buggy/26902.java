public com.ufo.socketioandroiddemo.message.model.ChatModel getChatLast() {
    ...
    io.realm.RealmResults<com.ufo.socketioandroiddemo.message.model.ChatBean> beans = realm.where(com.ufo.socketioandroiddemo.message.model.ChatBean.class).equalTo("DisplayInRecently", true).findAllSorted("Time", Sort.DESCENDING);
    if ((beans.size()) > 0) {
