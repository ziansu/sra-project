...
public java.lang.String getPath(io.swagger.servlet.ReaderContext context, java.lang.reflect.Method method) {
    ...
    return io.swagger.util.PathUtils.collectPath(context.getParentPath(), (apiAnnotation == null ? null : apiAnnotation.value()), org.apache.commons.lang3.StringUtils.defaultIfBlank(operationPath, method.getName()));
}