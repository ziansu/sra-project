public static org.apache.lens.cube.parse.ASTNode parseExpr(java.lang.String expr) throws org.apache.lens.server.api.error.LensException {
    ...
    try {
        ...
        throw new org.apache.lens.server.api.error.LensException(org.apache.lens.cube.error.LensCubeErrorCode.COULD_NOT_PARSE_EXPRESSION.getLensErrorInfo(), e, e.getMessage());
    }
