...
final java.util.Map<java.lang.String, java.lang.String> tags, org.jclouds.azurecompute.arm.domain.VirtualMachineProperties properties) {
    return new org.jclouds.azurecompute.arm.domain.AutoValue_VirtualMachine(id, name, location, type, (tags == null ? null : com.google.common.collect.ImmutableMap.copyOf(tags)), properties);
}