public static java.math.BigDecimal getBigDecimalFromArrowBuf(io.netty.buffer.ArrowBuf bytebuf, int index, int scale) {
    byte[] value = new byte[org.apache.arrow.vector.util.DecimalUtility.DECIMAL_BYTE_LENGTH];
    final int startIndex = index * (org.apache.arrow.vector.util.DecimalUtility.DECIMAL_BYTE_LENGTH);
