public void actionPerformed(java.awt.event.ActionEvent e) {
    if (java.awt.Desktop.isDesktopSupported()) {
        try {
            java.io.File f = new java.io.File((((de.hska.ibsys.MainFrame.MainFrame.class.getProtectionDomain().getCodeSource().getLocation().getPath()) + (java.io.File.separator)) + "Handbuch_DE.pdf"));
