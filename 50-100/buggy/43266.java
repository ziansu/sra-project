...
public void truncate() {
    try {
        ...
        throw new java.lang.IllegalStateException(java.lang.String.format("Truncate called on a table (%s) that did not exist", oracleTableNameGetter.getPrefixedTableName(tableRef)));
    }
