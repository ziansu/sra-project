void displaySettingsPage() {
    ...
    this.getUserService().getUserProfilePage(org.ednovo.gooru.client.gin.AppClientFactory.getPlaceManager().getRequestParameter(org.ednovo.gooru.client.mvp.settings.UserSettingsPresenter.GOORU_UID), getUserProfilePageAsyncCallback());
