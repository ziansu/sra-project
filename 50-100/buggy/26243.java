...
public android.support.v4.app.Fragment getItem(int position) {
    ...
    if (existingFrag != null) {
        ...
        com.ustadmobile.port.android.view.ContainerPageFragment frag = com.ustadmobile.port.android.view.ContainerPageFragment.newInstance(baseURI, hrefList[position], query, position);
