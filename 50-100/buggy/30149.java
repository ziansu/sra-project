...
protected void onPreExecute() {
    ...
    try {
        mLastEventInMilliseconds = mSimpleDateFormat.parse(preferences.getString(com.abel.putovits.gravelapp.receivers.CheckForNewEventsReceiver.LAST_EVENT_PREF_NAME, "1997-10-31"));
