public org.wso2.carbon.identity.gateway.api.IdentityResponse process(org.wso2.carbon.identity.gateway.api.IdentityRequest identityRequest) throws org.wso2.carbon.identity.gateway.api.FrameworkException {
    ...
    if (processor != null) {
        if (org.wso2.carbon.identity.gateway.resource.ProcessCoordinator.log.isDebugEnabled()) {
            org.wso2.carbon.identity.gateway.resource.ProcessCoordinator.log.debug(("Starting to process IdentityProcessor : " + (processor.getName())));
        }
