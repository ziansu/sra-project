public com.fasterxml.jackson.dataformat.xml.ser.ToXmlGenerator createGenerator(com.fasterxml.jackson.dataformat.xml.ObjectWriteContext writeCtxt, javax.xml.stream.XMLStreamWriter sw) throws java.io.IOException {
    ...
    return new com.fasterxml.jackson.dataformat.xml.ser.ToXmlGenerator(writeCtxt, ioCtxt, writeCtxt.getGeneratorFeatures(_generatorFeatures), writeCtxt.getFormatWriteFeatures(_xmlGeneratorFeatures), _objectCodec, sw, _xmlPrettyPrinter(writeCtxt));
}