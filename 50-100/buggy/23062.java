...
public void onItemClickListener(com.aftersapp.data.PartyDataDTO partyDataDTO, int position) {
    ...
    com.aftersapp.data.MapDirectionData userLocation = new com.aftersapp.data.MapDirectionData(new com.google.android.gms.maps.model.LatLng(latitude, longitude));
