...
public void runWith(java.util.List<T> result) {
    ...
    listView.setAdapter(new com.lasthopesoftware.bluewater.client.library.items.list.ItemListAdapter<T>(activity, R.id.tvStandard, result, itemListMenuChangeHandler, storedItemAccess, library));
