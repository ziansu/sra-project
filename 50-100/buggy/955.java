private org.duracloud.common.web.RestHttpHelper.HttpResponse addContentItem(java.lang.String contentId) throws java.lang.Exception {
    ...
    return BaseRestTester.restHelper.put(url, new java.io.ByteArrayInputStream(org.duracloud.integration.durastore.rest.TestContentRest.CONTENT.getBytes()), "text/plain", headers);
}