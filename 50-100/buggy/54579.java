...
public org.apache.lucene.index.PointValues.Relation compare(byte[] minPackedValue, byte[] maxPackedValue) {
    for (int dim = 0; dim < 2; ++dim) {
        if (((org.apache.lucene.util.StringHelper.compare(3, uniquePointValue[0], 0, maxPackedValue, (dim * 3))) > 0) || ((org.apache.lucene.util.StringHelper.compare(3, uniquePointValue[0], 0, minPackedValue, (dim * 3))) < 0)) {
