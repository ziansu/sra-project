...
com.alesharik.webserver.control.dashboard.websocket.WebSocketSender webSocketSender) {
    ...
    try {
        ...
        constructor = com.alesharik.webserver.control.dashboard.websocket.DashboardWebSocketPluginManager.plugins.get(name).getConstructor(com.alesharik.webserver.control.dashboard.websocket.WebSocketSender.class);
