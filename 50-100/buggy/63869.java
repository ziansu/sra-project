...
long id) {
    ...
    com.projectx.main.ServiceController.ServiceResponse response = new com.projectx.main.ServiceController.ServiceResponse(service);
    com.projectx.main.ServiceController.logger.debug("Getting info for service {} is successful, info: {}", id, response);
