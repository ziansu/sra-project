public static ratpack.thymeleaf3.Template thymeleafTemplate(java.util.Map<java.lang.String, ?> model, java.lang.String name, java.lang.String contentType, org.thymeleaf.fragment.IFragmentSpec fragmentSpec) {
    ...
    return new ratpack.thymeleaf3.Template(name, context, contentType, fragmentSpec);
}