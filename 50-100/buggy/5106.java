...
public void findByTenantIdAndType() throws java.lang.Exception {
    org.springframework.data.domain.Page<net.smartcosmos.dao.things.domain.ThingEntity> entityPage = repository.findByTenantIdAndTypeIgnoreCase(tenantId, type, null);
