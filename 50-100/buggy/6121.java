...
public java.util.List<ru.aviaj.model.Place> handle(java.sql.ResultSet resultSet) throws java.sql.SQLException {
    ...
    while (resultSet.next()) {
        bufferPlaceList.add(new ru.aviaj.model.Place(resultSet.getLong("id"), resultSet.getString("title"), resultSet.getString("description"), resultSet.getDouble("longitude"), resultSet.getDouble("latitude")));
    } 
