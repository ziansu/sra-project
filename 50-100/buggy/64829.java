...
public boolean onPrepareOptionsMenu(android.view.Menu menu) {
    ...
    boolean collectingData = android.preference.PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getBoolean(Preferences.PREFERENCE_COLLECTING_DATA, true);
