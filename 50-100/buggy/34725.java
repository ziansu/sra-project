...
public void setupClient() {
    ...
    adapter = new org.jclouds.virtualbox.compute.VirtualBoxComputeServiceAdapter(manager, new org.jclouds.location.suppliers.JustProvider(com.google.common.collect.ImmutableSet.<java.lang.String>of(), provider, java.net.URI.create(endpoint)), iMachineToImage);
}