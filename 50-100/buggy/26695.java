...
public seedu.commando.logic.commands.CommandResult execute() throws seedu.commando.commons.exceptions.IllegalValueException, seedu.commando.logic.commands.NoEventsCenterException {
    ...
    if (!(commandWord.isEmpty())) {
        seedu.commando.commons.core.Config.getUserGuideAnchorForCommandWord(commandWord).orElseThrow(() -> new seedu.commando.commons.exceptions.IllegalValueException(Messages.UNKNOWN_COMMAND_FOR_HELP));
    }
