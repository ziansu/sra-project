...
public void storeDataRecordMetaDataWithNoID() {
    ...
    try {
        ...
        nl.dtl.fairmetadata4j.model.DataRecordMetadata mdata = fairMetaDataService.retrieveDataRecordMetadata(valueFactory.createIRI(ExampleFilesUtils.DATARECORD_URI));
