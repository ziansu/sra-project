public static java.lang.String concat(java.lang.String path1, java.lang.String path2) {
    ...
    path1 = org.trustedanalytics.cfbroker.store.hdfs.helper.DirHelper.removeTrailingSlashes(path1);
    path2 = org.trustedanalytics.cfbroker.store.hdfs.helper.DirHelper.removeLeadingSlashes(path2);
    return (path1 + "/") + path2;
}