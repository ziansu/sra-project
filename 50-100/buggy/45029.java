private static com.breezejs.hib.CriteriaResult createCriterion(org.hibernate.Criteria crit, com.breezejs.query.AndOrPredicate pred) {
    ...
    for (com.breezejs.query.Predicate subPred : pred.getPredicates()) {
        com.breezejs.hib.CriteriaResult cr = com.breezejs.hib.CriteriaBuilder.toCriterion(nextCrit, subPred);
        j.add(cr.criterion);
