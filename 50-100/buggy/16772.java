public com.sun.tools.javac.util.List<com.sun.tools.javac.tree.JCTree> transform(com.redhat.ceylon.compiler.typechecker.tree.Tree.AttributeGetterDefinition decl) {
    ...
    return com.redhat.ceylon.compiler.codegen.AttributeDefinitionBuilder.getter(this, name, decl.getDeclarationModel()).modifiers(transformAttributeGetSetDeclFlags(decl)).getterBlock(body).build();
}