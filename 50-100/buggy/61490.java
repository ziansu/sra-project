...
public void createPhaseManager() {
    phaseManager = new tddtrainer.logic.PhaseManager(new tddtrainer.tracking.TrackingManager(), new tddtrainer.gui.catalog.ExerciseSelector(new tddtrainer.catalog.FakeCatalogDatasource(), null), new com.google.common.eventbus.EventBus());
