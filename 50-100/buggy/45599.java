private static java.util.List<org.apache.hadoop.hbase.KeyValue> getSortedRowMapping(org.apache.hadoop.hbase.client.Result row) throws java.io.IOException {
    ...
    for (org.apache.hadoop.hbase.Cell c : row.listCells()) {
        map.add(new org.apache.hadoop.hbase.KeyValue(org.apache.hadoop.hbase.CellUtil.cloneRow(c), org.apache.hadoop.hbase.CellUtil.cloneFamily(c), org.apache.hadoop.hbase.CellUtil.cloneQualifier(c), org.apache.hadoop.hbase.CellUtil.cloneValue(c)));
    }
    return map;
}