public void displayYoutubeUploads() {
    ...
    net.computingtutor.robert.computingtutor.PlaylistGetter UploadsPlaylistGetter = new net.computingtutor.robert.computingtutor.PlaylistGetter(getApplicationContext(), lv, youtubeUploads, activityLayout);
