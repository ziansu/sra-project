...
public void parseSimpleTableWithSimgleColumn() {
    ...
    org.junit.Assert.assertThat(tableFormatter.rightPadding(0, 0), org.hamcrest.CoreMatchers.is(((10 + 1) - 6)));
    org.junit.Assert.assertThat(tableFormatter.rightPadding(1, 0), org.hamcrest.CoreMatchers.is(1));
}