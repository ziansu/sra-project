public void start() {
    ...
    org.genepattern.server.executor.awsbatch.AWSBatchJobRunner.batchToGPStatusMap.put("SUBMITTED", DrmJobState.GP_PROCESSING);
    org.genepattern.server.executor.awsbatch.AWSBatchJobRunner.batchToGPStatusMap.put("PENDING", DrmJobState.GP_PROCESSING);
