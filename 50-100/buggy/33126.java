...
java.util.Optional<java.lang.Long> pageSize) {
    uk.gov.register.presentation.resource.Pagination pagination = new uk.gov.register.presentation.resource.Pagination("/records", pageIndex, pageSize, queryDAO.getTotalRecords());
