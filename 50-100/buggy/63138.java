...
public java.util.List<com.github.rinde.rinsim.geom.Point> getShortestPathTo(com.github.rinde.rinsim.geom.Point from, com.github.rinde.rinsim.geom.Point to) {
    com.google.common.base.Preconditions.checkArgument(isPointInBoundary(from), ("from must be within the predefined boundary of the plane, from is %s, " + "boundary: min %s, max %s."), to, min, max);
