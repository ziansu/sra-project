public static java.util.List<java.util.List<java.lang.String>> createSentencesFromText(java.lang.String document) throws eu.innovationengineering.lang.exceptions.LanguageException {
    ...
    for (java.lang.String sentence : senteces) {
        sentecesList.add(eu.innovation.engineering.LSA.keywordExtractor.LSACosineKeywordExtraction.cleanAndSplitSentence(sentence, lemmatizer));
    }
    return sentecesList;
}