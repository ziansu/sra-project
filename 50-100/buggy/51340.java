private void updatePokemonImages(com.pokemonbattlearena.android.engine.match.BattlePokemon self, com.pokemonbattlearena.android.engine.match.BattlePokemon opponent) {
    ...
    mOpponentBattleView.setActivePokemon(opponent.getOriginalPokemon(), getDrawableForPokemon(self.getOriginalPokemon().getName(), com.pokemonbattlearena.android.fragments.battle.BattleHomeFragment.typePokemon));
}