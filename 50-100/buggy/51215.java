...
public void testInvalidMapRecursiveType() throws java.lang.Exception {
    ...
    byte[] bytes = mapper.writeValueAsBytes(com.google.common.collect.ImmutableMap.of("project", "test", "collection", "test", "api", api, "properties", com.google.common.collect.ImmutableMap.of("test0", "test", "test1", com.google.common.collect.ImmutableMap.of("test", com.google.common.collect.ImmutableList.of("test")), "test2", false)));
