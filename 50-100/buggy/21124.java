private static void restoreDeviceInfo() {
    ...
    if ((com.cmcc.uiautomator.MiguUiAutomator.userType) == 3) {
        ...
        com.cmcc.uiautomator.MiguUiAutomator.jedis.rpush((((com.cmcc.uiautomator.MiguUiAutomator.userName) + "_") + (com.cmcc.uiautomator.MiguUiAutomator.redis_key)), json_device);
    }
}