...
public void testSelectBestPoolNoPools() {
    ...
    assertEquals(null, autobindRules.selectBestPools(consumer, new java.lang.String[]{ org.candlepin.policy.AutobindRulesTest.HIGHEST_QUANTITY_PRODUCT }, new java.util.LinkedList<org.candlepin.model.Pool>(), compliance, null, new java.util.HashSet<java.lang.String>(), false));
}