private void validateCustomMethods(com.blackbuild.groovy.configdsl.transform.ast.BlockStatement block) {
    ...
    for (com.blackbuild.groovy.configdsl.transform.ast.MethodNode method : annotatedClass.getMethods()) {
        com.blackbuild.groovy.configdsl.transform.ast.AnnotationNode validateAnnotation = com.blackbuild.groovy.configdsl.transform.ast.ASTHelper.getAnnotation(method, com.blackbuild.groovy.configdsl.transform.ast.DSLASTTransformation.VALIDATE_ANNOTATION);
