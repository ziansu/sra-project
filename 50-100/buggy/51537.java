public void run(org.eclipse.jface.action.IAction action) {
    ...
    try {
        br.unb.cic.rtgoretoprism.generator.goda.producer.RTGoreProducer producer = new br.unb.cic.rtgoretoprism.generator.goda.producer.RTGoreProducer(selectedActors, selectedGoals, sourceFolder, targetFolder);
        producer.run();
