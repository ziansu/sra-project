private long getCleanupTimeSeconds() {
    try {
        ...
        org.ow2.proactive.scheduler.task.utils.TaskKiller.LOGGER.warn(((("proactive.task.cleanup.time: " + (java.lang.System.getProperty("proactive.task.cleanup.time"))) + " is not parsable to long, fallback to default value. Error : ") + (e.getMessage())));
        return org.ow2.proactive.scheduler.task.utils.TaskKiller.CLEANUP_TIME_DEFAULT_SECONDS;
    }
}