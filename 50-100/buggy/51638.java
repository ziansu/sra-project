...
java.lang.Integer limit) throws dk.statsbiblioteket.doms.updatetracker.webservice.InvalidCredentialsException, dk.statsbiblioteket.doms.updatetracker.webservice.MethodFailedException {
    java.util.List<dk.statsbiblioteket.doms.updatetracker.improved.database.Entry> entries = dk.statsbiblioteket.doms.updatetracker.improved.Meat.getStore().lookup(new java.util.Date(beginTime), viewAngle, offset, limit, false);
