private static java.lang.String resolveJsonUnitAliases(java.lang.String body) {
    while (body.contains(com.sberbank.pfm.test.concordion.extensions.exam.PlaceholdersResolver.PREFIX_JSON_UNIT_ALIAS)) {
        ...
        original = original.replace((((com.sberbank.pfm.test.concordion.extensions.exam.PlaceholdersResolver.PREFIX_JSON_UNIT_ALIAS) + alias) + (com.sberbank.pfm.test.concordion.extensions.exam.PlaceholdersResolver.POSTFIX)), com.sberbank.pfm.test.concordion.extensions.exam.PlaceholdersResolver.toJsonUnit(alias));
        body = original;
    } 
    return body;
}