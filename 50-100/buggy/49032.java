...
public void run() {
    ...
    android.support.v17.leanback.widget.HeaderItem header = new android.support.v17.leanback.widget.HeaderItem(0, getResources().getString(R.string.search_results), null);
