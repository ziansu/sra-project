...
public void onCreate(android.os.Bundle savedInstanceState) {
    ...
    if ((getArguments()) != null) {
        ...
        location = ((com.geoculturedemo.nickstamp.geoculturedemo.Model.Location) (getArguments().getSerializable(com.geoculturedemo.nickstamp.geoculturedemo.Fragment.SongListFragment.ARG_LOCATION)));
    }
}