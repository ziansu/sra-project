...
java.lang.String clase) {
    try {
        if ((logica.ControladoraCaso.obtenerInvolucrado(usuarioActual, iUE, cedula)) != null)
            return "duplicado";
        
        logica.ControladoraCaso.agregarInvolucrado(usuarioActual, iUE, fechaDeNacimiento, nombre, cedula, nacionalidad, domicilio, clase);
