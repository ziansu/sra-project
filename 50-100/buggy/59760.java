...
public com.tr.rp.core.LanguageElement visitRanked_choice(com.tr.rp.parser.DefProgParser.Ranked_choiceContext ctx) {
    ...
    com.tr.rp.core.DStatement a = ((com.tr.rp.core.DStatement) (visitStatement(ctx.statement().get(0))));
    com.tr.rp.core.DStatement b = ((com.tr.rp.core.DStatement) (visitStatement(ctx.statement().get(1))));
