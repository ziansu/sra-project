...
public void testDropOrganization() throws java.lang.Exception {
    ...
    client.target(TARGET_URI).path((((io.lumeer.engine.rest.OrganizationServiceIntegrationTest.PATH_PREFIX) + "id/") + id)).request(MediaType.APPLICATION_JSON).buildDelete().invoke();
