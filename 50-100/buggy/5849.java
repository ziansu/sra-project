public static void load(mcp.mobius.waila.api.IWailaRegistrar registrar) {
    ...
    if (!(com.sixteencolorgames.supertechtweaks.compat.waila.WailaCompatibility.loaded)) {
        registrar.registerHeadProvider(com.sixteencolorgames.supertechtweaks.compat.waila.WailaCompatibility.INSTANCE, com.sixteencolorgames.supertechtweaks.blocks.BlockOre.class);
        ...
        registrar.registerTailProvider(com.sixteencolorgames.supertechtweaks.compat.waila.WailaCompatibility.INSTANCE, com.sixteencolorgames.supertechtweaks.blocks.BlockOre.class);
