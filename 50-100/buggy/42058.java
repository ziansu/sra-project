public void done(boolean result, samurai.geeft.android.geeft.adapters.GeeftItemAdapter.ViewHolder holder, double[] userInformation) {
    if (result) {
        ...
        holder.mProfileDialogUserGiven.setText(java.lang.String.valueOf(userInformation[1]));
        holder.mProfileDialogUserReceived.setText(java.lang.String.valueOf(userInformation[2]));
    }else {
