private static void validateUnicastXorMulticast(uk.co.real_logic.aeron.common.uri.AeronUri uri) {
    ...
    if (!(hasMulticastKeys ^ hasUnicastKeys)) {
        ...
        throw new java.lang.IllegalArgumentException(java.lang.String.format(msg, java.util.Arrays.toString(uk.co.real_logic.aeron.driver.UdpChannel.MULTICAST_KEYS), java.util.Arrays.toString(uk.co.real_logic.aeron.driver.UdpChannel.UNICAST_KEYS)));
    }
}