...
public com.denimgroup.threadfix.remote.response.RestResponse<java.lang.String> resolveRestException(java.lang.Exception ex) {
    ...
    assert ex instanceof com.denimgroup.threadfix.exception.RestException;
    return com.denimgroup.threadfix.remote.response.RestResponse.failure(((com.denimgroup.threadfix.exception.RestException) (ex)).getResponseString());
}