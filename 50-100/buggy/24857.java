private static org.silverpeas.components.projectmanager.model.TaskResourceDetail getTaskResourceDetailFromResultset(java.sql.ResultSet rs) throws java.sql.SQLException {
    ...
    org.silverpeas.components.projectmanager.model.TaskResourceDetail resourceDetail = new org.silverpeas.components.projectmanager.model.TaskResourceDetail(id, taskId, userId, charge, instanceId);
