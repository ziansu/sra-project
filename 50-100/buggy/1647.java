public void checkPermissions() {
    ...
    if (((permissionCoarseLocationCheck) != (android.content.pm.PackageManager.PERMISSION_GRANTED)) || ((permissionFineLocationCheck) != (android.content.pm.PackageManager.PERMISSION_DENIED))) {
