...
public void getCovariateTestData() throws org.drugis.addis.trialverse.service.impl.ReadValueException {
    ...
    java.util.Map<java.net.URI, org.drugis.addis.trialverse.CovariateStudyValue> result = triplestoreService.getStudyLevelCovariateValues(namespaceUid, version, java.util.Arrays.asList(CovariateOption.ALLOCATION_RANDOMIZED));
