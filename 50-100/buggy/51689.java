void addNewPart(java.lang.String instrName, int staffSpan, com.xenoage.zong.core.Score comp) {
    ...
    cursorList.add(((parts)++), new io_handler.Quill(new com.xenoage.zong.io.selection.Cursor(currentComp, com.xenoage.zong.core.position.MP.mp(1, 0, 0, com.xenoage.utils.math.Fraction._0, 0), true), instrName));
}