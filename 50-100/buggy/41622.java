private void updateValuesFromBundle(android.os.Bundle savedInstanceState) {
    ...
    if (savedInstanceState != null) {
        if (savedInstanceState.keySet().contains(edu.cornell.jjl.info4120final.MainActivity.REQUESTING_LOCATION_UPDATES_KEY)) {
            mRequestingUpdates = savedInstanceState.getBoolean(edu.cornell.jjl.info4120final.MainActivity.REQUESTING_LOCATION_UPDATES_KEY);
        }
