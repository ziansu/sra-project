...
public void testCustomJobConfigParams() {
    ...
    org.junit.Assert.assertEquals("executor.props for test_user", "PbsBigMem", gpConfig.getGPProperty(userContext, "executor.props"));
    ...
    org.junit.Assert.assertNotNull("initJobConfigParams was null", jobConfigParams);
}