...
public ua.artcode.model.response.RunResults runMain(ua.artcode.model.ExternalCode code) throws java.lang.Exception {
    ...
    ua.artcode.model.response.RunResults runResults = runCore.run(sourcesRoot, new java.lang.String[]{ sourcesRoot }, new java.lang.String[]{ path }, new java.lang.String[]{  }, PreProcessors.singleClass, MethodCheckers.main, Runners.main, ResultsProcessors.main);
