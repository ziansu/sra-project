public java.util.List<com.macklive.objects.Message> getMessagesForGameAfterDate(long gameId, java.util.Date date) {
    ...
    q.setFilter(com.google.appengine.api.datastore.Query.CompositeFilterOperator.and(new com.google.appengine.api.datastore.Query.FilterPredicate("owner", com.google.appengine.api.datastore.Query.FilterOperator.EQUAL, userService.getCurrentUser().getUserId()), new com.google.appengine.api.datastore.Query.FilterPredicate("game", com.google.appengine.api.datastore.Query.FilterOperator.EQUAL, game), new com.google.appengine.api.datastore.Query.FilterPredicate("time", com.google.appengine.api.datastore.Query.FilterOperator.GREATER_THAN, date)));
