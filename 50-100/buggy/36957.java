private static java.util.List<java.lang.String> executeCommand(java.lang.String cmd) {
    try {
        pt.ulisboa.tecnico.amorphous.requestrouter.lvs.LVSImplementation.logger.debug(("executing command: " + cmd));
        ...
        for (java.lang.String rline : result)
            pt.ulisboa.tecnico.amorphous.requestrouter.lvs.LVSImplementation.logger.debug(rline);
