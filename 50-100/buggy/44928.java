static com.google.api.services.calendar.Calendar loadCalendarClient() throws java.io.IOException {
    java.lang.String userId = com.google.appengine.api.users.UserServiceFactory.getUserService().getCurrentUser().getUserId();
