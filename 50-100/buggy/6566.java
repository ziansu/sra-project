private static org.stepik.api.objects.StudyObject getLessonStudyObject(long lessonId, long unitId) {
    org.stepik.api.objects.lessons.CompoundUnitLesson unitLesson = org.stepik.plugin.utils.Utils.getCompoundUnitLessonStudyObject(lessonId, unitId);
    ...
    if ((unit.getId()) != 0) {
        ...
        org.stepik.api.objects.sections.Section section = org.stepik.plugin.utils.Utils.getSectionStudyObject(unit.getSection(), stepikApiClient);
        if (section != null) {
