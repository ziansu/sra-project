public java.lang.String setPupilShape(com.base.game.character.GameCharacter owner, com.base.game.character.body.valueEnums.EyeShape pupilShape) {
    ...
    if (owner.isPlayer()) {
        return "<p>" + (("An irritable itchy feeling rises up into your [pc.eyes], but, much to your relief, it passes even before you're able to reach up and rub at them.</br>" + "You now have [style.boldTfGeneric([pc.pupilShape] pupils)]!") + "</p>");
    }else {
