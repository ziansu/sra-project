...
public void onChildAdded(com.google.firebase.database.DataSnapshot dataSnapshot, java.lang.String prevChildKey) {
    ...
    mGoogleMap.addMarker(new com.google.android.gms.maps.model.MarkerOptions().position(newLocation).title(dataSnapshot.child(("title" + ("\n" + "date"))).getValue(java.lang.String.class)));
}