public static java.lang.String openPDF(java.lang.String source) throws java.io.IOException {
    ...
    java.lang.System.out.println(((("newdocument: " + (application.PdfDocumentcreation.myDocument.getNumberOfPages())) + " ") + (application.PdfDocumentcreation.myDocument.toString())));
