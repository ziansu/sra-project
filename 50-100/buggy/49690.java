...
public java.lang.String getStateVerificatorShortName() {
    ...
    java.lang.String fullName = (((((stateVerificatorEmployee.getLastName()) + " ") + (stateVerificatorEmployee.getFirstName().charAt(0))) + ".") + (stateVerificatorEmployee.getMiddleName().charAt(0))) + ".";
    return fullName;
}