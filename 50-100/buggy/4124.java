public static java.lang.String isIdExist(final java.lang.String newId) throws org.parse4j.ParseException {
    ...
    return (data.management.DBManager.getObjectFieldsByKey(objectClass, key).get("id")) + "";
}