...
public void onSensorChanged(android.hardware.SensorEvent event) {
    if ((event.sensor.getType()) == (android.hardware.Sensor.TYPE_ACCELEROMETER)) {
        ...
        wr.appendData(io.github.kajdreef.smartphonesensing.Sensor.Accelerometer.gravity[0], io.github.kajdreef.smartphonesensing.Sensor.Accelerometer.gravity[1], io.github.kajdreef.smartphonesensing.Sensor.Accelerometer.gravity[2], io.github.kajdreef.smartphonesensing.Sensor.Accelerometer.state);
