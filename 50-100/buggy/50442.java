@java.lang.Override
public org.eclipse.core.runtime.IStatus addArtifactRepository(java.net.URI location, int flags) {
    try {
        getArtifactRepositoryManager().loadRepository(location, flags, null);
