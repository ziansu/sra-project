...
public boolean allows(com.intellij.openapi.vfs.VirtualFile file) {
    for (java.lang.String ignorePattern : ignorePatterns) {
        ...
        if (matches) {
            com.crownpartners.intellivault.filter.VaultImportFilter.log.info(java.lang.String.format("Skipping file %s, matched ignore pattern %s.", new java.lang.String[]{ file.getCanonicalPath() , ignorePattern }));
            return false;
        }
    }
    return true;
