...
public void moveOutOfBoundsTest() throws java.lang.Exception {
    ...
    drop.add(0);
    drop.add(1);
    johnholiver.game.move.Move move2 = new johnholiver.game.move.Move(board, p1, 0, 0, johnholiver.game.move.Direction.DOWN, drop);
