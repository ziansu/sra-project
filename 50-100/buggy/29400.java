...
public void testCheckSenderPartyTrust() throws java.lang.Exception {
    ...
    org.junit.Assert.assertTrue(trustSenderInterceptor.checkSenderPartyTrust(certificate, "GlobalSign", "messageID123"));
    org.junit.Assert.assertFalse(trustSenderInterceptor.checkSenderPartyTrust(certificate, "test sender", "messageID123"));
}