public void transformPropertyReference(cc.kave.commons.model.ssts.expressions.simple.IReferenceExpression expr) {
    ...
    cc.kave.commons.model.ssts.references.IFieldReference fieldReference = fieldReferenceToLocalField(createPropertyFieldName(propertyReference.getPropertyName()));
