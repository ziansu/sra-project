...
public void onItemClickListener(com.bitdubai.fermat_cht_api.layer.sup_app_module.interfaces.chat_actor_community.interfaces.ChatActorCommunityInformation data, int position) {
    try {
        ...
        com.bitdubai.sub_app.chat_community.common.popups.AcceptDialog notificationAcceptDialog = new com.bitdubai.sub_app.chat_community.common.popups.AcceptDialog(getActivity(), appSession, appResourcesProviderManager, data, moduleManager.getSelectedActorIdentity());
