...
public void testParseModelConstants() {
    ...
    try {
        com.verivital.hyst.ir.Configuration c = com.verivital.hyst.junit.ModelParserTest.flatten(com.verivital.hyst.importer.SpaceExImporter.importModels((path + "const_model.cfg"), (path + "const_model.xml")));
