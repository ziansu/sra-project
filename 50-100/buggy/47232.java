private static java.lang.String findLevelName(int level) {
    java.util.TreeSet<java.lang.Integer> allLevels = new java.util.TreeSet<java.lang.Integer>(com.baalam.mobile.exercisebooster.util.UserLevel.levelsNames.keySet());
