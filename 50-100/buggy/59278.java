...
protected void onRestoreInstanceState(android.os.Parcelable state) {
    ...
    setPattern(com.andrognito.patternlockview.PatternLockView.PatternViewMode.CORRECT, com.andrognito.patternlockview.utils.PatternLockUtils.stringToPattern(savedState.getSerializedPattern()));
