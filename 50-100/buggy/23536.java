...
public io.seldon.clustering.recommender.ClustersCounts retrieve() throws java.lang.Exception {
    io.seldon.clustering.recommender.CountRecommender.logger.debug(((("Trying to get top counts for tag and dimension from db : testMode is for client " + (client)) + " dimension:") + dimension));
