private com.amazon.speech.speechlet.SpeechletResponse apaLagiMauResponse(com.amazon.speech.speechlet.Session session) {
    ...
    session.removeAttribute(com.tss.carkak.temperature.TemperatureSpeechlet.TEMPERATURE_STAGE);
    session.removeAttribute(com.tss.carkak.temperature.TemperatureSpeechlet.DECREASE_TEMP_STAGE);
