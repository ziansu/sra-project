private void onActionStop() {
    ...
    actionBar.addAction(actionBarActions.get(com.quran.labs.androidquran.QuranViewActivity.ACTION_CHANGE_READER), 1);
    actionBar.addAction(actionBarActions.get(com.quran.labs.androidquran.QuranViewActivity.ACTION_JUMP_TO_AYAH), 2);
    playing = false;
}