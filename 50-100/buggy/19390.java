...
com.google.android.gms.common.ConnectionResult connectionResult) {
    android.widget.Toast.makeText(getActivity(), "An error has occurred.", Toast.LENGTH_SHORT).show();
    android.app.PendingIntent resolution = com.google.android.gms.common.GoogleApiAvailability.getInstance().getErrorResolutionPendingIntent(getActivity(), connectionResult.getErrorCode(), com.firebase.ui.auth.util.signincontainer.SaveSmartLock.RC_UPDATE_SERVICE);
    try {
