...
public com.klq.logic.IKLQItem visit(com.klq.ComputedQuestionNode node) {
    ...
    return new com.klq.Question(id, type, null, text, new java.util.ArrayList<com.klq.logic.expression.AExpression>(), new com.klq.Answer(node.getChild().accept(this).toString()));
}