public void testConvertOptionalFunctionParameters() throws java.lang.Exception {
    ...
    assertParseTypeAndConvert("function(?string=, number=)").isEqualTo(com.google.javascript.jscomp.parsing.TypeDeclarationsIRFactory.functionType(com.google.javascript.jscomp.parsing.TypeDeclarationsIRFactory.anyType(), parameters));
}