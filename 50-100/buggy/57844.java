...
java.lang.Long appointmentStartTime) throws com.mahdi.myapp.exception.DocException {
    ...
    com.mahdi.myapp.model.Bookings booking = com.mahdi.myapp.util.DocUtils.getBooking(appointmentStartTime, doctorProfile, patientProfile, "Reason", bookingStatusService.getRowByName("code", "2"));
