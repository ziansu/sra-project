...
eu.fraho.spring.securityJwt.ut.service.JwtRefreshCookieConfiguration refreshCookieConfiguration) {
    eu.fraho.spring.securityJwt.service.JwtTokenServiceImpl tokenService = new eu.fraho.spring.securityJwt.service.JwtTokenServiceImpl(tokenConfiguration, refreshConfiguration, () -> jwtUser, tokenCookieConfiguration, tokenHeaderConfiguration, refreshCookieConfiguration);
