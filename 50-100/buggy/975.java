...
java.lang.String inputNumber) throws java.net.URISyntaxException {
    ...
    return menuBuilder(ussdGroupUtil.askForGroupNoInlineNew(user, za.org.grassroot.webapp.controller.ussd.USSDVoteController.thisSection, groupsExistPrompt, groupsDontExistPrompt, "issue", ((groupMenus) + "create"), null));
}