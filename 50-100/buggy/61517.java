private eu.geekhome.asymptote.model.PWMImpulseSyncUpdate findPwmImpulseUpdate(int channel, java.util.ArrayList<eu.geekhome.asymptote.model.SyncUpdate> updates) {
    if ((updates.size()) > 0) {
