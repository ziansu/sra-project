...
public void configure() throws java.lang.Exception {
    ...
    from(net.technolords.micro.route.RestServiceRoute.DIRECT_MAIN).log(LoggingLevel.DEBUG, LOGGER, "Current headers: ${headers}").log(LoggingLevel.DEBUG, LOGGER, "Current body: ${body}").process(this.responseProcessor);
}