...
public void afterClosingWeGetAfreshLink() throws java.lang.Exception {
    ...
    org.junit.Assert.assertThat(link3, org.hamcrest.core.IsNot.not(org.hamcrest.core.IsSame.sameInstance(link1)));
    org.junit.Assert.assertThat(link3, org.hamcrest.core.IsNot.not(org.hamcrest.core.IsSame.sameInstance(link2)));
    close(link3);
}