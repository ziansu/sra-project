...
ir.asparsa.hobbytaste.ui.fragment.content.BaseContentFragment fragment) {
    try {
        fragmentManager.beginTransaction().setCustomAnimations(R.anim.come, R.anim.back).replace(R.id.content, fragment, fragment.getTagName()).addToBackStack(fragment.getTagName()).commit();
