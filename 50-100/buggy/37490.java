private static void initDatabase() {
    ...
    vn.com.solution.ntq.glastool.dao.DatabaseAccess.USING_CHAT_DB_DATABASE = vn.com.solution.ntq.glastool.dao.DatabaseAccess.MONGO_CLIENT.getDatabase(Constant.DB.using_chat_db.name());
}