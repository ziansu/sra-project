public static com.stratio.crossdata.common.logicalplan.Filter createFilter(java.lang.String catalogName, java.lang.String tableName, java.lang.String columnName, com.stratio.crossdata.common.statements.structures.Operator operator, java.lang.Boolean data, boolean indexed) {
    ...
    com.stratio.crossdata.common.statements.structures.BooleanSelector rightSelector = new com.stratio.crossdata.common.statements.structures.BooleanSelector(data);
