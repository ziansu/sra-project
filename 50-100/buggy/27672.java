public java.util.Map<java.lang.Integer, edu.rutgers.MOST.data.SBMLReaction> createCompartmentIdReactionMap(edu.rutgers.MOST.data.ReactionFactory f, java.util.Vector<edu.rutgers.MOST.data.SBMLReaction> rxns) {
