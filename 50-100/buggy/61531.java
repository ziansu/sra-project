private NetconfDevice.SchemaResourcesDTO createSchemaResourcesDTO(final java.lang.String moduleSchemaCacheDirectory, final java.lang.String instanceName) {
    final org.opendaylight.yangtools.yang.parser.repo.SharedSchemaRepository repository = new org.opendaylight.yangtools.yang.parser.repo.SharedSchemaRepository(instanceName);
