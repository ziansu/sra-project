public void loadDrivesAndTrips() {
    ...
    if ((((com.microsoft.loop.triptracker.utils.LoopUtils.getTrips().size()) > 0) || (!(ms.loop.loopsdk.core.LoopSDK.isInitialized()))) || (android.text.TextUtils.isEmpty(LoopSDK.userId))) {
        updateTripsInUI();
        return ;
    }
