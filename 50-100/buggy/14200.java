...
com.intellij.openapi.fileTypes.impl.VirtualFile file, int flags) {
    ...
    try {
        try {
            stream.writeByte((flags & ((com.intellij.openapi.fileTypes.impl.FileTypeManagerImpl.AUTO_DETECTED_AS_TEXT_MASK) | (com.intellij.openapi.fileTypes.impl.FileTypeManagerImpl.AUTO_DETECTED_AS_BINARY_MASK))));
        } finally {
            stream.close();
        }
