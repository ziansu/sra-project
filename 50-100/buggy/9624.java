...
public void theUserReceiveAGoodQualificationThenYourPointsIncreaseAt500() {
    unq.tpi.desapp.grupof.model.GoodQualification goodQualification = org.mockito.Mockito.mock(unq.tpi.desapp.grupof.model.GoodQualification.class);
    org.mockito.Mockito.when(goodQualification.getPoints()).thenReturn(500);
