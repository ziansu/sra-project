public static void logEvent(org.slf4j.ext.EventData data) {
    if (org.slf4j.ext.EventLogger.eventLogger.instanceofLAL) {
        ((org.slf4j.spi.LocationAwareLogger) (org.slf4j.ext.EventLogger.eventLogger.logger)).log(org.slf4j.ext.EventLogger.EVENT_MARKER, org.slf4j.ext.EventLogger.FQCN, LocationAwareLogger.INFO_INT, data.toXML(), null, null);
    }else {
