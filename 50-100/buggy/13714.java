protected static void stopWaiting() {
    ...
    org.gridchem.client.gui.filebrowser.FileBrowserImpl.topURIPanel.setEnabled(true);
    org.gridchem.client.gui.filebrowser.FileBrowserImpl.stopButton.setEnabled(false);
}