...
public synchronized void onCreate(android.database.sqlite.SQLiteDatabase db) {
    ...
    addGeocoder(de.blau.android.prefs.AdvancedPrefDatabase.ID_DEFAULT_GEOCODER_NOMINATIM, de.blau.android.prefs.AdvancedPrefDatabase.ID_DEFAULT_GEOCODER_NOMINATIM, de.blau.android.prefs.AdvancedPrefDatabase.GeocoderType.NOMINATIM, 0, Urls.DEFAULT_NOMINATIM_SERVER, true);
    addGeocoder(de.blau.android.prefs.AdvancedPrefDatabase.ID_DEFAULT_GEOCODER_PHOTON, de.blau.android.prefs.AdvancedPrefDatabase.ID_DEFAULT_GEOCODER_PHOTON, de.blau.android.prefs.AdvancedPrefDatabase.GeocoderType.PHOTON, 0, Urls.DEFAULT_PHOTON_SERVER, true);
}