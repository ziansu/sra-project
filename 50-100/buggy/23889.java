...
public void onDeleteItemClicked(com.gmail.markdevw.wetube.adapters.PlaylistItemAdapter itemAdapter, com.gmail.markdevw.wetube.api.model.PlaylistItem playlistItem) {
    ...
    messageService.sendMessage(com.gmail.markdevw.wetube.WeTubeApplication.getSharedDataSource().getCurrentRecipient().getId(), (("deleteitemplaylist" + (msgSplitter)) + (java.lang.String.valueOf(index))));
}