@java.lang.Override
protected java.util.function.Function<io.gravitee.gateway.api.buffer.Buffer, io.gravitee.gateway.api.buffer.Buffer> transform() throws io.gravitee.gateway.api.stream.exception.TransformationException {
    return ( buffer) -> {
