...
public void setInventorySlotContents(net.minecraft.inventory.IInventory inventory, int slotId, net.minecraft.item.ItemStack stack) {
    ...
    if (stack == null) {
        riskyken.armourersWorkshop.api.common.skin.type.ISkinType skinType = riskyken.armourersWorkshop.common.skin.type.SkinTypeHelper.getSkinTypeForSlot(slotId);
