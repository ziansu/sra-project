...
java.lang.Integer sellCaseId, @org.springframework.web.bind.annotation.RequestParam(value = "purchaseCaseIds", required = true)
java.lang.String[] purchaseCaseIds) {
    ...
    return com.jersey.sellCase.controller.SellCaseController.REDIRECT_ADD_PURCHASE_CASE.replace("{id}", sellCaseId.toString());
}