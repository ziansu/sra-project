public static boolean isIntentChromeOrFirstParty(android.content.Intent intent, android.content.Context context) {
    ...
    if (org.chromium.chrome.browser.externalauth.ExternalAuthUtils.getInstance().isGoogleSigned(context.getPackageManager(), org.chromium.base.ApiCompatibilityUtils.getCreatorPackage(token))) {
        return true;
    }
    return false;
}