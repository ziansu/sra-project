...
public void validate_shouldFailValidationIfAllFieldsNull() throws org.openmrs.validator.Expection {
    ...
    org.junit.Assert.assertTrue(errors.hasFieldErrors("retireReason"));
}