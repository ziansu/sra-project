private void addMetaDataToBuilder(org.hibernate.validator.metadata.raw.ConstrainedElement constrainableElement, java.util.Set<org.hibernate.validator.metadata.aggregated.BeanMetaDataImpl.BuilderDelegate> builders) {
    ...
    builders.add(new org.hibernate.validator.metadata.aggregated.BeanMetaDataImpl.BuilderDelegate(constrainableElement, ((((defaultGroupSequence) != null) && ((defaultGroupSequence.size()) > 1)) || ((defaultGroupSequenceProvider) != null)), defaultGroupSequence, constraintHelper));
}