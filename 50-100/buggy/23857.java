...
public void shutdown(java.lang.String username) throws java.io.IOException {
    ...
    sendMsg = ((((com.ronger.service.util.MsgConfig.SHUTDOWN) + (com.ronger.service.util.MsgConfig.SPACE)) + (com.ronger.service.util.MsgConfig.SPACE)) + username) + (com.ronger.service.util.MsgConfig.ENTER);
    sendMsg(sendMsg);
