...
public de.cismet.cismap.commons.gui.piccolo.FeatureAnnotationSymbol getPointAnnotationSymbol() {
    if ((winkel) == null) {
        return new de.cismet.cismap.commons.gui.piccolo.FeatureAnnotationSymbol(de.cismet.cismap.commons.drophandler.builtin.MappingComponentGeoImageFileFeatureRenderer.ARROW_NULL.getImage());
    }else {
