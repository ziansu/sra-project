...
public void buildGridWithIncorrectRowNumber() throws ar.fiuba.tdd.grupo10.nikoligames.exceptions.WrongNumberOfGridCellsException {
    ar.fiuba.tdd.grupo10.nikoligames.grid.Grid buildedGrid = new ar.fiuba.tdd.grupo10.nikoligames.grid.GridBuilder().setRows(5).setColumns(2).addCells(flattenCells).buildGrid();
}