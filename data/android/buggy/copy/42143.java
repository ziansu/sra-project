...
public void computeF1score() throws java.lang.Exception {
    ...
    org.junit.Assert.assertEquals("the f1 score must be equals to : ", 0.25F, org.atilf.module.disambiguation.ComputeTotalTermsScoreTest._totalTermScore.getF1score(), 0.0F);
}