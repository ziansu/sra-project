...
java.lang.String password) throws java.lang.Exception {
    org.springframework.security.authentication.UsernamePasswordAuthenticationToken auth = new org.springframework.security.authentication.UsernamePasswordAuthenticationToken(username, password, null);
    java.lang.String token = m_tokenService.getToken(auth);
    return token;
}