...
public void apply(java.lang.Void arg) throws org.eclipse.che.api.promises.client.OperationException {
    org.eclipse.che.ide.api.debug.Breakpoint breakpoint = new org.eclipse.che.ide.api.debug.Breakpoint(Breakpoint.Type.BREAKPOINT, lineNumber, file.getPath(), file, true);
