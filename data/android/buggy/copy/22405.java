...
com.tw.apistack.endpoint.exam.dto.Exam exam) {
    org.springframework.http.HttpStatus httpStatus = (com.tw.apistack.service.ExamService.getInstance().creteExam(exam)) ? org.springframework.http.HttpStatus.OK : org.springframework.http.HttpStatus.BAD_REQUEST;
