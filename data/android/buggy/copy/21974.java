public static java.lang.String getUrl() {
    ...
    return ((com.rokid.cloudappclient.http.BaseUrlConfig.BASE_HTTP) + (com.rokid.cloudappclient.http.BaseUrlConfig.DEFAULT_HOST)) + (com.rokid.cloudappclient.http.BaseUrlConfig.SEND_EVENT_PATH);
}