...
public void intervalTooBig(java.util.Date requestedStartTime, java.util.Date requestedEndTime) {
    org.helioviewer.jhv.plugins.eveplugin.radio.data.DownloadRequestData downloadRequestData = new org.helioviewer.jhv.plugins.eveplugin.radio.data.DownloadRequestData();
