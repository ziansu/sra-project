public org.springframework.data.domain.Page<es.test.vessel.entities.Vessel> findByNameContainingAndWidthBetweenAndLengthBetweenAndDraftLessThanEqual(@org.springframework.data.repository.query.Param(value = "point")
