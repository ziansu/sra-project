public no.uio.ifi.qure.dataprovider.DBDataProvider.DBUnparsedIterator getExternalOverlapping(java.lang.String whereClause) {
    ...
    return new no.uio.ifi.qure.dataprovider.DBDataProvider.DBUnparsedIterator(total, config.limit, config.jdbcDriver, config.connectionStr, query, config.uriColumn);
}