private void scheduleKeepalive() {
    ...
    currentKeepalive = executor.schedule(new org.opendaylight.netconf.sal.connect.netconf.sal.KeepaliveSalFacade.Keepalive(), keepaliveDelaySeconds, java.util.concurrent.TimeUnit.SECONDS);
}