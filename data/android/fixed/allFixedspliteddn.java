...
public android.support.v4.app.Fragment getItem(int position) {
    return com.dailynews.dailynews.widget.fragment.PageFragment.newInstance(position, tabTitles[position]);
}
...
protected void onCreate(android.os.Bundle savedInstanceState) {
    ...
    initialize(new com.widesteppe.Controller(), config);
}
...
private void setStorageFile() {
    ...
    imagePath = ((storageDirectory + (getString(R.string.app_name))) + ".") + (com.jets.medicalreminder.edit.EditMedicineFragment.IMAGE_FORMAT);
}
...
@java.lang.Override
public void onIconClicked(final android.view.View view) {
}
...
public void selectPic(android.view.View view) {
...
android.os.Bundle savedInstanceState) {
    ...
    fragmentTransaction.replace(R.id.home_fragment_container, new pl.mirko.home.HomeFragment());
