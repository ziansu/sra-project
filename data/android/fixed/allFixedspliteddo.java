...
public void intentToRestartStart(android.view.View view) {
...
private void setSwitchWithoutTriggering(android.support.v7.widget.SwitchCompat switchCompat, boolean newState) {
...
int icon, int backgroundColor) {
    return addItem(id, icon, null, backgroundColor, org.michaelbel.material.util.Utils.dp(getContext(), 48));
}
...
public static int getTextSizeId(android.content.Context context) {
    return com.project.nghicv.readingbook.util.PreferenceUtil.getUserPreference(context, com.project.nghicv.readingbook.util.PreferenceUtil.PREF_NOTIFICATION_ID, java.lang.Integer.class, 1);
}
...
public void run() {
    ...
    builder.setTitle(R.string.missing_binaries).setMessage(getString(R.string.missing_binaries_message)).show();
}
...
public static java.lang.String getPostPath(android.content.Context context, android.net.Uri uri) throws edu.mit.mobile.android.locast.data.NoPublicPath {
    return edu.mit.mobile.android.locast.data.MediaProvider.getPublicPath(context, uri, true);
}
