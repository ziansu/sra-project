@org.springframework.web.bind.annotation.RequestMapping(value = "/{name}", method = org.springframework.web.bind.annotation.RequestMethod.POST)
public org.springframework.http.ResponseEntity<com.app.timezonediff.Timezone> addTimezone(@org.springframework.web.bind.annotation.PathVariable
