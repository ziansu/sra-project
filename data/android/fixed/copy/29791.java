...
public void shouldRunStaticCall() throws java.io.IOException, java.lang.InterruptedException, process.ProcessException {
    ...
    process.RawToProfileConverter.procedureRaw(bowtieParams, inFile, outFile, true, true, true, "GENOMEVERSION", genomeBowtie2, "resources/bowtie2/example/reads/", "resources/processTest/results/");
}