...
java.lang.String password) throws edu.pitt.apollo.exception.SerializationException, edu.pitt.apollo.exception.UnsupportedSerializationFormatException {
    return new edu.pitt.apollo.brokerservicerestfrontend.methods.SetStatusOfRunMethod(username, password, SerializationFormat.XML).setStatusOfRun(runId, statusToUpdateTo, statusMessage);
}