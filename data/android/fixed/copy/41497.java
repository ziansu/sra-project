...
public void visit(com.teamagam.gimelgimel.domain.map.entities.geometries.PointGeometry pointGeometry) {
    ...
    mResult = new com.teamagam.gimelgimel.domain.map.entities.mapEntities.PointEntity(com.teamagam.gimelgimel.domain.messages.SendGeoMessageInteractor.CreateGeoEntityVisitor.NOT_USED_ID, mMessageText.trim(), pointGeometry, symbol);
}