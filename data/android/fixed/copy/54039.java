public java.util.ArrayList<com.izik.recipebook.Recipe> setRecipesBy(java.lang.String likeExpression, boolean findThisUserRecipes) {
    java.util.ArrayList<com.izik.recipebook.Recipe> likeExpressionRecipes = com.izik.recipebook.Model.instance(mContext).GetAllUsersRecipesByLikeExp(likeExpression, findThisUserRecipes);
