...
int id) {
    return new org.springframework.http.ResponseEntity<org.springframework.hateoas.Resource<app.entities.Book>>(buildBookResource(id, "Harry Potter"), org.springframework.http.HttpStatus.OK);
}