...
public void deleteArchivedProcessInstance_by_id_should_throw_exception_when_getArchivedProcessInstance_throws_exception() throws java.lang.Exception {
    ...
    doThrow(new org.bonitasoft.engine.core.process.instance.api.exceptions.SProcessInstanceReadException(new java.lang.Exception())).when(processInstanceService).getArchivedProcessInstancesInAllStates(anyListOf(java.lang.Long.class));
