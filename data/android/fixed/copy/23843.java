public java.util.ArrayList<com.izik.recipebook.Recipe> setUserFavoriteRecipesByExpression(java.lang.String userId, java.lang.String expression) {
    java.util.ArrayList<com.izik.recipebook.Recipe> likeExpressionRecipes = com.izik.recipebook.Model.instance(mContext).GetUserFavoriteRecipesByLikeExp(userId, expression);
