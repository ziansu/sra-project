...
public static void setUpBeforeClass() throws java.lang.Exception {
    ...
    com.lge.stark.eddard.httphandler.user.PutLogoutTest.USER_ID = new com.lge.stark.eddard.httphandler.user.com.lge.stark.eddard.httphandler.user.PutLoginTest().loginedUserId(com.lge.stark.eddard.httphandler.user.PutLogoutTest.DEVICE_ID);
}