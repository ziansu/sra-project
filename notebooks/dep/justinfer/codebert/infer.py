...
def infer(output_dir, load_model_path, test_filename, batch_size):
...
if __name__ == "__main__":
    ...
    infer(
        output_dir='.',
        load_model_path='/home/su284/data/workspace/program-repair/sra-project/notebooks/dep/code-refinement/output/checkpoint-best-bleu/pytorch_model.bin',
        test_filename='/home/su284/data/workspace/program-repair/sra-project/notebooks/dep/code-refinement/data/small/test.buggy-fixed.buggy,/home/su284/data/workspace/program-repair/sra-project/notebooks/dep/code-refinement/data/small/test.buggy-fixed.fixed',
        batch_size=1,
    )
